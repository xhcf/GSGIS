...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_area_dev_colorflow.css?version=3.3"/>'
...
<style type="text/css">
    ...
    .village_m_tab15 table.content_table tr td:nth-child(3) {
        color: #3d8ccf;
    }
    ...
    yx_info_list tr td:nth-child(2) {
        text-align: left;
    }
        ...
        <div style="margin-top: 5px">
            ...
            <div class="list_search">
                <div style="margin-top:5px">
                    ...
                    <div style="margin-left: 10px;display: inline-block;font-size:12px" disabled="disabled">
                        区&nbsp&nbsp县:
                    </div>
    ...
    <div style="overflow: hidden">
        ...
        <div class="build_bar sub_level">
            ...
            <input type="text" id="build_segm_name" placeholder="输入四级地址"
                   style="width: 135px;margin-left: 13px;margin-top: 2px;font-size:12px;background:#fff;">
        ...
        require(["esri/config",
                ...
                function (Config,
                    ...
                    $("#model_to_rank").click(function () {
                        //parent.load_list_village_for_sub_grid_user(4, city_id, bureau_no, branch_no);
                    ...
                    function subDraw_subList() {
                        $.post(url4Query, {
                            ...
                            $.post('<e:url value="querysubgrid.e"/>', {
                                ...
                                var data1 = data[1];
                                var data2 = data[0];
                                sub_zoom_array[substation] = data2[0].ZOOM;
                                var sub_style_num = new Array();
                                var sub_show_num = 0;
