...
<script>
  ...
  function initListDiv(){
	  if (index_type == '0') {
		  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_broad_home_market.jsp' />?flag=" + flag + "&region_id=" + region_id);
	  } else if (index_type == '1') {
		  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_business_locations.jsp' />?flag=" + flag + "&region_id=" + region_id);
	  } else if (index_type == '2') {
		  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_fb_real_percent_use.jsp' />?flag=" + flag + "&region_id=" + region_id);
	  } else if (index_type == '3') {
		  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_dispatch_yx.jsp' />?flag=" + flag + "&region_id=" + region_id);
	  } else if (index_type == '4') {
		  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_collect.jsp' />?flag=" + flag + "&region_id=" + region_id);
      } else if (index_type == '5') {
    	  $("#list_div").load("<e:url value='pages/telecom_Index/channel_leader/bigTab/big_table_protection.jsp' />?flag=" + flag + "&region_id=" + region_id);
          ...
          $("#list_div").load("<e:url value='pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp' />?city_id=" + "${param.city_id}" + "&village_type="+"${param.village_type}"+"&beginDate="+"${param.beginDate}"+"&frome_page=1");
