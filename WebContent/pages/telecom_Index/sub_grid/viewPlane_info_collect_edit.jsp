		...
		<div style="margin:10px 0;border-bottom:1px dashed #999;padding-bottom:15px;padding-left:8px;">
			<table>
				...
				<tr>
					...
					<td style="width:33%;">网格：<span id="info_colle_edit_grid_name"></span></td>
					<td style="width:33%;">小区：<span id="info_colle_edit_village_name"></span></td>
				</tr>
				<tr>
					<td colspan=3>
...
<script>
	...
	function saveInfoCollect(){
		...
		var info_colle_edit_address6 = $.trim($("#info_colle_edit_address6 option:selected").val());
  ...
  function setPosition(){
  	...
  	if(city_id=="undefined" || city_id=="null" || city_id==null || city_id==""){
		if(parent.global_position_build_view!=undefined){
			...
			$("#info_colle_edit_grid_name").text(parent.global_position_build_view[3]);
  ...
  function setAdd6OptionList(){
  	...
  	$.post(parent.url4Query,{"eaction":"getAdd4ListInSubAndGrid","city_id":city_id,"area_id":area_id,"sub_id":substation,"grid_id":grid_id},function(data){
  		data = $.parseJSON(data);
  		var arr = new Array();
