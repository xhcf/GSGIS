...
<e:q4o var="quryDate">
  select t.const_value ACCT_MON from easy_data.sys_const_table t where const_type='var.dss29' and const_name='calendar.curdate'
</e:q4o>
...
<head>
  ...
  <script src='<e:url value="/pages/telecom_Index/channel_leader/js/channel_geo_center.js"/>' charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/ieBrowser.js"/>' charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/channel_leader/js/xnglToEchartMap_channel_leader.js?version=New Date()"/>'
  ...
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_village_cell.js?version=0.8"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/convertData.js?version=New Date()"/>'
          charset="utf-8"></script>
  ...
  <link href='<e:url value="/pages/telecom_Index/sandbox_compete/css/sandbox_compete.css?version=2.2" />'
        rel="stylesheet" type="text/css" media="all"/>
  <link href='<e:url value="/pages/telecom_Index/sandbox_compete/css/nav_query_table_wrapper.css?version=1.7" />'
        rel="stylesheet" type="text/css" media="all"/>
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/leader_org_frame.css?version=1.1" />' rel="stylesheet" type="text/css" media="all"/>
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/leader_org_frame_reset.css?version=New Date()" />' rel="stylesheet" type="text/css" media="all"/>
  ...
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/leader_bureau_index.css?version=1.2.0"/>' rel="stylesheet" type="text/css" media="all" />
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/visual_map_range_reset.css?version=New Date()"/>' rel="stylesheet" type="text/css" media="all" />
...
<div style="position:relative;">
  <div class="leader_tools" id="tools_scroll">
    <ul class="nav_index_group">
      <li id="nav_index_broad_home_percent"><span></span><a href="javascript:void(0)">效能概览</a></li>
      <li id="nav_index_fb_cover"><span></span><a href="javascript:void(0)">网点清单</a></li>
      ...
      <li id="nav_index_village_page"><span></span><a href="javascript:void(0)" style="">行政村</a></li>
...
<script type="text/javascript">
  ...
  var map = "";
  var city_id = "";
  var url4Query = '<e:url value="/pages/telecom_Index/channel_leader/echartsMapData_channel_leader.jsp"/>';

  var url4echartmap = url4Query+'?eaction=index_province';

  var sql_url = '<e:url value="/pages/telecom_Index/channel_leader/channel_action/channel_leaderAction.jsp" />?eaction=getIndexForEcharts&flg=1&acc_day='+${initMonth};
  var sql_url1 = '<e:url value="/pages/telecom_Index/channel_leader/channel_action/channel_leaderAction.jsp" />?eaction=xn_rank&region_type=1&acct_month='+${initMonth};


  //echart地图要加载的页面
  var url4mapToWhere = '<e:url value="/pages/telecom_Index/channel_leader/leader_province_level.jsp"/>';

  var url4mapInsideWhere = '<e:url value="/pages/telecom_Index/channel_leader/leader_city_level.jsp"/>';
  ...
  $(function () {
    ...
    $(".nav_index_group").children().each(function(){
      $(this).on("click",function(){
        ...
        if(index_type_temp==1){//小区清单
          parent.load_list_view(1,'','');
        }else if(index_type_temp==7){//校园商客
          //2018.10.19
          parent.switchToCity_inside_page('931','兰州市',1,"sch_ent");
        }else{
          if(index_name=="nav_index_view_video"){///视频观看
            parent.view_video();
          }
          else if(index_name=="nav_index_village_page"){//行政村
            index_type = "";
            ...
            parent.load_list_view(10,'','');//行政村入口 大报表模式
          	...
          	if(parent.global_region_type=='village_cell'){
  ...
  function load_map(region_type){
    ...
    params.bureau_no = parent.bureau_no;

    if(region_type=="city"){
      url4mapToJson = '<e:url value="/pages/telecom_Index/channel_leader/js/gan_su_geo.json" />';
      $.get(url4mapToJson, function (cityJson) {
        ...
        if(index_type== 0){
        	...
        	url4channeltype = url4Query+'?eaction=index_channel_type';
        	setDataToEchartMap_bar_bureau(params, url4echartmap, url4mapToWhere,url4channeltype,sql_url,sql_url1);
      ...
      url4mapToJson = '<e:url value="/pages/telecom_Index/channel_leader/js/gan_su_geo.json" />';
      //url4mapToJson = '<e:url value="/pages/telecom_Index/channel_leader/js/gansu3.json" />';
      $.get(url4mapToJson, function (cityJson) {
        echarts.registerMap(province_name_short, cityJson);
        //chart_map = echarts.init(document.getElementById('pagemap'),"dark");
  ...
  function visualMap_init(index_type,region_type){
    ...
    if(index_type==0){//指标1 宽带家庭渗透率
      $("#choices_title").text("渠道效能");
      if(region_type=="city"){
        var index_range = parent.index_range_map["KPI_D_001"];
        $("#choices").append(

          "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" /> 高效能（>=80）</li>"+
          "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" /> 中效能（30-80）</li>"+
          "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" /> 中低效能（10-30）</li>"+
          "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" /> 低效能（<10）</li>"
      ...
      if(region_type=="city" || region_type=="bureau" || region_type=="sub" || region_type=="grid" || region_type=="village"){
        $("#choices").append(
        		"<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" value=\"100-40\"/> 强壮 (90-100)：<span></span></li>"+
                "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" value=\"35-30\"/> 健康 (80-90)：<span></span></li>"+
                "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" value=\"30-25\"/> 亚健康  (70-80)：<span></span></li>"+
                "<li class=\"active\"><input type=\"checkbox\" name=\"percent_check\" checked=\"checked\" value=\"20-0\"/> 不健康  (0-70)：<span></span></li>"
        );
      }/*else if(region_type=="bureau"){
