...
<div id="village_div" style="display: none;height: 100%">
    <div style="overflow: hidden">
        ...
        <div class="list_search">
            <div style="margin-left: 5px;margin-top: 5px">
                <div class="list_text">分公司:</div>
                <select id="v_city" class="list_select" style="width: 70px;margin-left:8px" disabled="disabled">
                    <option value="">全部</option>
                </select>
...
<div id="build_div" style="display: none;height: 100%">
    <div style="overflow: hidden">
        ...
        <div class="list_search">
            <div style="margin-left:5px;margin-top: 5px">
                <div class="list_text">分公司:</div>
                <select id="b_city" class="list_select" style="width: 60px;margin-left:13px" disabled="disabled">
                    <option value="">全部</option>
                </select>
...
<div id="yingxiao_div" style="display: none;height: 100%">
    <div style="overflow:hidden;">
        ...
        <div class="list_search" style="padding-bottom: 5px;margin-bottom: 0px">
            <div style="margin-left: 5px;margin-top: 5px;">
                <div class="list_text">分公司：</div>
                <select id="y_city" class="list_select" style="width: 60px;margin-left:5px" disabled="disabled">
                    <option value="">全部</option>
                </select>
...
<div style="clear:both ">
    ...
    <div class="tools_n" id="tools_scroll" style="position:absolute;top:-12px;left:0px;text-align:center;">
        ...
        <ul id="tools">
            ...
            <li id="nav_marketing_village" style="cursor: hand"><span></span><a href="javascript:void(0)"
                                                                                id="marketing_village">营销</a></li>
        ...
        require(["esri/config",
                ...
                function (Config,
                    ...
                    setBuildCity = function () {
                        $("#b_city").append(baseFullOption_default_city);
...
//									setBuildCity();
                                    setCitysBulid($("#b_city"), $("#b_area"), $("#b_branch"), $("#b_grid"), $("#build_query"));
                    ...
                    function freshBuildInVillageWin(build_id) {
                        ...
                        var item_str = "<tr><td></td><td>合计</td>" +
                                "<td>" + village_new_total_nums.ZHU_HU_COUNT + "</td>" +
                                    ...
                                    //"<td>"+village_new_total_nums.SY_RES_COUNT+"</td>"+
                                "<td>--</td>" +
                                "<td>--</td>" +
                    ...
                    featureLayer.on("update-end", function () {
                        $.post(url4Query, {"eaction": "getSubListByLatnId", "city_id": city_id}, function (data) {
                            ...
                            if (data.length == 0)
                                ...
                                $.post(url4Query, {
                                    eaction: "getAreaNameBySubId",
                                    sub_id: left_sub_id_from_province,
                                    city_id: city_id
                                }, function (data) {
                                    data = $.parseJSON(data);
                                    if (data == null) {
...
//						}
                    ...
                    function village_load_by_sub_only(substation) {
                        ...
                        ids_str_array = new Array();
                        $.post(url4Query, {
                            eaction: "getVillagesBySubIdOnly",
                            substation: substation
                        }, function (data1) {
                            data1 = $.parseJSON(data1);
