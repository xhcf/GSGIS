...
<head>
    ...
    <script src='<e:url value="/pages/telecom_Index/sub_grid/js/mapTran.js?version=1.1"/>' charset="utf-8"></script>
    <script src='<e:url value="/pages/telecom_Index/sub_grid/js/WKTUtil.js?version=New Date()"/>' charset="utf-8"></script>
		<link href='<e:url value="/pages/telecom_Index/sandbox_leader/css/leader_org_frame.css" />' rel="stylesheet" type="text/css" media="all"/>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/bureau_geo_center.js?version=1.4"/>'
	  ...
	  <link href='<e:url value="/pages/telecom_Index/sandbox_leader/css/leader_org_frame.css?version=1.2"/>' rel="stylesheet" type="text/css" media="all" />
    ...
    <script src='<e:url value="/pages/telecom_Index/enterprise_leader/js/order_exec.js?version=New Date()"/>' charset="utf-8"></script>
    <script src='<e:url value="/pages/telecom_Index/enterprise_leader/js/info_collect.js?version=New Date()"/>' charset="utf-8"></script>
</head>
...
<style>
    ...
    /*客户视图 2018*/
	  ...
	  .message_cont {display:flex;}
	  .message_cont>div {flex:1;}
	  #buildInVillage_review_win .base1 {height:40px;}

	  .build_village_tab tr td:last-child a {width:auto;}

	  #buildInVillage_review_win {width:700px;}
	  #buildInVillage_review_win .build_village_layout{height:185px;}

	  .build_village_tab th:first-child,.build_village_tab td:first-child {width:8%!important;}
	  .build_village_tab th:nth-child(2),.build_village_tab td:nth-child(2) {width:60%!important;}
	  .build_village_tab th:nth-child(3),.build_village_tab td:nth-child(3) {width:10%!important;}
	  .build_village_tab th:nth-child(4),.build_village_tab td:nth-child(4) {width:14%!important;}
	  .build_village_tab th:nth-child(5),.build_village_tab td:nth-child(5) {width:8%!important;}
	  /*.build_village_tab th:nth-child(6),.build_village_tab td:nth-child(6) {width:12%!important;}
	  .build_village_tab th:nth-child(7),.build_village_tab td:nth-child(7) {width:6%!important;}*/
	  #school_search_text {width:80%;}

		#nav_func_xinjian1 span {
      background: url('<e:url value="pages/telecom_Index/sandbox/images/new_village.png" />') no-repeat center/contain;
    }
</style>
...
<!-- 政企校园工作台 -->
<div class="village_info_win new_beta leader" id="schoolOrEnterprise_info_win" style="display: none;width:70%;height:95%;">
    ...
    <iframe id="schoolOrEnterprise_info_win_body" style="width:100%;height:96%;border:0"></iframe>
...
<div id="buildInVillage_review_win" class="village_info_win" style="position:absolute;z-index:999;display:none;">
    <div class="village_title" id="yingxiao_info_new_title"><span id="yingxiao_title">校园编辑</span>
    ...
    <div class="tab_box">
        <div>
            <div class="target_a" style="border-bottom:none;">
            		...
            		<h3 class="wrap_a" style="margin-top:5px;margin-bottom:0px;">基本信息</h3>
                <div class="base1" style="height:65px;">
                	<div class="message_cont">
	                		<div>学校名称：
	                			<select id="village_name" type="text" onchange="javascript:select_bureau();"></select>
	                			<input type="text" name="filter_input" oninput="javascript:filter_name();" style="position:absolute;left:84px;top:30px;height:22px!important;z-index:2;border:0px;" />
	                			<ul id="filter_ul" style="position:absolute;left:81px;background:#fff;border-left:1px solid #ccc;border-right:1px solid #ccc;border-bottom:1px solid #ccc;"></ul>
	                		</div>
                	</div>
                  <div class="message_cont">
                      <div>分&ensp;公&ensp;司：<span id="village_in_city"></span></div>
                      <div>县&emsp;&emsp;局：<select id="village_in_bureau" style="height:24px!important;padding:0px;display:none;"></select><span id="village_in_bureau1"></span></div>
                      <div>院校类型：<span id="college_type"></span></div>
                      <div style="display:none;">学校类型：<select id="village_scale" style="height:24px!important;"></select></div>
                  </div>
                </div>

                <h3 class="wrap_a" style="margin-top:5px;margin-bottom:0px;">统计信息</h3>
                <div class="base1" style="height:25px;">
                    <div class="message_cont">
                    	 <div>楼宇数： <span id="village_builds_total"></span></div>
                    	 <div>房间数： <span id="village_people_total"></span></div>
                       <div style="display:none;">宽带数： <span id="village_new_kd_sum"></span></div>
                       <div style="display:none;">宽带家庭渗透率： <span id="broad_home_percent" style="width:15;">--</span></div>
                    </div>
                </div>
                ...
                <div class="base1" style="height:30px;">
                    <div class="message_cont">
                    		<div>
                    				<span>进线运营商：</span>
				                  	<input style="margin-left:5px" class="radio_none"  id="none_jx" type="radio" name="none" value="0" checked="checked"/>未进线
		                 	      <span class="jx">
		                          <input class="checkb" id="dx_jx" type="checkbox" name="dx" value="1" />电信&emsp;&emsp;
			                 	  		<input class="checkb" id="yd_jx" type="checkbox" name="yd" value="2" />移动&emsp;&emsp;
			                 	  		<input class="checkb" id="lt_jx" type="checkbox" name="lt" value="3" />联通&emsp;&emsp;
			                 	  		<input class="checkb" id="gd_jx" type="checkbox" name="gd" value="4" />广电&emsp;&emsp;
			                 	  		<input class="checkb" id="qt_jx" type="checkbox" name="qt" value="5" />其他
		                 	      </span>
                    				<span style="margin-right:0px;">进线运营商数：</span>
                    				<span id="jx_num">--</span>
                    		</div>
                    </div>
                </div>

                <h3 class="wrap_a">楼宇信息<span class="add_item" onclick="javascript:cancleBuildInVillage()"
                                             style="margin:0;float:right;background:none;color:#3d8ccf;width:auto;text-decoration:underline;font-size:12px;">添加楼宇</span></h3>
                <input type="hidden" id="village_in_sub_id"/>
                <input type="hidden" id="village_in_grid_id"/>
                <input type="hidden" id="village_new_center"/>
                
                <input type="hidden" id="school_new_center1"/>
                <input type="hidden" id="school_new_center2"/>
                <input type="hidden" id="school_new_center3"/>
                
                <input type="hidden" id="village_in_grid_id_short"/>

            </div>
            <div style="width:100%;padding-right:14px;">
                <table class="build_village_tab" id="buildInvillage_res_head">
                </table>
            </div>
    ...
    <div style="position:relative;">
		  <div class="leader_tools" id="tools_scroll">
		    <ul class="nav_index_group">
		      ...
		      <li id="nav_func_xinjian1"><span></span><a href="javascript:void(0)" id="">校园新建</a></li>
...
<div id="pos_tab_win" class="">
	...
	<div style="padding-right:19px;padding-left:5px;">
		<input type="text" id="school_search_text" placeholder="请输入学校名称检索" /><input style="width:18%;cursor:pointer;color:#fff;" class="blue_btn" type="button" value="查询" onclick="javascript:pos_tab_query()" />
	</div>
	<div style="height:23px;width:280px;padding-left:5px;">
		<span style="display:inline-block;">记录数：</span><span id="pos_tab_total_num" style="display:inline-block;"></span>
	</div>
...
<script type="text/javascript">
		$("#pos_tab_div").height($("#pos_tab_win").height()-35-25-23-7-34);
		/*显示小列表*/
		//$("#pos_tab_win").show();
    ...
    var village_area_type_options = "<option value=\"2\" selected>宿舍区</option><option value=\"1\">教学区</option><option value=\"3\">生活区</option>";
    ...
    //选学校选中分局 选学校选中区县
    function select_bureau(){
    	var bureau_no = $("#village_name option:selected").attr("data");
    	if(bureau_no=="null")
    		$("#village_in_bureau").val("");
    	else
    		$("#village_in_bureau").val(bureau_no);
    		
    	$("#college_type").text($("#village_name option:selected").attr("data1"));
    	$("#village_scale").val($("#village_name option:selected").attr("data2"));
    	$("#village_in_bureau1").text($("#village_name option:selected").attr("data3"));
    }
    ...
    var village_service_feature_layer = "";
	  ...
	  function filter_name(){
	  	$("#filter_ul").empty();
	  	var searchWord = $.trim($("input[name='filter_input']").val());
	  	if(searchWord!=""){
	  		$("input[name='filter_input']").css({"background":"#fff"});
	  		var count = 0;
	  		for(var i=0,l = school_name_array.length;i<l;i++){
		  		var item = school_name_array[i];
		  		var temp = "";
		  		if((temp=item.BUSINESS_NAME).indexOf(searchWord)>-1){
		  			$("#filter_ul").append("<li title='"+temp+"' onclick='doFilter(\""+item.BUSINESS_ID+"\")' style=\"padding-left:6x;\">"+temp+"</li>");
		  			count++;
		  		}
		  	}
		  	if(count)
	  		...
	  		$("input[name='filter_input']").css({"background":"transparent"});
	  		$("#filter_ul").empty();
	  		$("#filter_ul").hide();
	  	}
	  }
    ...
    function backToPrevLevel(region_index){
    	...
    	if(region_index == 0){
	    	...
	    	parent.freshMapContainer('<e:url value="/pages/telecom_Index/enterprise_leader/leader_province_level.jsp"/>');
	    	parent.loadSmallTab(1,index_type,'',region_type_num);
    	}else if(region_index == 1){
    		parent.global_current_flag = 2;
	    	parent.global_current_city_id = city_id;
	    	parent.global_current_area_name = city_name;
	    	parent.freshMapContainer('<e:url value="/pages/telecom_Index/enterprise_leader/leader_city_level.jsp"/>');
    ...
    $(function () {
    		//校园名称过滤控件初始化样式
    		$("input[name='filter_input']").width($("#village_name").width()-28);
    		$("#filter_ul").width($("#village_name").width());
    		$("#filter_ul").hide();
    		...
    		$(".region_switch_group").hide();//20181206
				...
				$.post(url4Query_enterprise,{"eaction":"getBureauListByCity","city_id":city_id},function(data){
					var bureau_list_options = $.parseJSON(data);
					$("#village_in_bureau").append("<option value=''>请选择</option>");
					for(var i = 0,l = bureau_list_options.length;i<l;i++){
						var item = bureau_list_options[i];
						var opt = "<option value='"+item.ID+"'>"+item.TEXT+"</option>";
						$("#village_in_bureau").append(opt);
					}
					if('${sessionScope.UserInfo.LEVEL}'==3){
						$("#village_in_bureau").val('${sessionScope.UserInfo.CITY_NO}');
						$("#village_in_bureau1").text('${sessionScope.UserInfo.CITY_NAME}');
						$("#village_in_bureau").attr("disabled","disabled");
					}
				});
    ...
    function toGis() {//城关区，兰州市
        ...
        require(["esri/config",
                ...
                function (Config,
                        ...
                        layer.confirm(desc_text, {
                                ...
                                $.post(url_str, {
                                    ...
                                    if(nav_type_index=="village"){
                                    	...
                                    	school_GraphicsLayer_part.clear();
                    ...
                    operateVillage = function (village_id, st, addr, thiz) {
                        ...
                        school_GraphicsLayer_part.clear();
												...
												if(nav_type_index == "school" || nav_type_index == "enterprise"){
													if(nav_type_index == "school"){
														$("#schoolOrEnterprise_drag_handler span").text("校园视窗");
														var school_center = "";
														var size = village_ico_get_size(map.getZoom());
														$.post(url4Query_enterprise,{"eaction":"getSchoolCenter","school_id":village_id},function(data){
															var data = $.parseJSON(data);
															if(data.length){
																var center_vail_num = 0;
																...
																if(center_vail_num>1){
																	for(var i = 1,l = data.length;i<l;i++){
																		var d = data[i];
																		var pos = d.POSITION;
																		try{
																			var point_array = pos.split(",");
																			var school_pic_symb = "";
																			var type_name = "";
																			if(d.AREA_TYPE=='1'){
																				school_pic_symb = new PictureMarkerSymbol(school_part_ico1, size*0.8, size*0.8);
																				type_name = "教学区";
																			}
																			else if(d.AREA_TYPE=='2'){
																				school_pic_symb = new PictureMarkerSymbol(school_part_ico2, size*0.8, size*0.8);
																				type_name = "宿舍区";
																			}
																			else if(d.AREA_TYPE=='3'){
																				school_pic_symb = new PictureMarkerSymbol(school_part_ico3, size*0.8, size*0.8);
																				type_name = "生活区";
																			}
																			var part_graphic = new esri.Graphic(new Point(parseFloat(point_array[0]), parseFloat(point_array[1]), new SpatialReference({wkid: 4326})), school_pic_symb,{"type":type_name});//{"school_id": s_id,"school_name":d1.BUSINESS_NAME}
																			school_GraphicsLayer_part.add(part_graphic);
																		}catch(e){
																		}
																	}
																}
																school_center	= data[0].POSITION;
																var sc = school_center.split(",");
																map.centerAndZoom([parseFloat(sc[0]),parseFloat(sc[1])],9);
															}
														});
														$.post(url4Query_enterprise,{"eaction":"getSchoolPolygen","id":village_id},function(data){
															var data = $.parseJSON(data);
															if(data!=null){
																var geotry = WktToPolygon(data.GEOSHPE, "4326");
																school_GraphicsLayer_selected.add(new Graphic(geotry, circleSymb));
															}
														});
													}else if(nav_type_index == "enterprise"){
                        ...
                        if(ids_str==undefined){
                        	...
                        	$.post(url,{"eaction":action,"village_id":village_id},function(data){
                        		build_type_for_colorful = new Array();
                        		data = $.parseJSON(data);
                            ...
                            for (var i = 0, l = data.length; i < l; i++) {
                                ...
                                build_type_for_colorful[d.SEGM_ID] = d.AREA_TYPE;
                    ...
                    parent.global_operate_village = operateVillage;
                    //小列表点击 定位校园政企 定位校园商客
                    ...
                    function getBuildInsideVillage(build_ids_str){
                        ...
                        queryTask_standard.execute(query_standard, function (results) {
                            ...
                            for (var i = 0, l = results.features.length; i < l; i++) {
                                ...
                                var standard_ico_colorful = "";
                                if(build_type_for_colorful[feature.attributes.RESID]==1){
                                	standard_ico_colorful = standard_ico_selected1;
                                }else if(build_type_for_colorful[feature.attributes.RESID]==2){
                                	standard_ico_colorful = standard_ico_selected2;
                                }else if(build_type_for_colorful[feature.attributes.RESID]==3){
                                	standard_ico_colorful = standard_ico_selected3;
                                }
                                var img_colorful = new PictureMarkerSymbol(standard_ico_colorful, size, size);
                               
                                var build_gra_colorful = new esri.Graphic(feature.geometry, img_colorful, feature.attributes);
                                
                                draw_layer_school_part.add(build_gra_colorful);
                               
                                //school_GraphicsLayer_part.add(build_gra);
                            ...
                            e.append(str)
										...
										$("#nav_type_school").click(
											function(){
												...
												standard_where = "ext1 = 2 and BUREAU_NO = '${sessionScope.UserInfo.CITY_NO}'";
												if(map.getZoom()>=6){
													standard_load();
													draw_layer_mark_build.clear();
													drawed_layer_mark_build.clear();
										...
										$("#nav_type_enterprise").click(
											function(){
												...
												standard_where = "ext1 = 3 and BUREAU_NO = '${sessionScope.UserInfo.CITY_NO}'";
												if(map.getZoom()>=6){
													standard_load();
													draw_layer_mark_build.clear();
													drawed_layer_mark_build.clear();
										...
										$("#nav_index_enterprise_detail").unbind();
										$("#nav_index_enterprise_detail").click(
											function(){
												parent.load_list_view(0,'',city_id);
											}
										);
										//校园政企返回 返回上级
										...
										$("#nav_func_back").click(
											function(){
												...
												if(parent.global_fromProvince==1)
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/enterprise_leader/leader_province_level.jsp" />');
												else
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/enterprise_leader/leader_city_level.jsp" />');
											}
										);
										//左侧指标按钮切换
...
//                standard_load();
                    ...
                    var standard_where = "ext1 = 2 and BUREAU_NO = '${sessionScope.UserInfo.CITY_NO}'";//默认加载校园关联的楼宇
                    ...
                    $("#xinjian1").click(
                          function () {
                          		if(nav_type_index=="school"){
                          				$("input[name='filter_input']").removeAttr("disabled");
                          				hideAllServiceLayers();
																	showSchoolLayer();
                          		}else if(nav_type_index=="enterprise"){
                          				hideAllServiceLayers();
                          		...
                          		//类型选择控件名称
                          		$("#village_area_type").empty();
                          		if(nav_type_index=="school"){
                          			$("#village_scale").prev("span").text("学校类型：");
                          			//$("#village_area_type").append(village_area_type_options);
                          			//$("#village_area_type").prev("span").text("学校区域：");
                          			//$("#village_area_type").prev("span").andSelf().show();
                          			$("#village_area_type").prev("span").andSelf().hide();
                          		}else if(nav_type_index=="enterprise"){
                          			$("#village_scale").prev("span").text("商客类型：");
                          			$("#village_area_type").prev("span").andSelf().hide();
                          		}else{
                          			$("#village_scale").prev("span").text("类型：");
                          			$("#village_area_type").prev("span").andSelf().hide();
                          		}
                          			
                          		//学校名称获取，作为下拉选择 学校名称下拉
                          		school_name_array = new Array();
                          		var default_option = "<option value=''>请选择</option>";
                          		$("#village_name").removeAttr("disabled");
                          		$("#village_name").empty();
                          		$("#village_name").append(default_option);
                          		$.post(url4Query_enterprise,{"eaction":"getNewSchoolList","city_id":city_id},function(data){
                          				var d = $.parseJSON(data);
                          				for(var i = 0,l = d.length;i<l;i++){
                          					var item = d[i];
                          					$("#village_name").append("<option value='"+ item.BUSINESS_ID +"' data='"+ item.BUREAU_NO +"' data1='"+ item.ATTR_EXT2 +"'>"+ item.BUSINESS_NAME +"</option>");
                          					school_name_array.push(item);
                          				}
                          		});
                          		
                          		/*$("#village_name").combobox({
                          			textField:"BUSINESS_ID",
                          			valueField:"BUSINESS_NAME",
                          			data:[{"BUSINESS_ID":"1","BUSINESS_NAME":"a"},{"BUSINESS_ID":"2","BUSINESS_NAME":"b"},{"BUSINESS_ID":"3","BUSINESS_NAME":"c"}]
                          		});*/
                          		...
                          		$.post(url4Query_enterprise,{"eaction":"getEnterpriseType","type":nav_type_index},function(data){
																...
																$("#village_scale option[value='99999317']").attr("selected","selected");
															});
                    ...
                    tuichu = function (e) {
                        ...
                        if(buildInVillage_mode!="" && village_saved_flag){
                            ...
                            if(buildInVillage_mode=="add")
                            	village_updated_position = "";
                            if(village_updated_position!=""){
                            	queryBuildFunc(village_id_selected, ids_str, village_updated_position);
                            }else{
                            	queryBuildFunc(village_id_selected, ids_str, "");
                            }
                            village_position_layer.clear();
...
//							skin: 'demo-class',
                    ...
                    removeItemFromBuildInVillage = function (element, build_id) {
                        layer.confirm('您确定移除该条记录？', {
                                ...
                                drawed_layer_mark_build.remove(drawed_graphics_array_for_buildInVillage[build_id]);//从使用过的图层删除
                                delete drawed_graphics_array_for_buildInVillage[build_id];
                    ...
                    function freshBuildInVillageWin(build_id) {
                        ...
                        var item_str = "<tr><td></td><td>合计</td>" +
                                ...
                                //"<td>" + village_new_total_nums.RES_ID_COUNT + "</td>" +
                                "<td>--</td>" +
                                "<td></td>";
                                //"<td>" + (village_new_total_nums.YX_UN == null ? '--' : village_new_total_nums.YX_UN) + "</td></tr>";
                    ...
                    var buildRes = "";//已选择的楼宇 id:obj
                    var buildRe_area1 = "";//教学区
                    var buildRe_area2 = "";//宿舍区
                    var buildRe_area3 = "";//生活区
                    var buildR_type = "";//暂存校园楼宇列表中选择的区域类型
                    var vill_edit_bureau_val = "";
                    var village_new_total_nums = "";
                    var village_new_items = "";
                    var buildInvillage_res_head_html1 = "<tr>"+
                    		"<th>序号</th>"+
                    		"<th>楼宇名称</th>"+
                    		"<th>房间数</th>";//+
                    		//"<th>宽带用户数</th>"+
                    ...
                    var buildInVillage_res_head_html2 = "<th>操作</th></tr>";

                    var buildInVillage_remove_btn_html1 = "<a style=\"background:none;text-decoration:underline;\" href=\"javascript:void(0);\" onclick=\"javascript:removeItemFromBuildInVillage(this,'";
                    var buildInVillage_remove_btn_html2 = "')\">删除</a>";

                    $("#draw_polygon_village_review").unbind();//点确定
                    dojo.query("#draw_polygon_village_review").onclick(function (evt) {
                    		$("#buildInvillage_res_head").empty();
                    		if(nav_type_index=="school"){
                    			$("#buildInvillage_res_head").append(buildInvillage_res_head_html1+"<th>子区域</th>"+buildInVillage_res_head_html2);
                    		}else{
                    			$("#buildInvillage_res_head").append(buildInvillage_res_head_html1+buildInVillage_res_head_html2);
                    		}
                        $("#saveBuildInVillageBtn").show();
                        ...
                        if (ids == null || ids == undefined || ids.length == 0) {
                            ...
                            if(nav_type_index=="school"){
                            	buildRe_area1 = new Array();
	                            buildRe_area2 = new Array();
	                            buildRe_area3 = new Array();
	                            
	                            var keys = Object.keys(buildR_type);
	                            if(keys.length){
		                            for(var i = 0,l = keys.length;i<l;i++){
		                            		var area_type_temp = buildR_type[keys[i]];
		                            		if(area_type_temp==1){
		                            			buildRe_area1.push(keys[i]);
		                            		}else if(area_type_temp==2){
		                            			buildRe_area2.push(keys[i]);
		                            		}else if(area_type_temp==3){
		                            			buildRe_area3.push(keys[i]);
		                            		}
		                            }
	                            	
	                            	var school_builds = draw_layer_mark_build.graphics;
	                            	var ext0 = graphicsUtils.graphicsExtent(school_builds);
	                            	var center0 = ext0.getCenter();
	                            	$("#village_new_center").val(center0.x + "," + center0.y);
	                            		
	                            	var sb1 = new Array();
	                            	var sb2 = new Array();
	                            	var sb3 = new Array();
	                            	for(var i = 0,l = school_builds.length;i<l;i++){
	                            		var sb = school_builds[i];
	                            		var type = buildR_type[sb.attributes.RESID];
	                            		if(type==1)
	                            			sb1.push(sb);
	                            		else if(type==2)
	                            			sb2.push(sb);
	                            	...
	                            	if(sb1.length){
	                            		var ext1 = graphicsUtils.graphicsExtent(sb1);
	                            		var center1 = ext1.getCenter();
	                            		$("#school_new_center1").val(center1.x + "," + center1.y);
	                            	}
	                            	
	                            	if(sb2.length){
	                            		var ext2 = graphicsUtils.graphicsExtent(sb2);
	                            		var center2 = ext2.getCenter();
	                            		$("#school_new_center2").val(center2.x + "," + center2.y);
	                            	}
	                            	
	                            	if(sb3.length){
	                            		var ext3 = graphicsUtils.graphicsExtent(sb3);
	                            		var center3 = ext3.getCenter();
	                            		$("#school_new_center3").val(center3.x + "," + center3.y);
	                            	}
	                            }else{
	                            	$("#school_new_center1").val("");
	                            	$("#school_new_center2").val("");
	                            	$("#school_new_center3").val("");
	                            	getSchoolBuildAreaTypeList();
	                            }
                            }
                            ...
                            if(vill_edit_bureau_val!="")
                            	$("#village_in_bureau").val(vill_edit_bureau_val);
                            ...
                            $.post(url4Query, {
                                ...
                                for (var i = 0, l = data.length; i < l; i++) {
                                    ...
                                    if (d.SEGM_ID == 0) {
                                        ...
                                        item_str += "<td style='width:35px'></td>";
                                    ...
                                    "<td>" + d.OBD_CNT + "</td>";*/
                              		  ...
                              		  if(nav_type_index=="school" && i!=0){
                                    	var school_area_type_select = "<select class=\"village_area_type\" data=\""+d.SEGM_ID+"\">"+village_area_type_options+"</select>";
                                    	item_str += "<td>"+school_area_type_select+"</td>";
                                    }else{
                                    	item_str += "<td></td>";
                                    }
                                    ...
                                    if (buildInVillage[d.SEGM_ID] != undefined)
                                        item_str += buildInVillage_remove_btn_html1 + d.SEGM_ID + buildInVillage_remove_btn_html2;

                                    item_str += "</td></tr>";

                                    $("#buildInvillage_res_list").append(item_str);
                                    if(nav_type_index=="school" && i!=0){
                                    	$(".village_area_type").eq(i-1).val(buildR_type[d.SEGM_ID]);
                                    }
                                }
                                if (data.length - 1 < ids.length) {//表里的楼宇数据比圈定的楼宇数少，需要把没有在表里的楼宇也展现出来
                                    ...
                                    for (var i = 0, l = keys.length; i < l; i++) {
                                        ...
                                        if(nav_type_index=="school" && i!=0){
		                                    	var school_area_type_select = "<select class=\"village_area_type\" data=\""+keys[i]+"\">"+village_area_type_options+"</select>";
		                                    	item_str += "<td>"+school_area_type_select+"</td>";
		                                    	//$(".village_area_type").eq(i).val(d.AREA_TYPE);
		                                    }else{
		                                    	item_str += "<td></td>";
		                                    }

                                        item_str += "<td>"+buildInVillage_remove_btn_html1 + d.SEGM_ID + buildInVillage_remove_btn_html2;
                                        item_str += "</tr>";
                    ...
                    var v_id_for_update = "";
                    var v_name_for_update = "";
                    saveBuildInVillage = function (event) {
                    		var v_id = $("#village_name option:selected").val();
                    		if(v_id==""){
                    			layer.msg("还未选择学校");
                          return;
                    		}
                    		var v_name = $("#village_name option:selected").text();
                        ...
                        v_id_for_update = v_id;
                        v_name_for_update = v_name;
                        
                        var bureau_id = $("#village_in_bureau option:selected").val();
                        var bureau_name = $("#village_in_bureau option:selected").text();
                        if(bureau_id==""){
                        	layer.msg("请选择县局");
                        	return;
                        }
                        ...
                        for (var i = 0, l = ids.length; i < l; i++) {
                            ...
                            if(nav_type_index=="school")
                            	build_area_type_str += (id+"_"+$(".village_area_type[data='"+id+"']").val() + ",");
                        }
                        ...
                        console.log("ids_str_for_update:"+ids_str_for_update);
                        if(nav_type_index=="school"){
                        	build_area_type_str = build_area_type_str.substr(0, build_area_type_str.length - 1);
                        }
                        console.log("build_area_type_str:"+build_area_type_str);
                        ...
                        var school_new_center1 = $("#school_new_center1").val();
                        var school_new_center2 = $("#school_new_center2").val();
                        var school_new_center3 = $("#school_new_center3").val();
                        
                        //var village_area_type_temp = "";
                        //if(nav_type_index=="school")
                        //	village_area_type_temp = $("#village_area_type option:selected").val();
                        		...
                        		return;
	                        		...
	                        		try {
															  if (buildInVillage_mode == "add") {
															      ...
															      $.post(url_str,{"eaction":"isExistSchool","business_id":v_id},function(data){
															      	var d = $.parseJSON(data);
															      	if(d!=null){
															      		layer.msg("该校园已创建，请选择其他校园");	
															      		$("#saveBuildInVillageBtn").removeAttr("disabled");
															      		layer.close(index);
															      		return;
															      	}
															      	var build_bureau = draw_layer_mark_build.graphics[0].attributes.BUREAU_NO;
																			var school_bureau = $("#village_in_bureau option:selected").val();
																			if(build_bureau!=school_bureau){
																				layer.confirm("所选楼宇可能不在学校所属的分局里，确定继续吗？",{btn: ['确定', '取消']},
																				function(){
																					$.post(url_str, {
																		            'eaction': eaction_str,
																		            ...
																		            //'business_attr2':village_area_type_temp,
																		
																		            'position': village_new_center,
																		            'school_new_center1': school_new_center1,
																		            'school_new_center2': school_new_center2,
																		            'school_new_center3': school_new_center3,
																		
																		            'ids': ids_str,
																		            'name_str': name_str,
																		            'short_name_str': short_name_str,
																		            "build_area_type_str":build_area_type_str,
																		            "wktstr":$("#wktstr").val()
																		        }, function (data) {
																		        		layer.close(index);
																		            layer.msg("保存成功");
                    ...
                    cancleBuildInVillage = function () {
                        $("#buildInVillage_review_win").hide();
                        getSchoolBuildAreaTypeList();
                        vill_edit_bureau_val = $("#village_in_bureau option:selected").val();
                    }
                    function getSchoolBuildAreaTypeList(){
                    		buildR_type = new Array();
                    		$(".village_area_type").each(function(i,d){
                    			buildR_type[$(".village_area_type").eq(i).attr("data")] = $(d).val();
                    		});
                    }
                    ...
                    editBuildInVillage = function () {
                        ...
                        $("#village_area_type").empty();
                    		if(nav_type_index=="school"){
                    			$("input[name='filter_input']").attr("disabled","disabled");
                    			$("#village_scale").prev("span").text("学校类型：");
                    			//$("#village_area_type").append(village_area_type_options);
                    			//$("#village_area_type").prev("span").text("学校区域：");
                    			//$("#village_area_type").prev("span").andSelf().show();
                        ...
                        if(nav_type_index=="school"){
                        	...
                        	$.post(url4Query_enterprise,{eaction:'getSchoolCenter',school_id:v_id},function(data){
                        		var data = $.parseJSON(data);
                        		if(data.length){
	                        		try{
	                        			$("#village_new_center").val(data[0].POSITION);
	                        			village_updated_position = data[0].POSITION;
	                        			$("#school_new_center1").val(data[1].POSITION);
	                        			$("#school_new_center2").val(data[2].POSITION);
	                        			$("#school_new_center3").val(data[3].POSITION);
	                        		}catch(e){
	                        		}
                        		}
                        	});
                            ...
                            if(nav_type_index=="village"){
                            	for (var i = 0, l = data.length; i < l; i++) {
	                                ...
	                                if (i == 0) {
	                                    ...
	                                    $("#village_scale").val(d.BUSINESS_ATTR1);
	                                    //$("#village_area_type").val(d.BUSINESS_ATTR2);
	                                    ...
	                                    if(d.LINE_CNT==0)
													            ...
													            if(d.OTHER_OPTICAL_FIBER==1)
													            	$("#qt_jx").attr("checked",true);
													            else
													            	$("#qt_jx").attr("checked",false);
													            $("#jx_num").text(d.LINE_CNT);
                            	...
                            	for (var i = 0, l = data.length; i < l; i++) {
                            		var d = data[i];
                            		if(i==0){
                            			$("#village_name").append("<option value=\""+v_id+"\" selected=\"selected\">"+d.BUSINESS_NAME+"</option>");
                            			$("#village_name").attr("disabled","disabled");
                            			ids_str += ("'" + d.SEGM_ID + "',");
	                                build_id_used.push(d.SEGM_ID);
	                                if(nav_type_index=="school"){
	                                	$("#village_in_bureau").val(d.BUREAU_NO);
	                                	village_updated_position = data[0].POSITION;
	                                	$("#village_in_bureau").attr("disabled","disabled");
	                                	$("#village_in_bureau1").text(d.BUREAU_NAME);
	                                	$("#village_scale").val(d.BUSINESS_ATTR1);
	                                	$("#college_type").text(d.ATTR_EXT2);
	                                }
                            		}
                            	}
                            }
                            	...
                            	$.post(url4Query_enterprise, {eaction: "build_wines_in_school_or_enterprise", village_id: v_id}, function (data1) {
	                                ...
	                                for (var i = 0, l = data1.length; i < l; i++) {
	                                    ...
	                                    if(nav_type_index=="school" && i!=0){
	                                    	var school_area_type_select = "<select class=\"village_area_type\" data=\""+d.SEGM_ID+"\">"+village_area_type_options+"</select>";
	                                    	item_str += "<td>"+school_area_type_select+"</td>";
	                                    	buildR_type[d.SEGM_ID] = d.AREA_TYPE;
	                                    }else{
	                                    	item_str += "<td></td>";
	                                    }
	                                    ...
	                                    $("#buildInvillage_res_list").append(item_str);
	                                    if(nav_type_index=="school" && i!=0){
	                                    	$(".village_area_type").eq(i-1).val(d.AREA_TYPE);
	                                  	}
	                                }
	                                //if(sort>ids.length){
                    ...
                    function drawEnable(evt) {
                        ...
                        if (draw_type == "ellipse") {
                            ...
                            school_part_mouse_over_when_draw_f = function (evt) {
																if(evt.graphic.attributes==undefined)
																	return;
														    var type_name = evt.graphic.attributes.type;
														    $("#village_info_mini_win").html(type_name);
														    $("#village_info_mini_win").css({top: evt.pageY + 10, left: evt.pageX + 10});
														    $("#village_info_mini_win").show();
														}
														school_part_mouse_out_when_draw_f = function (evt) {
														    $("#village_info_mini_win").hide();
														}
                    ...
                    function killEventForBuildInVillage() {//在从框选楼宇加入到小区的功能退出时要禁止的事件
                        ...
                        dojo.disconnect(standard_layer_click_for_buildInVillage_handler);
                        dojo.disconnect(draw_layer_school_part_mouse_over_handler);
                        dojo.disconnect(draw_layer_school_part_mouse_out_handler);
                    ...
                    function killEvent() {
                        ...
                        dojo.disconnect(draw_layer_school_part_mouse_over_handler);
                        dojo.disconnect(draw_layer_school_part_mouse_out_handler);
                        dojo.disconnect(draw_layer_school_part_click_handler);
                        ...
                        //dojo.disconnect(school_GraphicsLayer_part_mouse_over_handler);
                        //dojo.disconnect(school_GraphicsLayer_part_mouse_out_handler);
                    ...
                    function reboundForBuildInVillage() {
                        ...
                        draw_layer_school_part_mouse_over_handler = dojo.connect(draw_layer_school_part, "onMouseOver", function (evt) {
                        		map.setMapCursor("pointer");
		                        $("#village_info_mini_win").html(evt.graphic.attributes.RESFULLNAME);
		                        $("#village_info_mini_win").css({top: evt.pageY - 15, left: evt.pageX + 15});
		                        $("#village_info_mini_win").show();
		                    });
		                    draw_layer_school_part_mouse_out_handler = dojo.connect(draw_layer_school_part, "onMouseOut", function (evt) {
		                    		map.setMapCursor("default");
		                        $("#village_info_mini_win").hide();
		                    });
                    }
                    ...
                    function reboundEvent() {
                        ...
                        draw_layer_school_part_mouse_over_handler = dojo.connect(draw_layer_school_part, "onMouseOver", function (evt) {
		                    ...
		                    draw_layer_school_part_click_handler = dojo.connect(draw_layer_school_part, "onClick", function (evt) {
                            standard_layer_click(evt);
                        });
                        ...
                        school_GraphicsLayer_mouse_over_handler = dojo.connect(school_GraphicsLayer, "onMouseOver", function (evt) {
												...
												enterprise_GraphicsLayer_click_handler = dojo.connect(enterprise_GraphicsLayer, "onClick", function (evt) {
												    ...
												    var pointAttributes = {"enterprise_id": enterprise_id,"enterprise_name":evt.graphic.attributes.enterprise_name};
                    ...
                    function addBuildToVillagePoint(evt) {
                        ...
                        if (buildInVillage[attr.RESID] != undefined) {//已经选中的楼宇上再次点击，则取消它
                            ...
                            //drawed_layer_mark_build.remove(drawed_graphics_array_for_buildInVillage[attr.RESID]);//从使用过的图层删除
                            //delete drawed_graphics_array_for_buildInVillage[attr.RESID];
                            return;
                        }
                    ...
                    var school_part_ico1 = '<e:url value="/pages/telecom_Index/common/images/enterprise/teach.png" />';//教学区
                    var school_part_ico2 = '<e:url value="/pages/telecom_Index/common/images/enterprise/apart.png" />';//宿舍区
                    var school_part_ico3 = '<e:url value="/pages/telecom_Index/common/images/enterprise/live.png" />';//生活区

                    var standard_ico_selected1 = '<e:url value="/pages/telecom_Index/common/images/channel_ico_new/build_selected_s1.png" />';
                    var standard_ico_selected2 = '<e:url value="/pages/telecom_Index/common/images/channel_ico_new/build_selected_s2.png" />';
                    var standard_ico_selected3 = '<e:url value="/pages/telecom_Index/common/images/channel_ico_new/build_selected_s3.png" />';
                    ...
                    school_GraphicsLayer_part = new GraphicsLayer();
                    ...
                    var draw_layer_school_part = new GraphicsLayer();
                                ...
                                default://封闭多边形
                                    ...
                                    if (draw_type == "polygon_village" || draw_type == "rectangle_village") {
                                        ...
                                        if(draw_type == "polygon_village"){
                                        	...
                                        	var gs = draw_layer.graphics;
                                        	var ges = new Array();
                                        	for(var i = 0,l = gs.length;i<l;i++){
                                        		var g = gs[i];
                                        		ges.push(g.geometry);
                                        	}
                                        	var temp = PolygonsToWKT(ges);
                                        	$("#wktstr").val(temp);
                                        	
                                        	/*var geo_drawed = evt.geometry;
                                        	var temp = PolygonToWKT(geo_drawed);
                                        	$("#wktstr").val(temp);*/
                                        }else
                    ...
                    map.addLayer(draw_layer_mark_build);
                    map.addLayer(draw_layer_school_part);
                    ...
                    school_service_load = function(){
                      ...
                      village_gras_array = new Array();
                      ids_str_array = new Array();
                      $.post(url4Query_enterprise, {eaction: "getSchoolByCityId", city_id: city_id,"bureau_no":'${sessionScope.UserInfo.CITY_NO}'}, function (data) {
                          ...
                          map.addLayer(school_GraphicsLayer_part);
                          map.addLayer(school_GraphicsLayer_selected);

                          //进来定位学校
													if(parent.global_entrance_type=="school"){
														nav_type_index="school";
														operateVillage(parent.global_school_id);
														parent.global_entrance_type="";
													}
                      });
                    }
                    ...
                    enterprise_service_load = function(){
                      ...
                      village_gras_array = new Array();
                      ids_str_array = new Array();
                      $.post(url4Query_enterprise, {eaction: "getEnterpriseByCityId", city_id: city_id,"bureau_no":'${sessionScope.UserInfo.CITY_NO}'}, function (data) {
                          var data1 = $.parseJSON(data);
...
//									var linesymbol = new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color(qx_all_line_color), 1.5);
                    ...
                    featureLayer.on("update-end", function () {
                      ...
                      function focus_bureau(){
                      	$.post(url4Query,{"eaction":"getUnionOrgCodeByBureauName","bureau_name":parent.global_position[2]},function(data){
                      		var d = $.parseJSON(data);
                      		var substation_str = "SUBSTATION_NO IN (";
                      		$.each(d,function(index,item){
                      			substation_str += "'"+item.UNION_ORG_CODE+"'";
                      			if(index<d.length-1)
        											substation_str += ",";
                      		});
                      		substation_str += ")";
                      		
                      		var gra_arr = new Array();
                      		var queryTask = new QueryTask(new_url_sub_vaild + sub_layer_index);
                      		var query = new Query();
                      		query.where = substation_str;
													query.outFields = ['SUBSTATION_NO'];
													query.returnGeometry = true;
													queryTask.execute(query, function (results) {
														if (results.features.length == 0)
															return;
														$.each(results.features,function(index1,item1){
															gra_arr.push(item1);
														});
														
														var ext = graphicsUtils.graphicsExtent(gra_arr);
														var center = ext.getCenter();
                      ...
                      else if(parent.global_add4_position_flag=='2'){
                      	standard_position_load(parent.global_res_id,'','','',true);
                      }
										}
                    ...
                    function standard_load() {
                        ...
                        queryTask_standard.execute(query_standard, function (results) {
                            ...
                            if(parent.global_add4_position_flag=='2'){
		                    			standard_position_load(parent.global_res_id,'','','',true);
		                    			parent.global_add4_position_flag="";
		                    		}
                        });
                        /*map.addLayer(standard_layer);
                         map.addLayer(village_layer);
                    ...
                    var draw_layer_school_part_mouse_over_handler = dojo.connect(draw_layer_school_part, "onMouseOver", function (evt) {
                    		map.setMapCursor("pointer");
                        $("#village_info_mini_win").html(evt.graphic.attributes.RESFULLNAME);
                        $("#village_info_mini_win").css({top: evt.pageY - 15, left: evt.pageX + 15});
                        $("#village_info_mini_win").show();
                    ...
                    var draw_layer_school_part_mouse_out_handler = dojo.connect(draw_layer_school_part, "onMouseOut", function (evt) {
                        map.setMapCursor("default");
                        //map.infoWindow.hide();
                        $("#village_info_mini_win").hide();
                    });
                    ...
                    var draw_layer_school_part_click_handler = dojo.connect(draw_layer_school_part, "onClick", function(evt){
                    		standard_layer_click(evt);
                    });
...
//						}
                    ...
                    var school_GraphicsLayer_mouse_over_handler = dojo.connect(school_GraphicsLayer, "onMouseOver", function (evt) {
										...
										var school_GraphicsLayer_part_mouse_over_handler = dojo.connect(school_GraphicsLayer_part, "onMouseOver", function (evt) {
										    map.setMapCursor("pointer");
										    school_part_mouse_over_when_draw_f(evt);
										});
										var school_GraphicsLayer_part_mouse_out_handler = dojo.connect(school_GraphicsLayer_part, "onMouseOut", function (evt) {
										    map.setMapCursor("default");
										    school_part_mouse_out_when_draw_f(evt);
										});
                    ...
                    function queryBuildFunc(v_id_temp, ids_str_temp, v_position) {
                        ...
                        queryTask_standard.execute(query_standard, function (results) {
                            ...
                            if(nav_type_index=="village"){
	                            ...
	                            if(village_saved_flag){
	                            	village_img = new PictureMarkerSymbol(village_ico, size, size);
	                            	village_graphic = new esri.Graphic(new Point(parseFloat(point_array[0]), parseFloat(point_array[1]), new SpatialReference({wkid: 4326})), village_img, {"village_id": v_id,"village_name":v_name_for_update});
	                            	village_layer.add(village_graphic);//绘制新的小区位置
	                            	village_saved_flag = false;
	                            }
                            }else if(nav_type_index=="school"){
                            	if (village_selected_gra_update != "" && village_selected_gra_update!=undefined){
                                school_GraphicsLayer.remove(village_gras_array[village_selected_gra_update.attributes.village_id]);//删除旧的小区位置	
	                            }
	                            if(village_saved_flag){
	                            	village_img = new PictureMarkerSymbol(school_ico, size, size);
	                            	village_graphic = new esri.Graphic(new Point(parseFloat(point_array[0]), parseFloat(point_array[1]), new SpatialReference({wkid: 4326})), village_img, {"school_id": v_id,"school_name":v_name_for_update});
	                            	school_GraphicsLayer.add(village_graphic);//绘制新的小区位置
	                            	village_saved_flag = false;
	                            }
                            }else if(nav_type_index=="enterprise"){
                            	if (village_selected_gra_update != "" && village_selected_gra_update!=undefined){
                                enterprise_GraphicsLayer.remove(village_gras_array[village_selected_gra_update.attributes.village_id]);//删除旧的小区位置	
	                            }
	                            if(village_saved_flag){
		                            village_img = new PictureMarkerSymbol(enterprise_ico, size, size);
		                            village_graphic = new esri.Graphic(new Point(parseFloat(point_array[0]), parseFloat(point_array[1]), new SpatialReference({wkid: 4326})), village_img, {"enterprise_id": v_id,"enterprise_name":v_name_for_update});
		                            enterprise_GraphicsLayer.add(village_graphic);//绘制新的小区位置
		                            village_saved_flag = false;
	                            }
                            }
                        });
                    ...
                    enterprise_GraphicsLayer.on("graphic-add", function (evt) {
										    ...
										    village_gras_array[id] = gra;
										    if (id == village_id_selected || id == global_village_id) {
										        ico_url = enterprise_ico_selected;
										        var size = village_ico_get_size(map.getZoom());
    ...
    $(".village_normal_screen").click(function(){
		...
		//小列表
		var pos_tab_seq_num = 0, pos_tab_begin_scroll = 0, pos_tab_page_list = 0, pos_tab_eaction = "", pos_v_name = "";
		function pos_tab_load_list() {
		    ...
		    pos_tab_listCollectScroll(true);
		}
		...
		function getPosTabParam(){
				pos_v_name = $.trim($("#school_search_text").val());
				return {
					"city_id":city_id,
					"bureau_no":'${sessionScope.UserInfo.CITY_NO}',
					"v_name":pos_v_name,
		...
		$("#pos_tab_div").scroll(function () {
		    ...
		    if (scrollTop / (contentH - viewH) >= 0.95) {
		        if (new Date().getTime() - pos_tab_begin_scroll > 500) {
		            pos_tab_page_list++;
		            pos_tab_listCollectScroll(false);
		        }
		        pos_tab_begin_scroll = new Date().getTime();
		    }
		});
		
		function pos_tab_listCollectScroll(flag) {
				var params = getPosTabParam();
		    var $list = $("#pos_tab_tbody");
		    $.post(url4Query_enterprise, params, function (data) {
		        data = $.parseJSON(data);
		        if(pos_tab_page_list==0){
		        	if(data.length){
		        		$("#pos_tab_total_num").text(data[0].C_NUM);
		        	}else{
		        		$("#pos_tab_total_num").text("0");
		        	}
		        }
		        for (var i = 0, l = data.length; i < l; i++) {
		          var d = data[i];
		...
		function pos_tab_clear_data() {
		    pos_tab_seq_num = 0, pos_tab_begin_scroll = 0, pos_tab_page_list = 0;
