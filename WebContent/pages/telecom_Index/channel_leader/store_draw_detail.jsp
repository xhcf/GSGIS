	...
	<div class="p_content">
				...
				<div class="basic_bottom clearfix">
					<div>
						...
						<ul>
							...
							<li>•  月&nbsp;环&nbsp;比&nbsp;：  <font id="month_rate">25.22%</font></li>
						</ul>
					</div>
					<!-- <div>
						<P>渠道效能</P>
					...
					<div>
						...
						<ul>
							<h2 style="margin-left:35px;">月累计发展</h2>
								<li>•  移动：  <font id="yd_xz">95,000</font></li>
								<li>•  宽带：   <font id="kd_xz">95,000</font></li>
								<li>•  电视：   <font id="itv_xz">95,000</font></li>
						</ul>
						<ul style="border-top:none;margin-top: -105px;margin-left: 120px;">	
							<h2 style="margin-left:30px;">日&nbsp;发&nbsp;展</h2>
								<li>•  移动：  <font id="yd_xz">95</font></li>
								<li>•  宽带：   <font id="kd_xz">9</font></li>
								<li>•  电视：   <font id="itv_xz">12</font></li>
						</ul>
					</div>
					<div>
						<P>发展质态</P>
						...
						<ul>
							<li>•  活&nbsp;跃&nbsp;率：   <font id="yd_xz">23.02%</font></li>
							<li>•  离&nbsp;网&nbsp;率：   <font id="kd_xz">33.28%</font></li>
							<li>•  存量用户：                       <font id="itv_xz">95,000</font></li>
							<li>•  流失用户：                       <font id="itv_xz">32,000</font></li>
						</ul>
					</div>
					<div>
						<P>发展效益</P>
		...
		<div  style="display: none;" class="nlfx">
			<div class="ability">
				...
				<div class="clearfix">
					<div class="fl xn_com xn_tree" style="margin-top:10px;">
						<h6 class="xn_title"><i></i>渠道日积分</h6>
						<span>日账期：
						...
						<table class="xn_table jf_table">
							...
							<tbody>
								<tr>
									<td>合计</td>
									<td id="curday_jf">9899</td>
									<td id="lastday_jf">999</td>
									<td id="day_rate">25.02%</td>
									<td id="month_jf">99,999</td>
								</tr>
								<tr>
									<td>发展积分</td>
									<td id="curday_fzjf">9899</td>
									<td id="lastday_fzjf">999</td>
									<td id="day_fzrate">25.02%</td>
									<td id="month_fzjf">99,999</td>
								</tr>
								<tr>
									<td>存量积分</td>
									<td id="curday_cljf">9899</td>
									<td id="lastday_cljf">999</td>
									<td id="day_clrate">25.02%</td>
									<td id="month_cljf">99,999</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="fl xn_com xn_tree" style="margin-top:10px;height:270px;">
						<h6 class="xn_title"><i></i>渠道月积分</h6>
						<table class="xn_table jf_table">
							<thead>
								<tr>
									<td>指标项</td>
							...
							<tbody>
								<tr>
									<td>合计</td>
									<td id="curmonth_jf">9899</td>
									<td id="lastmonth_jf">999</td>
									<td id="month_rate">25.02%</td>
									<td id="year_jf">99,999</td>
								</tr>
								<tr>
									<td>发展积分</td>
									<td id="curmonth_fzjf">9899</td>
									<td id="lastmonth_fzjf">999</td>
									<td id="month_fzrate">25.02%</td>
									<td id="year_fzjf">99,999</td>
								</tr>
								<tr>
									<td>存量积分</td>
									<td id="curmonth_cljf">9899</td>
									<td id="lastmonth_cljf">999</td>
									<td id="month_clrate">25.02%</td>
									<td id="year_cljf">99,999</td>
								</tr>
								<tr>
									<td>收入积分</td>
									<td id="curmonth_srjf">9899</td>
									<td id="lastmonth_srjf">999</td>
									<td id="month_srrate">25.02%</td>
									<td id="year_srjf">99,999</td>
								</tr>
								<tr>
									<td>其它积分</td>
									<td id="curmonth_qtjf">9899</td>
									<td id="lastmonth_qtjf">999</td>
									<td id="month_qtrate">25.02%</td>
									<td id="year_qtjf">99,999</td>
								</tr>
							</tbody>
						</table>
		...
		<div  style="display: none;" class="nlfx">
			<div class="ability">
				...
				<div class="clearfix">
					<div class="fl xn_com xn_tree" style="height:300px;margin-top: 10px;">
						<h6 class="xn_title"><i></i>发展效能</h6>
						<table class="xn_table fzxn_table">
							...
							<tbody>
								<tr>
									<td>合计</td>
									<td id="curmonth_xn">9899</td>
									<td id="lastmonth_xn">999</td>
									<td id="month_xnrate">25.02%</td>
									<td id="curday_xn">99,999</td>
									<td id="lastday_xn">99,999</td>
									<td id="day_xnrate">99,999</td>
								</tr>
								<tr>
									<td>手机</td>
									<td id="curmonth_xnsj">9899</td>
									<td id="lastmonth_xnsj">999</td>
									<td id="month_xnratesj">25.02%</td>
									<td id="curday_xnsj">99,999</td>
									<td id="lastday_xnsj">99,999</td>
									<td id="day_xnratesj">99,999</td>
								</tr>
								<tr>
									<td>宽带</td>
									<td id="curmonth_xnkd">9899</td>
									<td id="lastmonth_xnkd">999</td>
									<td id="month_xnratekd">25.02%</td>
									<td id="curday_xnkd">99,999</td>
									<td id="lastday_xnkd">99,999</td>
									<td id="day_xnratekd">99,999</td>
								</tr>
								<tr>
									<td>电视</td>
									<td id="curmonth_xnds">9899</td>
									<td id="lastmonth_xnds">999</td>
									<td id="month_xnrateds">25.02%</td>
									<td id="curday_xnds">99,999</td>
									<td id="lastday_xnds">99,999</td>
									<td id="day_xnrateds">99,999</td>
								</tr>
								<tr>
									<td>橙分期</td>
									<td id="curmonth_xncfq">9899</td>
									<td id="lastmonth_xncfq">999</td>
									<td id="month_xnratecfq">25.02%</td>
									<td id="curday_xncfq">99,999</td>
									<td id="lastday_xncfq">99,999</td>
									<td id="day_xnratecfq">99,999</td>
								</tr>
								<tr>
									<td>终端</td>
									<td id="curmonth_xnzd">9899</td>
									<td id="lastmonth_xnzd">999</td>
									<td id="month_xnratezd">25.02%</td>
									<td id="curday_xnzd">99,999</td>
									<td id="lastday_xnzd">99,999</td>
									<td id="day_xnratezd">99,999</td>
								</tr>
							</tbody>
						</table>

					</div>
					<div class="xn_com jf_day" style="margin-top:325px;">
		...
		<div  style="display: none;" class="nlfx">
			<div class="ability">
				...
				<div class="clearfix">
					<div class="fl xn_com xn_tree" style="margin-top:10px;height:270px;">
						...
						<table class="xn_table jf_table">
							...
							<tbody>
								<tr>
									<td>活跃率</td>
									<td id="curmonth_zt">9899</td>
									<td id="lastmonth_zt">999</td>
									<td id="month_ratezt">25.02%</td>
								</tr>
								<tr>
									<td>活跃用户数</td>
									<td id="curmonth_zthuser">9899</td>
									<td id="lastmonth_zthuser">999</td>
									<td id="month_ratezthuser">25.02%</td>
								</tr>
								<tr>
									<td>离网率</td>
									<td id="curmonth_ztlw">9899</td>
									<td id="lastmonth_ztlw">999</td>
									<td id="month_rateztlw">25.02%</td>
								</tr>
								<tr>
									<td>离网用户数</td>
									<td id="curmonth_ztluser">9899</td>
									<td id="lastmonth_ztluser">999</td>
									<td id="month_rateztluser">25.02%</td>
								</tr>
								<tr>
									<td>存量用户数</td>
									<td id="curmonth_ztcluser">9899</td>
									<td id="lastmonth_ztcluser">999</td>
									<td id="month_rateztcluser">25.02%</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="fr xn_com xn_two"  style="margin-top:10px;"> 
						<h6 class="xn_title"><i></i>活跃率趋势</h6>
						<div class="bar_com" >
		...
		<div  style="display: none;" class="nlfx">
			<div class="ability">
				...
				<div class="clearfix">
					<div class="fl xn_com xn_tree" style="margin-top:10px;height:300px;width: 49.3%">
					...
					<div class="fl xn_com xn_tree" style="margin-left:10px;;margin-top:10px;height:300px;width: 49.3%">
						<h6 class="xn_title"><i></i>成本构成</h6>
						<table class="xn_table jf_table">
							<thead>
								<tr>
									<td>指标项</td>
					...
					<div class="fr xn_com xn_tree"  style="margin-top:10px;width: 49.3%;float: left;"> 
						<h6 class="xn_title"><i></i>毛利率趋势</h6>
						<div class="bar_com" >
							<div id="line5" style="width: 100%;height: 200px;"></div>
						</div>
					</div>
					<div class="fr xn_com xn_tree"  style="margin-top:10px;width: 49.3%;float: left;margin-left: 10px;"> 
						<h6 class="xn_title"><i></i>成本构成</h6>
						<div class="bar_com" >
...
<script type="text/javascript">
	...
	$("#bar1").width(w2);
	$("#line1").width($(".p_content").width()/1.5);
