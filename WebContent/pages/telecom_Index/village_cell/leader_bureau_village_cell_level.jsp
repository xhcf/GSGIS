...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_area_dev_colorflow.css?version=2.1"/>'
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/bureau_geo_center.js?version=1.4"/>'
		...
		<link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_she_dui_page_win.css?version=2.4"/>' rel="stylesheet" type="text/css" media="all"/>
		<link href='<e:url value="/pages/telecom_Index/village_cell/css/leader_bureau_village_cell_level.css?version=2.4"/>' rel="stylesheet" type="text/css" media="all"/>
...
<style>
    ...
    .sub_summary_div .layui-layer-content {height:92%!important;overflow:hidden;}
...
<!-- 楼宇详情弹窗 shenruijie -->
<div class="build_more_win she_dui_view_win" id="detail_more" style="display:none;">
    <div class="titlea titleb">
        <div id="detail_more_draggable" style='text-align:left;width:90%;display: inline-block'>社队视图</div>
        <div class="titlec" onclick="$('#detail_more').hide()"></div>
    </div>
    <iframe width="100%" height="92%"></iframe>
</div>
...
<div style="clear:both ">
    ...
    <a href="javascript:backToEchart()" id="nav_fanhui" class="add_backcolor" style="display:block;"></a>
    ...
    <div style="position:relative;">
		  ...
		  <div class="region_switch_group_village_cell" style="z-index:100;">
		    <ul>
		      <!--<li region_type = 'city' style="display:none;">市</li>
		      <li region_type = 'bureau' style="display:none;">县</li>
		      <li region_type = 'sub'>支</li>
		      <li region_type = 'grid'>网</li>-->
		      <li class='active'>行政村</li>
		    </ul>
		  </div>
...
<script type="text/javascript">
    ...
    var indexContainer_url_bureau = '<e:url value="/pages/telecom_Index/common/jsp/indexTabs_dev.jsp" />';
    ...
    var indexContainer_url_village_cell = '<e:url value="/pages/telecom_Index/village_cell/smallTab/small_table_village_cell.jsp" />';
    ...
    var unused_build_div_handle = "";
	  ...
	  if(window.innerHeight<800){
		...
		var url_sum_sub = '<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary_village_cell.jsp" />';
		var url_sum_grid = '<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary_grid_village_cell.jsp" />';
		var sub_name = "";
		var grid_name = "";
		var substation = "";
		var grid_id_short = "";
    ...
    function openMarketWin(tab_index,condition){
	    	if(tab_index==undefined)
				...
				var org_name = "";
	      if(org_type=="sub"){
	        $("#sub_market_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_market_new.jsp' />?tab_index="+tab_index+"&condition="+condition+"&city_id="+city_id+"&substation="+substation_for_summary_pop);
	        org_name = "支局";
	      }else if(org_type=="grid"){
	      	$("#sub_market_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_market_new.jsp' />?tab_index="+tab_index+"&condition="+condition+"&city_id="+city_id+"&substation="+substation_for_summary_pop+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
	      	org_name = "网格";
	      }
    ...
    function openResourceWin(tab_index){
	      ...
	      closeOtherLayerWin();
	      if(org_type=="sub"){
					$("#sub_resource_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_resource_new.jsp' />?tab_index="+tab_index + "&substation=" + substation_for_summary_pop);
					org_name = "支局";
				}else if(org_type=="grid"){
					tab_index = 1;
					$("#sub_resource_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_resource_new.jsp' />?tab_index="+tab_index+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
					org_name = "网格";
				}
    ...
    function openYXWin(tab_index,tab_index2){
      ...
      var org_name = "";
			if(org_type=="sub"){
				$("#sub_yx_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_yx_new.jsp' />?tab_index="+tab_index+"&tab_index2="+tab_index2+"&substation=" + substation_for_summary_pop);
				org_name = "支局";
			}else if(org_type=="grid"){
				$("#sub_yx_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_yx_new.jsp' />?tab_index="+tab_index+"&tab_index2="+tab_index2+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
				org_name = "网格";
			}
    ...
    function openCollectWin(tab_index,condition){
      ...
      var org_name = "";
			if(org_type=="sub"){
				$("#sub_collect_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_collect_new.jsp' />?tab_index="+tab_index + "&substation=" + substation_for_summary_pop+"&condition="+condition);
				org_name = "支局";
			}else if(org_type=="grid"){
				tab_index = 1;
				$("#sub_collect_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_collect_new.jsp' />?tab_index="+tab_index + "&substation=" + substation_for_summary_pop+"&condition="+condition+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
				org_name = "网格";
			}
    ...
    function openNewCollectWin(){
        ...
        closeOtherLayerWin();
        if(org_type=="sub"){
					$("#sub_collect_new_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_collect_new.jsp' />?substation=" + substation_for_summary_pop);
				}else if(org_type=="grid"){
					tab_index = 1;
					$("#sub_collect_new_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_collect_new.jsp' />?substation=" + substation_for_summary_pop+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
				}
    ...
    function openStockWin(tab_index,condition){
      ...
      var org_name = "";
			if(org_type=="sub"){
				$("#sub_stock_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_sub/summary_sub_stock_new.jsp' />?tab_index="+tab_index + "&substation=" + substation_for_summary_pop+"&condition="+condition);
				org_name = "支局";
			}else if(org_type=="grid"){
				tab_index = 1;
				$("#sub_stock_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_stock_new.jsp' />?tab_index="+tab_index + "&substation=" + substation_for_summary_pop+"&condition="+condition+"&grid_id="+grid_id_for_summary_pop+"&grid_id_short="+grid_id_short_summary_pop);
				org_name = "网格";
			}
      ...
      sub_stock_div_handle = layer.open({
		...
		showSummaryWindow = function(){
		  ...
		  $.post(url4Query, params, function(data) {
			...
			var params1 = {"eaction": "getVillageCellCnt"};
		  if(org_type=="sub"){
    ...
    function backToPrevLevel(region_index){
    	...
    	if(region_index == 0){
	    	...
	    	parent.loadSmallTab_village_cell(1,index_type,'',region_type_num);
	    	...
	    	parent.loadSmallTab_village_cell(2,index_type,city_id,region_type_num);
    	}
	  }
    ...
    function switch_region(region_type){
        ...
        //map.setExtent(extent_init.expand(1.5));
	      parent.loadSmallTab_village_cell(3,index_type,"");
	      if(mapZoom>=9)
        ...
        if(featureLayer_grid!="")
	      ...
	      parent.loadSmallTab_village_cell(4,index_type,"");
	      if(mapZoom>=9)
	      	map.centerAndZoom(map.extent.getCenter(),8);
	      //map.setExtent(extent_init.expand(1.5));
	    }else if(region_type=="village"){
	      ...
	      parent.loadSmallTab_village_cell(5,index_type,"");
	    }
	  }
    ...
    $(function () {
    		...
    		//行政村层级切换按钮
    		$(".region_switch_group_village_cell").show();
    		//parent.reposMapPosition();
				...
				parent.global_region_type = "village_cell";//20181206 默认右侧加载小区
				//var region_type_num = 0;
	        /*if(region_type=="city"){
	        	region_type_num = 1;
	        }else if(region_type=="bureau"){
				...
				parent.loadSmallTab_village_cell(2,city_id);
		      ...
		      $(this).on("click",function(){
		        ...
		        if(index_type_temp==6){
		          ...
		          var region_type_num = 0;
			        ...
			        parent.loadSmallTab_village_cell(region_type_num,index_type,'');
		        }
		      });
		    });
    ...
    function toGis() {//城关区，兰州市
        if (map != "") {
            try {
                ...
                map.destroy();
                map = "";
                parent.freshIndexContainer(indexContainer_url_bureau);
            } catch (e) {
                return;
            }
        }
        ...
        require(["esri/config",
                ...
                function (Config,
                    ...
                    operateVillage = function (village_id, st, addr, thiz) {
                        ...
                        //$("#village_cell_info_win").css({"left":cent_pos[0],"top":cent_pos[1]});
                    ...
                    parent.global_func_operateVillage = operateVillage;
...
//							skin: 'demo-class',
                    ...
                    featureLayer = new FeatureLayer(new_url_sub_vaild + sub_layer_index, {
                        definitionExpression: "BRANCH_TYPE ='b1' ",
                    ...
                    clickToGrid_village_cell = function(substation, sub_name, thiz, zoom, grid_name, station_id){
                    		subToGridFlag = false;
                        clickToGrid_function_village_cell(substation, sub_name, thiz, zoom, grid_name, station_id);
                        //village_load("RES_ID = '"+station_id+"' AND STATUS = 1");
                        ////village_load(station_id);
                        //village_where = "report_to_id = '"+station_id+"'";
                        //village_service_load();
                    ...
                    function clickToGrid_function_village_cell(substation, sub_name, thiz, zoom, grid_name, station_id) {
                        grid_selected_id = station_id;
                        $(thiz).siblings().removeClass("tr_click_background_color");//background-color: #c1c1c1;
                        $(thiz).siblings().addClass("tr_default_background_color");
                        $(thiz).removeClass("tr_default_background_color");
                        ...
                        if (sub_gra_last_temp == undefined || sub_gra_last_temp == "") {
                            ...
                            /*var zoom = map.getZoom();
                             currentOpacity = getLayerOpacity(zoom);
                             sub_gra_last.setSymbol(highlightSymbol_sub_click);*/
                            subToGrid_toGrid_village_cell(sub_gra_last_temp, sub_selected_geometry, sub_gra_last_temp.attributes, station_id, grid_name, false, zoom);
                        }
                    }
                        ...
                        if (parent.global_substation == substation && subToGridFlag) {
                            ...
                            $.post(url4Query,{"eaction":"getGridUnionOrgCodeByReportToId","report_to_id":station_id},function(data){
                            	...
                            	$.post(url4Query, {"eaction": "getGridIdByGridUnionOrgCode", "grid_id": data.STATION_NO}, function (data1) {
                            		...
                            		grid_name_for_sum_pop = grid_name;
...
//									var linesymbol = new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color(qx_all_line_color), 1.5);
                    ...
                    var subToGrid = function (graphics, sub_selected_geometry, sub_attr) {
                        ...
                        substation = sub_attr.SUBSTATION_NO;
                    ...
                    var subToGrid_toGrid_village_cell = function (graphics, sub_selected_geometry, sub_attr, station_id, grid_name_selected, zoomable, zoom1) {
                        back_to_ext = map.extent;
                                ...
                                if (village_position_operat) {
                                    ...
                                    if (zoom1 == 9) {//可能是小区框选功能
                                        map.centerAndZoom(getGravityCenter(graphics.geometry, graphics.geometry.rings), zoom1);
                                    		...
                                    		var ext = graphics.geometry.getExtent();
                                    		ext = ext.offset(0.085,0);
                    ...
                    //从网格返回支局
                    backToSub = function () {
                    		substation = parent.global_substation;
                    		org_type = "sub";
                    ...
                    backToCity = function () {
                        ...
                        //parent.loadSmallTab_village_cell(parent.global_current_flag,index_type);
                        //parent.updateTabPosition();
                        //parent.updatePosition(parent.global_current_flag);
                        //backToPrevLevel(1);
                        $("#tools_scroll").hide();
											 var city_center_point = [city_center_zoom_gis[city_id].lng,city_center_zoom_gis[city_id].lat];
                       map.centerAndZoom(city_center_point,city_center_zoom_gis[city_id].zoom);
                    }
                    ...
                    featureLayer.on("update-end", function () {
                        $.post(url4Query_leader, {"eaction": "getSubName", "city_id": city_id}, function (data) {
                            data = $.parseJSON(data);
                            //data = data[0];
                            if (data.length == 0)
                                return;
                      ...
                      else if(parent.global_entrance_type == "village_cell"){
                      	substation_for_summary_pop = parent.global_substation;
                      	sub_summary_div_name = parent.global_position[3];
                        sub_name_for_sum_pop = parent.global_position[3];
                      	clickToGrid_village_cell(parent.global_substation, parent.global_position[3], "", -1, parent.global_position[4], parent.global_report_to_id);
                      	operateVillage(parent.global_village_cell_id);
                      	$.post(url4Query,{"eaction":"getGridUnionOrgCodeByReportToId","report_to_id":parent.global_report_to_id},function(data){
													data = $.parseJSON(data);
													if(data!=null)
														parent.global_grid_id = data.STATION_NO;
														parent.freshIndexContainer(indexContainer_url_grid+"?global_pos_vc_flag=1");
												});
                      }
...
//						}
    ...
    var backToEchart = function () {
        ...
        var url4mapBackTop = '<e:url value="/pages/telecom_Index/sandbox_leader/leader_province_level.jsp"/>';
        parent.freshMapContainer(url4mapBackTop);
        global_region_type = 1;
        parent.freshIndexContainer(indexContainer_url_village_cell+"?region_type=1");
        //parent.toggleModelButton();
    }
    parent.backToEchart = backToEchart;
    ...
    parent.resize_vill_win = function(flag){
    	if(flag=="open"){
    		...
    		$("#village_cell_info_win").addClass("half_win");
        $("#village_cell_info_win").removeClass("full_win");

    	}else{
    		$("#village_cell_info_win").addClass("full_win");
    		$("#village_cell_info_win").removeClass("half_win");
    	}
    	var cent_pos = getCenter("#village_cell_info_win");
      $("#village_cell_info_win").css({"left":cent_pos[0]*2*(2/3),"top":cent_pos[1]});
    }

    parent.resize_she_dui_view_win = function(flag){
    	if(flag=="open"){//右侧打开
    		//$("#detail_more").css({"width":"90%"});
    		//$("#detail_more").css({"left":"5%"});
    		$("#detail_more").removeClass("sheDuiFullWin");
    		$("#detail_more").addClass("sheDuiHalfWin");

    	}else{//右侧收起
    		//$("#detail_more").css({"width":"70%"});
    		//$("#detail_more").css({"left":"15%"});
    		$("#detail_more").removeClass("sheDuiHalfWin");
    		$("#detail_more").addClass("sheDuiFullWin");
    	}
