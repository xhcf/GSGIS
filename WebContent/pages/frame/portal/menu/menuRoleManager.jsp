		...
		<script type="text/javascript">
			...
			function formatterCZ1(value,rowData){
				...
				if(rowData.INFLUENCE_TYPE!='1')
					content='<a class="easyui-linkbutton" href="javascript:void(0);" onclick="deleteRole(\''+rowData.ROLE_CODE+'\');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
				return content;
			}
			...
			function formatterCZ2(value,rowData){
				var content="--";
				if(rowData.INFLUENCE_TYPE!='1')
					content='<a class="easyui-linkbutton" href="javascript:void(0);" onclick="addRole(\''+rowData.ROLE_CODE+'\');"><i class="fa fa-plus-square-o" aria-hidden="true"></i></a>';
				return content;
			}
