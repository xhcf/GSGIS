...
<script type="text/javascript"> 
	...
	function formatterExt(value,rowData){
		var res = '<a href="javascript:void(0);" title="编辑" onclick="updExt(\''+rowData.ATTR_CODE+'\')"><i class="fa fa-edit" aria-hidden="true"></i></a>'+
				  '<a href="javascript:void(0);" title="删除" onclick="delExt(\''+rowData.ATTR_CODE+'\')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>'+
				  '<a href="javascript:void(0);" title="子系统" onclick="setSubSystem(\''+rowData.ATTR_CODE+'\')"><i class="fa fa-desktop" aria-hidden="true"></i></a>';
		return res;
	}
...
<c:datagrid url="/pages/frame/portal/user/ext/ExtAction.jsp?eaction=LIST&attr_code=${param.attr_code}&attr_name=${param.attr_name}&value_type=${param.value_type}&model_type=${param.model_type}" id="ext_table" pageSize="15" fit="true"
					download="true" nowrap="false" style="width:auto;height:500px;" toolbar="#toobars" border="false">
	<thead>
		<tr>
