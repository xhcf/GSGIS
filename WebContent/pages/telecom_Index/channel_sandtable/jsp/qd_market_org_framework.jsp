...
<script>
  ...
  function initListDiv(level,city_id,bureau_id,branch_id,grid_id){
    ...
    if(level==1)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/jsp/qd_market.jsp"/>');
    else if(level==2)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/jsp/qd_market.jsp"/>?city_id='+city_id);
    else if(level==3)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/jsp/qd_market.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id);
    else if(level==4)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/jsp/qd_market.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id);
    else if(level==5)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/jsp/qd_market.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&grid_id="+grid_id);
  }
