...
<e:style value="/resources/themes/base/boncBase@links.css"/>
	...
	<e:if condition="${param.endDate!=null&&param.endDate!=''&&param.endDate!='null'}">
		...
		<c:datagrid url="/pages/frame/log/logAction.jsp?eaction=userLoginRank&loginDate=${loginDate_val}&endDate=${endDate_val}" id="visitLogListTable" pageSize="15" download="访问日志" fit="true" border="false" toolbar="#tb">
			<thead>
				<tr>
