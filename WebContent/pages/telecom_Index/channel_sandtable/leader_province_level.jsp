...
<head>
  ...
  <script src='<e:url value="/pages/telecom_Index/channel_sandtable/js/channel_geo_center.js"/>' charset="utf-8"></script>
  ...
  <script src='<e:url value="/pages/telecom_Index/channel_sandtable/js/xnglToEchartMap_channel_leader.js?version=1.3"/>'
...
<div style="position:relative;">
  <div class="leader_tools" id="tools_scroll">
    <ul class="nav_index_group">
      <li id="nav_index_broad_home_percent"><span></span><a href="javascript:void(0)">渠道概览</a></li>
...
<script type="text/javascript">
  ...
  var sql_url = '<e:url value="/pages/telecom_Index/channel_sandtable/channel_action/channel_leaderAction.jsp" />?eaction=getcityDataEcharts&flg=1&acct_month='+${initMonth}+'&acct_day='+${initDay};
  var sql_urlxn = '<e:url value="/pages/telecom_Index/channel_sandtable/channel_action/channel_leaderAction.jsp" />?eaction=getcityDataEcharts_xn&flg=1&acct_month='+${initMonth}+'&acct_day='+${initDay};
  var sql_url1 = '<e:url value="/pages/telecom_Index/channel_sandtable/channel_action/channel_leaderAction.jsp" />?eaction=xn_rank&region_type=1&acct_month='+${initMonth};


  //echart地图要加载的页面
  var url4mapToWhere = '<e:url value="/pages/telecom_Index/channel_sandtable/leader_province_level.jsp"/>';

  var url4mapInsideWhere = '<e:url value="/pages/telecom_Index/channel_sandtable/leader_city_level.jsp"/>';
  ...
  function load_map(region_type){
    ...
    if(region_type=="city"){
      url4mapToJson = '<e:url value="/pages/telecom_Index/channel_sandtable/js/gan_su_geo.json" />';
      $.get(url4mapToJson, function (cityJson) {
        ...
        if(index_type== 0){
        	...
        	//url4echartmap = sql_index+'?eaction=tab1_index_bottom&region_type='+index_type+"&acct_month="+'${acc_month_tab1.ACCT_MONTH}';//"region_type":region_type,"acct_month":'${acc_month_tab1.ACCT_MONTH}'
        	//setDataToEchartMap(params, url4echartmap, url4mapToWhere);
        	//${acc_month_tab1.ACCT_MONTH}
        	url4echartmap1 = sql_index+'?eaction=tab1_index_bottom&region_type='+(index_type+1)+"&acct_month="+'${acc_month_tab1.ACCT_MONTH}';//"region_type":region_type,"acct_month":'${acc_month_tab1.ACCT_MONTH}'
        	url4echartmap = url4Query+'?eaction=index_bureau';
        	url4channeltype = url4Query+'?eaction=index_channel_type';
        	setDataToEchartMap_bar_bureau(params, url4echartmap, url4echartmap1, url4mapToWhere,url4channeltype,sql_url,sql_urlxn);
      ...
      url4mapToJson = '<e:url value="/pages/telecom_Index/channel_sandtable/js/gan_su_geo.json" />';
      //url4mapToJson = '<e:url value="/pages/telecom_Index/channel_sandtable/js/gansu3.json" />';
      $.get(url4mapToJson, function (cityJson) {
        echarts.registerMap(province_name_short, cityJson);
        //chart_map = echarts.init(document.getElementById('pagemap'),"dark");
