        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'分公司',align:'center',halign:'center',width: sub_width*0.28,
                        formatter:function(value,rowData){
                            return "<span title='" + value + "'>" + value + "</span>";
                        }
                    },
                    {
                        field:'USE_RATE1',title:'保有率',align:'center',halign:'center',width: sub_width*0.29,sortable:true,
                        formatter:function(value,rowData){
                    ...
                    {
                        field:'XY_RATE1',title:'续约率',align:'center',halign:'center',width: sub_width*0.3,sortable:true,
                        formatter:function(value,rowData){
                        	if(value!=null&&value!=undefined&&value!=-1){
                                return num_formatter(value);
                            }else
            ...
            onLoadSuccess:function (data) {
            	...
            	for(var i = 0,l = dataRows.length;i<l;i++){
                    if(dataRows[i].USE_RATE1 >=98){
                    	level_num[0] += 1;
                    }else if (dataRows[i].USE_RATE1 >=97 && dataRows[i].USE_RATE1 < 98 ){
                    	level_num[1] += 1;
                    }else if (dataRows[i].USE_RATE1 >=96 && dataRows[i].USE_RATE1 < 97 ){
                    	level_num[2] += 1;
                    }else if (dataRows[i].USE_RATE1 >=95 && dataRows[i].USE_RATE1 < 96 ){
                    	level_num[3] += 1;
                    }else if (dataRows[i].USE_RATE1 >=94&& dataRows[i].USE_RATE1 < 95){
                    	level_num[4] += 1;
                    }else if (dataRows[i].USE_RATE1 < 94 ){
                    	level_num[5] += 1;
                    }
                }
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'区县',align:'left',halign:'center',width: sub_width*0.28,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'>" + value + "</div>";
                        }
                    },
                    {
                        field:'USE_RATE1',title:'保有率',align:'center',halign:'center',width: sub_width*0.23,sortable:true,
                        formatter:function(value,rowData){
                        	 if(value!=null&&value!=undefined&&value!=-1){
                                 return num_formatter(value);
                             }else
                    ...
                    {
                        field:'XY_RATE1',title:'续约率',align:'center',halign:'center',width: sub_width*0.23,sortable:true,
                        formatter:function(value,rowData){
                        	if(value!=null&&value!=undefined&&value!=-1){
                                return num_formatter(value);
                            }else
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'支局',align:'left',halign:'center',width: sub_width*0.28,
                        formatter:function(value,rowData){
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'网格',align:'left',halign:'center',width:sub_width*0.28,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'><a href='javascript:void(0);' onclick='javascript:parent.inside("+rowData.LATN_ID+")'>" + value + "</a></div>";
                        }
                    },
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'小区',align:'left',halign:'center',width: sub_width*0.26,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'><a href='javascript:void(0);' onclick='javascript:parent.inside(\""+rowData.LATN_ID+"\")'>" + value + "</a></div>";
                        }
                    },
