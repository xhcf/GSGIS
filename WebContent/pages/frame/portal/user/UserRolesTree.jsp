...
<e:q4l var="rolesOfUserObj" sql="frame.user.rolesOfUserObj"></e:q4l>
<e:set var="rolesOfUserStrList" value=""></e:set>
<e:forEach items="rolesOfUserObj.list" var="rolesOfUserItem">
   <e:set var="rolesOfUserStrList" value="${rolesOfUserStrList},${rolesOfUserItem.ROLES}"></e:set>
</e:forEach>
<e:if condition="${rolesOfUserStrList !=null && rolesOfUserStrList ne ''}">
	<e:set var="rolesOfUserStrList" value="${e:substring(rolesOfUserStrList,1,rolesOfUserStrList.length())}"/>
</e:if>
...
<html>
  <head>
    ...
    var tempSelectRole=[];
    rolesOfUser='${rolesOfUserStrList}'.split(',');
