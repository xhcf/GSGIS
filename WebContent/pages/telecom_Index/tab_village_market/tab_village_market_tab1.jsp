...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sandbox_leader/css/lead_tab.css?version=1.3.0" />'  rel="stylesheet" type="text/css"
          media="all">
    <script src='<e:url value="/pages/telecom_Index/common/js/vue.min.js"/>' charset="utf-8"></script>
    <style>
        #tools{height:95%;}
...
<div class="sub_box grab_tab">
    <div style="height:96.5%;width:100%;margin:0.3% auto;" id="tab_div">
        ...
        <div class="tab_box table_cont_wrapper" id="table_test">
            <div class="sub_">
...
<script type="text/javascript">
    ...
    $(function(){
        init_tab_height = $("#tab_div").height() - 91 - $(".big_table_title").height() - $(".search").eq(0).height() - $(".search").eq(1).height();
