...
<html>
	...
	<div id="tbar">
		...
		<form id="editForm" method="post" action="<e:url value="/pages/frame/portal/subsystem/SubsystemEdit.jsp"/>">
					<input type="hidden" id="editSysId" name="subsystemId"/>
		</form>
	</body>
</html>