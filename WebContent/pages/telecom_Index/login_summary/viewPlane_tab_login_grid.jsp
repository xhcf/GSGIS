  ...
  <link href='<e:url value="/resources/css/main.css"/>' rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			var table_row_size = getTableRows2();
		...
		function showDetail(latn_id,bureau_no,branch_no,grid_id){
			if(grid_id=='')
				grid_id = '999';
			window.open("<e:url value='pages/telecom_Index/login_summary/viewPlane_tab_login_detail.jsp' />?city_id="+latn_id+"&bureau_id="+bureau_no+"&branch_id="+branch_no+"&grid_id="+grid_id+"&begin="+begin+"&end="+end, "", "");
		}
	</script>
</head>
<body>
			...
			<div class="tab_box">
				<div class="sub_">
					...
					<div class="sub_b" style="border:0px;width:97.5%;margin:0px auto;">
						...
						<c:datagrid
								url="pages/telecom_Index/common/sql/viewPlane_tab_login_action.jsp?eaction=grid&city_id=${param.city_id}"
							...
							<thead>
								<tr>
									...
									<th field="EXT9" width="20%" align="left" halign="center">网格</th>
									<th field="LOGIN_NUM" width="23%" align="left" halign="center">登录次数</th>
									<th field="LOGIN_USER_NUM" width="23%" align="left" halign="center" formatter="font_clickable_formatter2">使用用户数</th>
								</tr>
							</thead>
						</c:datagrid>
					</div>
