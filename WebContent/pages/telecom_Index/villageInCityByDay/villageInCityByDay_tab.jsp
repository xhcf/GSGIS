...
<div class="sub_box grab_tab">
    <div style="height:96.5%;width:100%;margin:0.3% auto;" id="tab_div">
        <div class="big_table_title"><h4>城&nbsp;中&nbsp;村&nbsp;攻&nbsp;坚&nbsp;活&nbsp;动&nbsp;日&nbsp;报</h4></div>
...
<script type="text/javascript">
    ...
    var begin = 0,end = 0, seq_num = 0, begin_scroll = 0, page_list = 0, query_flag=2, query_sort = '0', eaction = "get_villageInCity_attack_day",acct_mon='';
    ...
    $(function(){
        init_tab_height = document.body.offsetHeight*0.94 - 62 - $(".big_table_title").height() - $(".search").eq(0).height() - $(".search").eq(1).height();
    ...
    function doExcel() {
        ...
        //下载的文件名称拼接
        var fileName = '城中村攻坚活动日报'+'_'+beginDate+'.xlsx';

        var url = "<e:url value='villageInCityByDay_ExcelDownload.e?beginDate="+beginDate+"&city_id="+city_id_temp+"&file=1'/>";
