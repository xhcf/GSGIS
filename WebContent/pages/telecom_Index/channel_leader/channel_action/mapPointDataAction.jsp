...
<e:switch value="${param.eaction}">
  ...
  <e:case value="getBureauNoByBurName">
    <e:q4o var="latnId">
      SELECT distinct(bureau_no) bureau_no FROM ${gis_user}.DB_CDE_GRID WHERE bureau_name = '${param.bureau_name}' AND ROWNUM = 1
    </e:q4o>
    ${e:java2json(latnId)}
  </e:case>
  ...
  <e:case value="deve">
    <e:q4o var="obj">
		    SELECT
		  	...
		  	FROM GIS_DATA.TB_DW_GIS_ZHI_JU_INCOME_MON M,
		       GIS_DATA.TB_DW_GIS_ZHI_JU_INCOME_D   D
		 	WHERE M.FLAG = D.FLAG
			   AND M.LATN_ID = D.LATN_ID
