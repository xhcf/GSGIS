		...
		<script type="text/javascript">
			...
			function formatterCZ1(value,rowData){
				...
				if(rowData.INFLUENCE_TYPE!='1')
					content='<a class="easyui-linkbutton" title="删除" href="javascript:void(0);" onclick="deleteUser(\''+rowData.USER_ID+'\');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
				return content;
			}
			...
			function formatterCZ2(value,rowData){
				var content="--";
				if(rowData.INFLUENCE_TYPE!='1')
					content='<a class="easyui-linkbutton" title="添加" href="javascript:void(0);" onclick="addUser(\''+rowData.USER_ID+'\');"><i class="fa fa-plus-square-o" aria-hidden="true"></i></a>';
				return content;
			}
		...
		<tr>
			<td width="50%">
				<div id="tb1">
					<form id="loginLogForm" method="post" name="loginLogForm"  action="">
						...
						<div class="search-area">
							登陆ID：<input id="loginIdForHasSelect"  type="text" name="loginIdForHasSelect" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 50px">
				...
				<c:datagrid url="/pages/frame/portal/role/RoleAction.jsp?eaction=getHasSelectUsers&currentNodeId=${param.currentNodeId }" id="hasSelectUsersTable" pageSize="10"  style="width:100%;height:400px;"  toolbar="#tb1">
					<thead>
						<tr>
							<th field="LOGIN_ID" width="30%"> 登陆ID </th>
							<th field="USER_NAME" width="30%"> 用户姓名 </th>
							<th field="CZ1" width="40%" align="center" formatter="formatterCZ1"> 操作 </th>
						</tr>
					</thead>
				</c:datagrid>
			</td>
			<td width="50%">
				<div id="tb2">
					<form id="loginLogForm" method="post" name="loginLogForm"  action="">
						<h2>未选择的用户</h2>
						<div class="search-area">
							登陆ID：<input id="loginIdForNeedSelect"  type="text" name=""loginIdForNeedSelect"" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 50px">
				...
				<c:datagrid url="/pages/frame/portal/role/RoleAction.jsp?eaction=getNeedSelectUsers&currentNodeId=${param.currentNodeId }" id="needSelectUsersTable" pageSize="10" style="width:100%;height:400px;" title=""  toolbar="#tb2">
					<thead>
						<tr>
