...
<html>
  ...
  <body>
    	...
    	<div id="tree_panel" class="easyui-panel" title="" fit="true" border="false" data-options="fit:true, border:false,toolbar:'#tb'" style="overflow-y:scroll!important;">
		...
		<!-- //新建 -->
		<div id="dialog_menuAdd" style="width:800px;height:400px;top: 40px">
		...
		<!-- //修改-->
		<div id="dialog_menuEdite" style="width:800px;height:400px;top: 40px">
