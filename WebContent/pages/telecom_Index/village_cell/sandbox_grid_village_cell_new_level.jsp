...
<head>
    ...
    <!--<link href='<e:url value="/pages/telecom_Index/common/css/build_view_new.css?version=1.0"/>' rel="stylesheet" type="text/css" media="all" />-->
            ...
            <div style="width:100%;padding-right:17px;">
                <table class="build_village_tab">
                    <tr>
                        ...
                        <th style="width: 300px">四级地址</th>
                        <th style="width: 60px">住户数</th>
                        <th style="width: 70px">宽带用户</th>
                        <th style="width: 60px">OBD数</th>
                        <th style="width: 70px">营销派单</th>
...
<script type="text/javascript">
    ...
    var url4Query_sandSummary = '<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary_grid_village_cell.jsp" />';
    ...
    if(window.innerHeight<800){
      ...
      function openMarketWin(tab_index,condition){
        closeOtherLayerWin();
            $("#sub_market_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_market_new.jsp' />?tab_index="+tab_index+"&condition="+condition+"&city_id="+city_id+"&substation="+substation+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
    ...
    $("#sub_summary_to_resource2").on("click",function(){
      ...
      function openResourceWin(tab_index){
      	if(tab_index==undefined)
      		tab_index = 0;
        closeOtherLayerWin();
            $("#sub_resource_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_resource_new.jsp' />?tab_index="+tab_index+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openYXWin(tab_index,tab_index2){
        closeOtherLayerWin();
            $("#sub_yx_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_yx_new.jsp' />?tab_index="+tab_index+"&tab_index2="+tab_index2+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openCollectWin(tab_index,condition){
        closeOtherLayerWin();
            $("#sub_collect_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_collect_new.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openNewCollectWin(){
            closeOtherLayerWin();
            $("#sub_collect_new_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_collect_new.jsp' />?substation=" + substation+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
            sub_collect_div_handle = layer.open({
                title: '竞争收集',
                type: 1,
                shade: 0,
      ...
      function openStockWin(tab_index,condition){
          closeOtherLayerWin();
          $("#sub_stock_div").load("<e:url value='/pages/telecom_Index/village_cell/summary_inside_grid/summary_grid_stock_new.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function showSummaryWindow(){
          ...
          //行政村数
	        $.post(url4Query_sandSummary,{"eaction":"getVillageCellCnt","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
          ...
          //营销
				  /*$.post(url4Query_sandSummary,{"eaction":"getYxSummary","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
			        		data = $.parseJSON(data);
			        		if(data!=null){
          ...
          //精准总数
          /*$.post(url4Query_sandSummary,{eaction:"get_jz_count",grid_union_org_code:grid_id},function(data){
              data = $.parseJSON(data);
              if(data!=null){
          ...
          //异网总数
          /*$.post(url4Query_sandSummary,{eaction:"get_yw_count",grid_union_org_code:grid_id},function(data){
              data = $.parseJSON(data);
              if(data!=null){
          ...
          //日执行率、月执行率
          /*$.post(url4Query_sandSummary,{eaction:"get_jz_rate",grid_union_org_code:grid_id},function(data){
              data = $.parseJSON(data);
              if(data!=null){
                  $("#summary_jz_exec_lv_day").text(data.RATE_DAY);//营销 精准 日执行率
                  $("#summary_jz_exec_lv_month").text(data.RATE_MONTH);//营销 精准 月执行率
          ...
          /*$.post(url4Query_sandSummary,{eaction:"get_yw_rate",grid_union_org_code:grid_id},function(data){
              data = $.parseJSON(data);
              if(data != null){
            	  //暂无数据写死
