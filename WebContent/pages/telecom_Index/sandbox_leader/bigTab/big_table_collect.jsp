...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_table.css"/>' rel="stylesheet" type="text/css"
          media="all"/>
    <link href='<e:url value="/pages/telecom_Index/sandbox_leader/css/lead_tab.css?version=1.1" />' rel="stylesheet"
          type="text/css"
          media="all">
    <style>
        ...
        /*竞争收集统计 小区*/
        .tab0_vill tr:first-child th:first-child{width:3%;}
        .tab0_vill tr:first-child th:nth-child(2){width:9%;}
        ...
        .tab0_vill tr:first-child th:nth-child(8){width:5%;}
        .tab0_vill tr:first-child th:nth-child(9){width:5%;}

        .tab0_vill tr:first-child th:nth-child(10){width:35%;}

        .tab0_vill tr:first-child th:nth-child(11){width:5%;}
        .tab0_vill tr:first-child th:nth-child(12){width:5%;}
        .tab0_vill tr:first-child th:nth-child(13){width:5%;}


        .tab0_vill tr:nth-child(2) th:first-child{width:5%;}
        .tab0_vill tr:nth-child(2) th:nth-child(2){width:5%;}
        .tab0_vill tr:nth-child(2) th:nth-child(3){width:5%;}
        ...
        .body0_vill tr td:first-child{width:3%!important;}
        .body0_vill tr td:nth-child(2){width:9%!important;}
        ...
        .body0_vill tr td:nth-child(8){width:5%!important;}
        .body0_vill tr td:nth-child(9){width:5%!important;}

        .body0_vill tr td:nth-child(10){width:5%!important;}
        ...
        .body0_vill tr td:nth-child(15){width:5%!important;}
        .body0_vill tr td:nth-child(16){width:5%!important;}

        .body0_vill tr td:nth-child(17){width:5%!important;}
        .body0_vill tr td:nth-child(18){width:5%!important;}
        .body0_vill tr td:nth-child(19){width:5%!important;}
                        ...
                        <div id="big_table_content_0" style="margin-right: 14px">
                            <table style="width: 100%" class="table1 tab0_other" id="table_head2">
                                <tr>
                                    ...
                                    <th width="75" rowspan="2">当日新增数</th>
                                    <th width="75" rowspan="2">当日修改数</th>
                                    <th colspan="7">异网宽带收集情况</th>
                                    <th width="75" rowspan="2">未装宽带</th>
                                </tr>
                                <tr>
                                    <th width="75">异网总数</th>
                                    <th width="75">移动</th>
                            ...
                            <table style="width: 100%" class="table1 tab0_vill" id="table_head3">
                                <tr>
                                    ...
                                    <th rowspan="2">当日新增数</th>
                                    <th rowspan="2">当日修改数</th>
                                    <th colspan="7">异网宽带收集情况</th>
                                    <th rowspan="2">未装宽带</th>
