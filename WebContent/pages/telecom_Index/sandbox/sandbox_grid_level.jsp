...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sandbox_compete/css/add6_info_list_win.css?version=1.9" />'
    rel="stylesheet" type="text/css" media="all"/>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/js_constant.js?version=4.3"/>' charset="utf-8"></script>
    ...
    <link href='<e:url value="/pages/telecom_Index/common/css/datagid_reset.css"/>' rel="stylesheet" type="text/css"
          media="all"/>
    <link href='<e:url value="/pages/telecom_Index/sandbox_compete/css/nav_query_table_wrapper.css?version=1.8" />'
          rel="stylesheet" type="text/css" media="all"/>
    <%--<link href='<e:url value="/resources/themes/common/css/reset.css?version=1.2"/>' rel="stylesheet" type="text/css"--%>
          <%--media="all"/>--%>
    <link href='<e:url value="/pages/telecom_Index/sandbox/css/sandbox_sub_level.css?version=1.38"/>' rel="stylesheet" type="text/css"
          media="all"/>
</head>
<tbody class="body_padding" style="position:relative;background-color:transparent;width:100%;height:100%;">
<style>
    html, body, #map {
        height: 100%;
        margin: 0;
...
<div class="village_info_win new_beta" id="village_info_win" style="display: none;">
    ...
    <div class="bulid_village_btn village_edit" style="top:72px;width:152px;">
        <e:if condition="${sessionScope.UserInfo.LOGIN_ID eq 'admin' || sessionScope.UserInfo.LOGIN_ID eq 'gsdx'}">
    ...
    <div class="tab_box">
        ...
        <div style="display:none;">
            ...
            <!--表头-->
            <div class="village_m_tab" style="width:98%;padding-right:16px;">
            ...
            <div class="village_m_tab7" style="width:97.8%;">
...
<div id="execute_win" style="display:none;">
		<div style="display:block;width:100%;padding: 0px;margin:0px;overflow:hidden;">
		<div class="market_exe_info" style="height:120px;">
			<div class="exe_user_info" style="padding-left:2%;">
				联系人：<span id="cell_exe_constractor" style="margin-right:50px;"></span> 联系电话：<span
...
<script type="text/javascript">
    ...
    var grid_id_short = parent.global_grid_id_short;
    
    //var standard_collect_where = "COLLECT_FLG is not null and branch_type = 'a1'";
    var standard_collect_where = "COLLECT_FLG is not null AND serial_no IN('99999310','99999318','99999319') and grid_id = "+grid_id_short;
    var village_where = "LATN_ID = " + city_id + " and grid_id = '"+grid_id_short+"'";
    var yingxiao_where = "latn_id = "+ city_id + " and yx_flg is not null and grid_id = '"+grid_id_short+"'";
    ...
    function execute_show(prod_inst_id){
    	
    	//$("#execute_win").show();
    	$.post(url4Query_sandBox,{"eaction":"executeOrderGet","prod_inst_id":prod_inst_id},function(data){
    		data = $.parseJSON(data);
    		$("#cell_exe_constractor").text(data.CONTACT_CONTPERSON);
    		$("#cell_exe_constract_num").text(data.CONTACT_TEL);
    		layer.open({
                    title: ['营销执行', 'line-height:32px;text-size:30px;height:32px;'],
                    //title:false,
                    type: 1,
                    shade: 0,
                    area: ["450px", "220px"],
        ...
        require(["esri/config",
                ...
                function (Config,
                    ...
                    var highlightSymbol_sub_mouse_over = new SimpleFillSymbol(
                            ...
                            new SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new Color([highlight_sub_mouse_over_color[0], highlight_sub_mouse_over_color[1], highlight_sub_mouse_over_color[2], 1]), highlight_sub_mouse_over_line_width),//0.3],2
                    ...
                    var highlightSymbol_grid_mouse_over = new SimpleFillSymbol(
                            ...
                            new SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new Color([qx_selected_line_color[0], qx_selected_line_color[1], qx_selected_line_color[2], currentOpacity]), sub_has_grid_self_line_width),//0.3],2
                    ...
                    if (beforeMouseOverColor_sub == "" || beforeMouseOverColor_sub == undefined)
                        beforeMouseOverColor_sub = {r: 255, g: 146, b: 20};//255, 146, 20
...
//                    	navSummaryToggle();
                    ...
                    $("#nav_compete").click(function(){
                    	if(!$(this).hasClass("active")){
                    		...
                    		loadLbFloatWin_grid(grid_id_short);
                    	}
                    });
                    ...
                    $("#nav_yingxiao").click(function(){
                    	if(!$(this).hasClass("active")){
                    		nav_function_flag = "rectangle_summary_yingxiao";
	                    	closeRightIframe();
	                    	navClassToggle(this);
	                    	$("#query_div").hide();
	                    	$(".shrink_btn3").hide();
	                    	hideAllServiceLayer();
	                    	clearAllUnusedLayer();
	                    	showYingxiaoFeatureLayer();
	                    	loadLbFloatWin_grid_yingxiao();
                    	}
                    });
...
//		                                offset: ['1px', '38px'],
                    ...
                    function queryVillage(latn_id, page) {
                        ...
                        $.post(url4Query, {
                            ...
                            $("#min_max").removeClass("top");
								    				$("#min_max").css({"bottom":$("#left_bottom_float_window").height()+14,"width":$("#left_bottom_float_window").width()+12});
								    				$("#min_max").show();
                        })
                    }
                    ...
                    function loadLbFloatWin_grid(grid_id_short) {
                    ...
                    function loadLbFloatWin_grid_village() {
                        hideAllLBwincontentTab();
                    ...
                    function loadLbFloatWin_grid_resource() {
                    		$("#left_bottom_float_window").hide();
                    		//$("#left_bottom_float_window_title span").text("");
                    		//$("#left_bottom_float_window_summay").text("");
                        hideAllLBwincontentTab();
                        return;
                        $("#left_bottom_float_window").css({"height": "auto", width: "auto","bottom":document.documentElement.clientHeight*0.12});
                    ...
                    function loadLbFloatWin_grid_yingxiao() {
                    		$("#left_bottom_float_window_summay").hide();
                        hideAllLBwincontentTab();
                        $("#left_bottom_float_window").css({"height": "auto", "width": "auto","bottom":document.documentElement.clientHeight*0.12});
                        $("#left_bottom_float_window").children(".left_bottom_float_window_content").eq(3).show();
                        $("#yingxiao_tabs_head > span").eq(0).addClass("active");
                        $("#left_bottom_float_window").show();
                        $("#min_max").removeClass("top");
                        $("#min_max").css({
                            "bottom": $("#left_bottom_float_window").height() + 14,
                    ...
                    function getYingXiaoTabs() {
                    	$("#left_bottom_float_window_title span").text("营销清单");
                    	queryKHIndex();
                    	queryYXListBigData();
                    }
                    ...
                    var seq_num_bigData = 0;
										function queryYXListBigData(){
											$.post(url4Query_sandBox,{"eaction":"getYXlistToday","union_org_code":substation},function(data){
													data = $.parseJSON(data);
													$("#yx_villagecount_bigdata").text(data.length);
													if(data.length>0)
													...
													for(var i = 0,l = data.length;i<l;i++){
														...
														var temp = "";
														temp += "<tr><td>"+(i+1)+"</td><td style=\"font-weight:bold;\">"+d.CONTACT_CONTPERSON+"</td><td colspan=2 style=\"color:#5697FF;font-weight:bold;width:74%;\">"+d.ACC_NBR+"</td><td rowspan=4 style=\"width:40px;\"><a href=\"javascript:void(0);\" onclick=\"execute_show('" + d.PROD_INST_ID + "')\" style=\"font-size:12px;\">执行</td></tr>";
														temp += "<tr><td></td><td style=\"font-weight:bold;color:#FF6600;\">推荐</td><td style=\"font-weight:bold;\">【"+d.SCENE_NAME+"】</td><td>"+d.MKT_CONTENT+"</td></tr>";
														temp += "<tr><td></td><td style=\"font-weight:bold;\">原由：</td><td colspan=2 style=\"text-align:left;\">"+d.MKT_REASON+"</td></tr>";
														temp += "<tr><td></td><td style=\"font-weight:bold;\">地址：</td><td colspan=2 style=\"text-align:left;\">"+d.CONTACT_ADDS+"</td></tr>";
                    ...
                    clickToGridAndVillage = function (substation, sub_name, thiz, zoom, grid_name, station_id, village_id, tab_id) {
                        ...
                        queryTask_village.execute(query_village, function (results) {
                            ...
                            village_selected_gra_update = results.features[0];
			                      ...
			                      var pointAttributes = {"village_id": results.features[0].attributes.village_id};
...
//                                map.centerAndZoom(point,zoom);
                ...
                standard_load();
                    ...
                    function openVillageNewPopWin(substation){
                    	
                    	layer.open({
                    		title: ['网格选择', 'line-height:32px;text-size:30px;height:32px;'],
                        //title:false,
                        type: 1,
                        shade: 0,
                        area: ['500px', '100px'],
...
//							skin: 'demo-class',
                    ...
                    function summaryCollectPolygen(geo, where) {
	                        ...
	                        var query_standard = new Query();
	                        //if (where != undefined)
	                            query_standard.where = "collect_flg is not null and grid_id = '"+grid_id_short+"'";
	                        //else
                    ...
                    queryTask1.execute(query1, function (results) {
                        ...
                        for (var i = 0, k = 0; i < l; i++, k++) {
                            ...
                            //fillsymbol1.setOutline(new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color(grid_selected_line_color), grid_line_width));//STYLE_DASH，click_line_color_grid
                            ...
                            fillsymbol1.setOutline(new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color([qx_selected_line_color[k][0],qx_selected_line_color[k][1],qx_selected_line_color[k][2],1]), sub_has_grid_self_line_width));//STYLE_DASH，click_line_color_grid
                    ...
                    clickToSub = function (substation, sub_name, thiz, zoom) {
                    		///loadLbFloatWin_grid(substation);
                        subToGridFlag = false;
                        map.infoWindow.hide();
                        $("#sub_info_win").hide();
                        $("#grid_info_win").hide();
...
//									var linesymbol = new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color(qx_all_line_color), 1.5);
                    ...
                    var subFillRecover_mouseover = function () {
                        if (sub_gra_last != undefined && sub_gra_last != "") {
                            ...
                            var symbol = new esri.symbol.SimpleFillSymbol(esri.symbol.SimpleFillSymbol.STYLE_SOLID, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID,
                                    new esri.Color(sub_selected_line_color), sub_selected_line_width), new esri.Color([color.r, color.g, color.b, currentOpacity]));
                    ...
                    var gridFillRecover_mouseover = function () {
                        if (grid_gra_last != undefined && grid_gra_last != "") {
                            ...
                            //fillsymbol1.setOutline(new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color([grid_selected_line_color[0], grid_selected_line_color[1], grid_selected_line_color[2], grid_selected_line_color[3]]), grid_line_width));//color.a,STYLE_DASH，click_line_color_grid,grid_line_color
                            fillsymbol1.setOutline(new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color([qx_selected_line_color[0], qx_selected_line_color[1], qx_selected_line_color[2], qx_selected_line_color[3]]), sub_has_grid_self_line_width));//color.a,STYLE_DASH，click_line_color_grid,grid_line_color
                    ...
                    function queryStandardByResids() {
                        ...
                        query_standard.outFields = ["RESID", "RESNAME", "RESFULLNAME", "UNION_ORG_CODE", "GRID_UNION_ORG_CODE", "GRID_NAME", "BUREAU_NAME", "BUREAU_NO", "COLLECT_FLG"];
                        query_standard.returnGeometry = true;
                        var city_geometry = "";//所展示市级范围的图形对象
                        queryTask_standard.execute(query_standard, function (results) {
                            if (results.features.length == 0)
                    ...
                    function standard_load() {
                        ...
                        var queryTask_standard = new QueryTask(standard_address);
                        var query_standard = new Query();
                        query_standard.where = "grid_id = '" + grid_id_short + "'";
                        query_standard.geometry = map.extent;
...
//                        map.infoWindow.resize(260,200);
                    ...
                    showBuildDetail = function (res_id, str, visible, page, c, query_id) {
                        ...
                        if (page == 0) {
                            ...
                            $("#detail_more > iframe").attr("src", "<e:url value='pages/telecom_Index/sub_grid/viewPlane_build_view_details.jsp' />?res_id=" + res_id + "&vis=" + visible + "&village_id=" + query_id);
                        } else if (page == 1) {
                            $("#detail_more > iframe").attr("src", "<e:url value='pages/telecom_Index/sub_grid/viewPlane_build_view_details.jsp' />?res_id=" + res_id + "&vis=" + visible + "&yx_id=" + query_id);
                            ...
                            $("#detail_more > iframe").attr("src", "<e:url value='pages/telecom_Index/sub_grid/viewPlane_build_view_details.jsp' />?res_id=" + res_id + "&vis=" + visible + "&tab_flag=4" + "&village_id=" + query_id);
                        }
...
//						}
                    ...
                    /*var village_layer_mouse_over_handler = dojo.connect(village_layer, "onMouseOver", function (evt) {
                     ...
                     var village_layer_click_handler = dojo.connect(village_service_feature_layer, "onClick", function (evt) {
                     		village_click_event(evt);
                     });
                     var village_layer_click_handler = dojo.connect(village_service_feature_layer1, "onClick", function (evt) {
                     		village_click_event(evt);
                     });
                     var village_layer_click_handler = dojo.connect(village_service_feature_layer2, "onClick", function (evt) {
                     		village_click_event(evt);
                     });
