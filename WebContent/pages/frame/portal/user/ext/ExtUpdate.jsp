...
<form action="" method="post" id="attrUpdForm" >
	...
	<col width="*">
		...
		<tr>
			<th>属性编码：</th>
			<td><input type="text" id="attr_code_temp" name="attr_code_temp" value="${cur_attr.attr_code}" disabled="disabled" style="width:190px;">
			<input type="hidden" id="attr_code" name="attr_code" value="${cur_attr.attr_code}"></td>
		</tr>
		<tr>
			<th>属性名称：</th>
			<td><input type="text" id="attr_name" name="attr_name" value="${cur_attr.attr_name}" class="easyui-validatebox" required style="width:190px;"></td>
		</tr>
		<tr>
			<th>属性描述：</th>
			<td>
				<input type="text" id="attr_desc" name="attr_desc" value="${cur_attr.attr_desc}" class="easyui-validatebox" style="width:190px;"></td>
			</td>
		</tr>
		<tr>
			<th>属性值类型：</th>
		...
		<tr>
			...
			<td>
				...
				<input type="text" disabled="disabled" id="model_desc_temp" name="model_desc_temp" value="${cur_attr.model_desc  }" style="width:190px;">
				<e:description><e:select items="${models.list}" id="ext_model" name="ext_model" label="model_desc" value="model_code" defaultValue="${cur_attr.show_mode}" style="width:190px;"/></e:description>
			</td>
		</tr>
		...
		<tr id="CASCADE_CHECKBOX_RADIO_SELECTS_TREE_CASSELECT">
			<th>候选项编码表名：</th>
			<td>
				<input type="text" id="code_table" name="code_table" value="${cur_attr.code_table }" class="easyui-validatebox" style="width:190px;">
			</td>
		</tr>
		<tr id="CASCADE_CHECKBOX_RADIO_SELECTS_TREE_CASSELECT">
			<th>候选项值列名：</th>
			<td>
				<input type="text" id="code_key" name="code_key" value="${cur_attr.code_key }" class="easyui-validatebox" required validType="test['候选项值列名']" style="width:190px;">
			</td>
		</tr>
		<tr id="CASCADE_TREE_CITY_AREA">
			<th>候选项上级编码列名：</th>
			<td>
				<input type="text" id="code_parent_key" name="code_parent_key" value="${cur_attr.code_parent_key }" class="easyui-validatebox" required validType="test['候选项上级编码列名']" style="width:190px;">
			</td>
		</tr>
		<tr id="CASCADE_CHECKBOX_RADIO_SELECTS_TREE_CASSELECT">
			<th>候选项描述列名：</th>
			<td>
				<input type="text" id="code_desc" name="code_desc" value="${cur_attr.code_desc }" class="easyui-validatebox" required validType="test['候选项描述列名']" style="width:190px;">
			</td>
		</tr>
		<tr id="CASCADE_CHECKBOX_RADIO_SELECTS_TREE_CASSELECT">
			<th>候选项排序列名：</th>
			<td>
				<input type="text" id="code_ord" name="code_ord" value="${cur_attr.code_ord }" class="easyui-validatebox" required validType="test['候选项排序列名']" style="width:190px;">
			</td>
		</tr>
		<tr id="CASCADE_SELECTS">
			<th>是否多选：</th>
			<td>
				<select id="muni" name="muni" style="width:190px;">
		...
		<tr class="ISNULL">
			<th>默认-值：</th>
			<td>
				<input type="text" id="default_value" name="default_value" value="${cur_attr.default_value }" style="width:190px;">
			</td>
		</tr>
		<tr class="ISNULL">
			<th>默认-描述：</th>
			<td>
				<input type="text" id="default_desc" name="default_desc" value="${cur_attr.default_desc }" style="width:190px;">
			</td>
		</tr>
		<tr>
			<th>扩展属性排序：</th>
