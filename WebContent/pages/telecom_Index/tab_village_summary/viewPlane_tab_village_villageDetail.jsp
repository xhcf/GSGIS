  ...
  <link href='<e:url value="/resources/css/main.css"/>' rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		...
		function changeBureauSelect(){
			$.post("<e:url value='/pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp' />",{"eaction":"getBureauByCityId","city_id":city_id_temp},function(data){
		...
		function changeBranchSelect(){
			$.post("<e:url value='/pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp' />",{"eaction":"getBranchByBureauId","bureau_id":bureau_id_temp},function(data){
		...
		function changeGridSelect(){
			$.post("<e:url value='/pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp' />",{"eaction":"getGridByBranchId","branch_id":branch_id_temp},function(data){
				...
				<div class="sub_">
					...
					<div class="sub_b" style="border:0px;width:97.5%;margin:15px auto;">
						<!--<div class="t_body" id="scroll_target"> download 城市支局小区信息统计_市级概况-->
							<c:datagrid
									url="pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp?eaction=village&city_id=${param.city_id}&bureau_id=${param.bureau_id}&branch_id=${getBranchTypeBySubId.UNION_ORG_CODE}&grid_id=${param.grid_id}"
