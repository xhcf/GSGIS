        ...
        if(index==1){
            ...
            $("#sub2").datagrid({
                ...
                columns:[[
                    ...
                    {field:'VILLAGE_NAME',title:'小区名称',align:'center',halign:'center',width:sub_width*0.34,
                        formatter:function(value,rowData){
...
<script type="text/javascript" >
    ...
    var tab_flag = parent.global_pos_vc_flag;
    ...
    var url4Query_index = '<e:url value="pages/telecom_Index/common/sql/tabData_index_grid_vc.jsp" />';
                ...
                [
                    ...
                    {field:'GRID_NAME',title:'网格名称',align:'left',halign:'center',width:sub_width*0.34,
                    	formatter:function(value,rowData){
                          ...
                          if(value.length>length_standard){
			  	if('${sessionScope.UserInfo.LEVEL}'==5){
					return "<span title='"+value+"'>"+value.substr(0,length_standard)+"..</span>";
				}else{
	...
	$("#resource").on("click",function(){
		...
		$.post(url4Query_sandSummary,{"eaction":"get_info_all","grid_union_org_code":grid_id},function(data){
		...
		$("#village_detail_list").datagrid({
			...
			columns:[
				[
					...
					{field:'VILLAGE_NAME',title:'行政村',align:'center',halign:'center',width:sub_width*0.32,
						formatter:function(value,rowData){
	...
	function summary_info(){
		...
		//行政村数
		$.post(url4Query_sandSummary,{"eaction":"getVillageCellCnt","grid_union_org_code":grid_id},function(data){
    ...
    function market_tab(){
        ...
        $.post(url4Query, {eaction:'three_index_market', flag: flag, report_to_id:report_to_id },
            function(data) {
        ...
        //2019-04-25指标来源调整
        $.post(url4Query_sandSummary,{"eaction":"get_info_all","grid_union_org_code":grid_id},function(data1){
            var income_divs0 = $(".target_title").eq(0).next().children();
            var danwei = "户";
            if(flag==1 || flag==2 || flag==3) {
                danwei = "万户";
...
//					barGap:'20%',
    ...
    function freshFigue1(){
        ...
        //});
        $.post(url4Query_index,{"eaction":'getMarketChart',"grid_id": grid_id,"day":'${lastMonth_market.VAL}',"month":'${lastMonth_market.SUB_VAL}'},function(data){
            data = $.parseJSON(data);
            /*for(var j=0;j<=5;j++){
    ...
    function deve_tab(){
        ...
        //三包发展情况、市场竞争 ---begion
        $.post(url4Query,{eaction:'three_index',flag:flag,latn_id:city_id,city_name:city_name,report_to_id:report_to_id,substation:substation,yesterday:'${yesterday.VAL}',last_month:'${lastMonth.VAL}',click_name:city_full_name,},function(data){
            data = $.parseJSON(data);
            if(data==null){
                return;
            }
