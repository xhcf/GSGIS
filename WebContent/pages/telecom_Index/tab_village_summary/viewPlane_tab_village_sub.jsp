...
<e:set var="datagrid_url">
	<e:url value="/pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp?eaction=grid&city_id=${param.city_id}&bureau_id=${param.bureau_id}&branch_id=${param.branch_id}&grid_id=${param.grid_id}" />
</e:set>
<html>
<head>
	...
	<script type="text/javascript">
		var url4Query = '<e:url value="/pages/telecom_Index/common/sql/viewPlane_tab_village_summary_action.jsp"/>';
