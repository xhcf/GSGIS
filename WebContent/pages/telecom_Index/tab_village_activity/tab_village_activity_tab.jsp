...
<e:q4l var="centerList">
  ...
  group by T.bureau_no, T.branch_no, T.branch_name,t.branch_no
...
<head>
  ...
  <style>
    ...
    /*表格样式*/
    .tab_head1 {width:100%;}
    .tab_head1 tr th:first-child {width:12%!important;}
    .tab_head1 tr th:nth-child(2){width:16%!important;}
    .tab_head1 tr th:nth-child(3){width:24%!important;}
    .tab_head1 tr th:nth-child(4){width:24%!important;}
    .tab_head1 tr th:nth-child(5){width:24%!important;}

    .tab_comm {width:100%;}
    .tab_comm tr td:first-child {width:12%!important;color:#fff!important;}
    .tab_comm tr td:nth-child(2){width:16%!important;color:#fff!important;}
    .tab_comm tr td:nth-child(3){width:24%!important;color:#fff!important;}
    .tab_comm tr td:nth-child(4){width:24%!important;color:#fff!important;}
    .tab_comm tr td:nth-child(5){width:24%!important;color:#fff!important;}
...
<div class="sub_box grab_tab">
  <div style="height:94%;width:100%;margin:0.3% auto;" id="tab_div">
    <div class="big_table_title"><h4>小&nbsp;区&nbsp;活&nbsp;动&nbsp;统&nbsp;计&nbsp;报&nbsp;表</h4></div>
...
<script type="text/javascript">
  ...
  var url4data_list = '<e:url value="/pages/telecom_Index/common/sql/tabData_village_activity.jsp" />';
  var eaction = "getListSummary", seq_num = 0, page = 0, flag = 1;
  ...
  function listCollectScroll(flag) {
    ...
    $.post(url4data_list, params, function (data) {
      ...
      for (var i = 0, l = data.length; i < l; i++) {
        ...
        newRow += name_str +
        "<td>" + d.CAMPAIGN_ALL_NUM + "</td>" +
        "<td>" + d.CAMPAIGN_DAY_NUM + "</td>" +
        "<td>" + d.CAMPAIGN_MON_NUM + "</td>" +
        "</tr>";
        $list.append(newRow);
      }
  ...
  function clear_data() {
    seq_num = 0, begin_scroll = 0,page = 0,flag = '1';
    $("#all_count").text("");
