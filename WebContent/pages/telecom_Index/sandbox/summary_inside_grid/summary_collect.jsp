...
<e:q4l var="grid_list">
  SELECT '-1' CODE, '全部' TEXT FROM DUAL
</e:q4l>
...
<head>
  ...
  <style>
    ...
    #info_m_tab {height:48%;}
    .win_full_screen #info_m_tab {height:70%;}
    #stock_village_table_content, #stock_build_table_content {height:70%;}
    .red_font {color:red;}
    .village_m_tab{margin:0px;}
        ...
        <div class="head_table_wrapper">
            <table class="head_table tab_header">
                <!--<tr>
                    ...
                    <th colspan="3" width="210">宽带</th>
                    <th colspan="3" width="210">ITV</th>
...
var url_summary_grid = "<e:url value='/pages/telecom_Index/common/sql/tabData_sandbox_summary_grid.jsp' />";
...
function initCondition(){
    $.post(url_summary_grid,{"eaction":"get_info_all","grid_id_short":grid_id_short},function(data){
    ...
    $.post(url_summary_grid,{"eaction":"get_four_vill_type","grid_id_short":grid_id_short},function(data){
        var data = $.parseJSON(data);
