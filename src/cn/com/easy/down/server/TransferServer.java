...
//            		  System.out.println("完整参数为--->"+fullParamStr);
		...
		private static Map addExtParams(Map paramMap){
			System.out.println("1:"+TransferServer.class.getClassLoader().getResource("/").getPath());
			System.out.println("1:"+TransferServer.class.getClassLoader().getResource("/").getPath().replace("WEB-INF/classes/", "") + "pages/download/");
