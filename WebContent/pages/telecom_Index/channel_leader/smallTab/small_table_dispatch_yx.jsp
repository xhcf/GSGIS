        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'分公司',align:'center',halign:'center',width: sub_width*0.2,
                        formatter:function(value,rowData){
                            return "<span title='" + value + "'>" + value + "</span>";
                        }
                    },
                    {
                        field:'USE_RATE1',title:'执行率',align:'center',halign:'center',width: sub_width*0.22,sortable:true,
                        formatter:function(value,rowData){
                        ...
                        field:'ORDER_CNT',title:'派单数',align:'center',halign:'center',width: sub_width*0.25,sortable:true,
                        formatter:function(value,rowData){
                            if(value!=null&&value!=undefined&&value!=-1)
                                return value;
                            else
                    ...
                    {
                        field:'EXEC_CNT',title:'执行数',align:'center',halign:'center',width: sub_width*0.2,
                        formatter:function(value,rowData){
                            if(value!=null&&value!=undefined&&value!=-1)
                                return value;
                            else
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'区县',align:'left',halign:'center',width: sub_width*0.16,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'>" + value + "</div>";
                        }
                    },
                    {
                        field:'USE_RATE1',title:'执行率',align:'center',halign:'center',width: sub_width*0.2,sortable:true,
                        formatter:function(value,rowData){
                            if(value!=null&&value!=undefined&&value!=-1){
                                return num_formatter(value);
                            }else
                    ...
                    field:'ORDER_CNT',title:'派单数',align:'center',halign:'center',width: sub_width*0.2,sortable:true,
                    formatter:function(value,rowData){
                        if(value!=null&&value!=undefined&&value!=-1)
                            return value;
                        else
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'支局',align:'left',halign:'center',width: sub_width*0.16,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'><a href='javascript:void(0);' onclick='javascript:parent.inside("+rowData.UNION_ORG_CODE+")'>" + value + "</a></div>";
                        }
                    },
                    {
                        field:'USE_RATE1',title:'执行率',align:'center',halign:'center',width: sub_width*0.2,sortable:true,
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'网格',align:'left',halign:'center',width: sub_width*0.16,
                        formatter:function(value,rowData){
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'小区',align:'left',halign:'center',width: sub_width*0.15,
                        formatter:function(value,rowData){
                            return "<div class='long_message' title='" + value + "'><a href='javascript:void(0);' onclick='javascript:parent.inside("+rowData.LATN_ID+")'>" + value + "</a></div>";
                        }
                    },
                    ...
                    {
                        field:'ORDER_CNT',title:'派单数',align:'center',halign:'center',width: sub_width*0.2,
                        formatter:function(value,rowData){
                            if(value!=null&&value!=undefined&&value!=-1)
                                return value;
                            else
                    ...
                    {
                        field:'EXEC_CNT',title:'执行数',align:'center',halign:'center',width: sub_width*0.19,
                        formatter:function(value,rowData){
                            if(value!=null&&value!=undefined&&value!=-1)
                                return value;
                            else
