...
<html>
	...
	<body>
		<table id="tbar" style="width:100%;">
			<tbody>
				<tr>
					...
					<td>
						活动状态:<e:select id="post_state" name="post_state" items="${TypeList.list}" label="TYPE_DESC" value="TYPE_CODE" headLabel="全部" headValue=""/>
					</td>
					<td>
		...
		<c:datagrid url="/pages/frame/notice/NoticeAction.jsp?eaction=list" id="noticeTable" style="width:auto;height:auto;"
					title="活动历史" download="true" singleSelect="true" nowrap="false" toolbar="#tbar">
			<thead>
				<tr>
