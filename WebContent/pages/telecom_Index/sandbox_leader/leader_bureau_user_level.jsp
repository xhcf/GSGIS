...
<e:q4l var="subList">
    ...
    a.branch_hlzoom
    from (
    select distinct union_org_code, color, t.bureau_name, t.branch_no,t.branch_name,t.branch_type,t.branch_hlzoom
    ...
    and g.stat_date = '${yesterday.VAL}'
    and g.flag = 4
    and m.statis_mon = '${lastMonth.VAL}'
    and m.flag = '4'
</e:q4l>
<e:q4l var="gridList">
		select d.grid_id,
...
<head>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/order_exec.js?version=New Date()"/>' charset="utf-8"></script>
	    ...
	    .region_switch_group {right:95px;}
		</style>
</head>
...
<div class="village_info_win new_beta leader" id="village_info_win" style="display: none;width:70%;height:95%;"><!-- width:880px -->
    ...
    <iframe id="village_info_win_body" style="width:100%;height:96%;border:0"></iframe>
...
<div id="buildInVillage_review_win" class="village_info_win" style="display:none;position:absolute;z-index:999;">
    ...
    <div class="target_a" style="border-bottom:none;">
        ...
        <div class="bulid_village_btn" style="display:none;">
    ...
    <div style="position:relative;">
		  <div class="leader_tools" id="tools_scroll">
		    <ul class="nav_index_group">
		      ...
		      <li id="nav_index_village_detail"><span></span><a href="javascript:void(0)" id="">城市小区清单</a></li>
		    </ul>
		  </div>
...
<div id="village_draw_tool_div" style="width: 120px;height: 50px" onclick="javascript:tuichu(event)">
	...
	<div id="sub_summary_div">
	    ...
	    <div>
	        <ul class="sub_summary_total_nums">
	            ...
	            <li><span>小区数:</span><span id="sub_summary_village_num"></span></li>
	            <li><span>楼宇数:</span><span id="sub_summary_add4_num"></span></li>
	            <li><span>住户数:</span><span id="sub_summary_add6_num"> </span></li>
	        </ul>
	    </div>
	    <div class="sub_summary_tabs">
	        <div>
	            <div id="sub_summary_to_market" class="sub_summary_tabs_title">市场</div>
	            <div class="sub_summary_index_content">
	                <header class="summary_index_important">宽带渗透率：<span id="summary_market_lv"></span></header>
	                <ul>
	                    <li>家庭住户：<span class="summary_index_clickable" onclick="javascript:summaryToTab('market',4)" id="summary_zhu_hu"></span></li>
	                    <li>家庭光宽：<span id="summary_zhu_hu_h"></span></li>
                		<li>融合：<span id="summary_together_broadband_user"></span></li>
                		<li>融合率：<span id="summary_together_broadband_lv"></span></li>
	                </ul>
	                <ul>
	                    <li>政企住户：<span id="summary_zhu_hu_zq"></span></li>
	                    <li>政企光宽：<span id="summary_zhu_hu_zq_h"></span></li>
                    	    <li>融合：<span id="summary_together_broadband_user_zq"></span></li>
                	    <li>融合率：<span id="summary_together_broadband_lv_zq"></span></li>
	                </ul>
	                <!--<ul>
	                		<li>移动用户：<span id="summary_mobile_user"></span></li>
	                		<li>单产品用户：<span id="summary_single_product_user"></span></li>
	                		<li>融合用户：<span id="summary_together_product_user"></span></li>
	                </ul>
	                <ul>
	        ...
	        <span></span>
	        <div>
	            <div id="sub_summary_to_resource1" class="sub_summary_tabs_title">资源</div>
	            <div class="sub_summary_index_content">
	                <header class="summary_index_important">光网覆盖率：<span id="summary_obd_percent"></span></header>
	                <ul>
	                    <li>OBD数：<span id="summary_obd_num" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',3,'')"></span></li>
                    	    <li>0-1OBD：<span id="summary_obd_zero" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',3,'1')"></span></li>
                    	    <li>高占用OBD：<span id="summary_obd_full" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',3,'3')"></span></li>
	                </ul>
			<header class="summary_index_important">端口占用率：<span id="summary_port_lv"></span></header>
	                <ul>
	                    <li>端口数：<span id="summary_port_num"></span></li>
                    	    <li>占用端口：<span id="summary_port_used"></span></li>
                    	    <li>空闲端口：<span id="summary_port_free"></span></li>	                
			 </ul>
	            </div>
	        </div>
	        <span></span>
	        <div>
	            <div id="sub_summary_to_resource2" class="sub_summary_tabs_title">小区</div>
	            <div class="sub_summary_index_content">
	                <header class="summary_index_important" style="margin-left:10px;">小区数：<span id="sub_summary_village_num1" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'')"></span></header>
	                <ul>
	                    <li style="padding-left:10px;">白区小区：<span id="summary_village_low_line" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'baiqu')"></span></li>
	                    <li style="padding-left:10px;">拔旗小区：<span id="summary_village_no_line" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'baqi')"></span></li>
	                </ul>
	                <ul>
	                    <li style="padding-left:10px;">急迫小区：<span id="summary_vill_v_type_1" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'jipo')"></span></li>
	                    <li style="padding-left:10px;">紧迫小区：<span id="summary_vill_v_type_2" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'jinpo')"></span></li>
	                    <li style="padding-left:10px;">操心小区：<span id="summary_vill_v_type_3" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'caoxin')"></span></li>
	                    <li style="padding-left:10px;">平稳小区：<span id="summary_vill_v_type_4" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0,'pingwen')"></span></li>
	                </ul>
	            </div>
	        </div><span></span>
	        <div>
	            <div id="sub_summary_to_yx" class="sub_summary_tabs_title">营销</div>
	            <div class="sub_summary_index_content">
	                ...
	                <!--<header class="summary_index_important">异网预警：<span  class="summary_index_clickable" onclick="javascript:summaryToTab('yx',1)" id="summary_yw_num"></span></header>
	                <ul>
	                    <li>日执行率：<span id="summary_yw_exec_lv_day"></span></li>
	                    <li>月执行率：<span id="summary_yw_exec_lv_month"></span></li>
	                </ul>-->
	            </div>
	        </div><span></span>
	        <div>
	            <div id="sub_summary_to_collect" class="sub_summary_tabs_title">收集</div>
	            <div class="sub_summary_index_content">
			<header class="summary_index_important">竞争收集：<span id="summary_collect_lv"></span></header>
	                <ul>
	                    <li>应收集：<span class="summary_index_clickable" onclick="javascript:summaryToTab('collect',1)" id="summary_uninstall"></span></li>
	                    <li>已收集：<span class="summary_index_clickable" onclick="javascript:summaryToTab('collect',1)" id="summary_collect_count"></span></li>
	                </ul>
	                <ul>
               	 	...
               	 	<ul>
                		<li>未装：<span id="summary_buss_unintall_cnt" onclick=""></span></li>
                	</ul>
	            </div>
	        </div><span></span>
	        <div>
	            <div id="sub_summary_to_stock" class="sub_summary_tabs_title">资料</div>
	            	<div class="sub_summary_index_content">
									<header class="summary_index_important">四级地址：<span id="summary_add4_cnt" onclick=""></span></header>
		            	<!--<ul>
		            			<li>GIS上图：<span id="summary_add4_gis_cnt" class="summary_index_clickable" onclick=""></span></li>
		            			<li>上图率：<span id="summary_add4_gis_lv"></span></li>
		            	</ul>-->
		            	<ul>
		            			<li>资源已达：<span id="summary_build_num_reached" onclick=""></span></li>
		            			<li>资源未达：<span id="summary_build_num_unreach" onclick=""></span></li>
		            	</ul>
		            	<ul>
		            			<li>已归小区：<span id="summary_build_num_in_map" class="summary_index_clickable" onclick=""></span></li>
		            			<li>未归小区：<span id="summary_build_num_no_in_map" class="summary_index_clickable" onclick=""></span></li>
		            	</ul>
		            	<!--
		            	<header class="summary_index_important">小区数：<span id="summary_village_num" class="summary_index_clickable" onclick="javascript:summaryToTab('collect',0)"></span></header>
		                <ul>
	...
	<div id="used_build_div">
		...
		<div class="" id="used_build_list_scroll">
			<table class="content_table build_detail_in" id="used_build_list" style="width:100%;">
			</table>
		</div>

		<div class="head_table_wrapper" style="padding-left:10px;height:5%;">当前统计总数：<span id="used_build_now"></span></div>
	</div>
...
<script type="text/javascript">
    ...
    //县级用户编码
    var bureau_no = parent.user_bureau_no;
    ...
    var sub_name_speical = {
		...
		var substation_array = new Array();
    var substation_str = "SUBSTATION_NO IN (";
    var sub_dev = new Array();
    var sub_data = new Array();
    
    var substation_temp = ${e:java2json(subList.list)};
    for(var i = 0,l = substation_temp.length;i<l;i++){
        var d = substation_temp[i];
        ...
        sub_data[d.UNION_ORG_CODE] = d.BRANCH_NAME;
        substation_array.push(d.UNION_ORG_CODE);
        substation_str += "'"+ d.UNION_ORG_CODE +"'";
        if(i<l-1)
        	substation_str += ",";
    }
    substation_str += ")"; 
    //console.log(substation_str);
    
    var reporttoid_array = new Array();
    var reporttoid_str = "REPORT_TO_ID IN (";
    var grid_dev = new Array();
    var grid_data = new Array();
    
    var reporttoid_temp = ${e:java2json(gridList.list)};
    for(var i = 0,l = reporttoid_temp.length;i<l;i++){
        var d = reporttoid_temp[i];
        grid_dev[d.STATION_ID] = {
            branch_name: d.BRANCH_NAME,
            grid_name: d.GRID_NAME
        };
        grid_data[d.STATION_ID] = d.GRID_NAME;
        reporttoid_array.push(d.STATION_ID);
        reporttoid_str += "'"+ d.STATION_ID +"'";
        if(i<l-1)
        	reporttoid_str += ",";
    }
    reporttoid_str += ")"; 
    console.log(reporttoid_str);
  	...
  	$("#sub_summary_to_stock").on("click",function(){
		...
		showSummaryWindow = function(){
		  ...
		  if(org_type=="sub"){
		  	...
		  	grid_union_org_code = grid_id_for_summary_pop;
		  	params.grid_id_short = grid_id_short_summary_pop;
		  	grid_id_short = grid_id_short_summary_pop;
		  }
    ...
    function backToPrevLevel(region_index){
    	...
    	if(region_index == 0){
	    	...
	    	parent.freshMapContainer('<e:url value="/pages/telecom_Index/sandbox_leader/leader_province_level.jsp"/>');
	    	parent.loadSmallTab(1,index_type,'',region_type_num);
    	}else if(region_index == 1){
    		parent.global_current_flag = 2;
	    	parent.global_current_city_id = city_id;
	    	parent.global_current_area_name = city_name;
	    	parent.freshMapContainer('<e:url value="/pages/telecom_Index/sandbox_leader/leader_city_level.jsp"/>');
    ...
    $(function () {
    		...
    		//$(".region_switch_group").hide();//20181206
				$.post(url4Query_leader,{"eaction":"grid_list","latn_id":city_id,"bureau_no":bureau_no},function(data){
					data = $.parseJSON(data);
				...
				var region_type_num = 3;//20181206 默认右侧加载小区
				parent.global_region_type = "sub";//20181206 默认右侧加载支局
				//var region_type_num = 0;
	        /*if(region_type=="city"){
	        	region_type_num = 1;
	        }else if(region_type=="bureau"){
		      ...
		      $(this).on("click",function(){
		        ...
		        if(index_name=="nav_index_village_detail"){//城市小区清单
		          ...
		          if(region_type=="sub")
		      			...
		      			region_type_num = 5;
		          parent.loadSmallTab(region_type_num,index_type,bureau_no);
		        }
		      });
		    });
    ...
    function toGis() {//城关区，兰州市
        ...
        require(["esri/config",
                ...
                function (Config,
                    ...
                    var village_where = "bureau_no = " + bureau_no;
...
//							skin: 'demo-class',
                    ...
                    featureLayer = new FeatureLayer(new_url_sub_vaild + sub_layer_index, {
                        definitionExpression: substation_str,
			...
			featureLayer.on("graphic-add", function (evt) {
                    ...
                    function clearDrawLayer() {
				     ...
				     featureLayer_grid = new FeatureLayer(new_url_sub_vaild + grid_layer_index,{
		                     definitionExpression : reporttoid_str,
		                     mode: FeatureLayer.MODE_SNAPSHOT,
		                     //mode: FeatureLayer.MODE_ONDEMAND,
		                     outFields: ["*"],
		                     visible:true,
		    ...
		    //网格图层加载 end
                    ...
                    function buildInsideVillageColorful(){
                    		var queryTask_standard = new QueryTask(standard_address);
                        var query_standard = new Query();
                        query_standard.where = "bureau_no = '"+bureau_no+"'";
                        ...
                        queryTask_standard.execute(query_standard, function (results) {
                            ...
                            $.post(url4Query_leader,{"eaction":"getBuildUsedInArea","build_ids":ids_str,"latn_id":city_id,"bureau_no":bureau_no},function(data){
                            	data = $.parseJSON(data);
...
//						}
    ...
    parent.resize_building_view_win = function(flag){
    	if(flag=="open"){
    		$("#detail_more").removeClass("buildingFullWin");
    		$("#detail_more").addClass("buildingHalfWin");
    	}else{
    		$("#detail_more").removeClass("buildingHalfWin");
    		$("#detail_more").addClass("buildingFullWin");
    	}
    	var cent_pos = getCenter("#detail_more");
      $("#detail_more").css({"left":cent_pos[0]*2*(2/3),"top":cent_pos[1]});
    }
