...
<head>
	...
	<script src='<e:url value="/pages/telecom_Index/common/js/js_constant.js?version=3.2"/>' charset="utf-8"></script>
...
<style>
    ...
    .build_detail_in a {color:#3d8ccf;}
	#updown {
...
.village_m_tab15 table.content_table  tr td:nth-child(2) {color:#3d8ccf;padding-left:5px;text-align:left;}
		...
		<div style="margin-top: 5px">
			...
			<div class="list_search" >
				...
				<div style="margin-bottom: 2px">
					...
					<input type="text" id="b_branch_name" placeholder="输入网格名称" style="width: 140px;margin: 5px;margin-left:8px;height:26px!important;font-size:12px;background:#fff;">
		...
		<div style="margin-top: 5px">
			...
			<div class="list_search">
				...
				<div style="margin-left: 5px">
					<div class="list_text">网&nbsp&nbsp格:</div><input type="text" id="g_grid_name" placeholder="输入网格名称" style="width:130px;margin:5px;margin-left:10px;font-size:12px;background:#fff;">
		...
		<div class="build_bar sub_level">
		  <table>
			    <tr>
			      ...
			      <td width="160">
			        <input type="text" id="v_village_name" placeholder="输入小区名称" style="width: 135px;margin-left: 13px;font-size:12px;background:#fff;">
			      </td>
			      <td width="80">
...
<div id="build_div" style="display: none;height: 100%">
	<div style="overflow: hidden">
		...
		<div class="build_bar sub_level">
				...
				<div class="list_text">四级地址:</div><input type="text" id="build_segm_name" placeholder="输入四级地址" style="width:135px;margin-left:13px;margin-top:5px;font-size:12px;background:#fff;">
...
<div id="yingxiao_village_div" style="display: none;height: 100%">
	<div style="overflow: hidden">
		...
		<div id="yingxiao_div_grid_name" class="village_name_new"></div>
		...
		<div class="build_bar sub_level">
				...
				<div class="list_text">小&nbsp&nbsp区:</div><input type="text" id="yx_v_village_name" placeholder="输入小区名称" style="width:135px;margin-left:13px;margin-top:5px;font-size:12px;background:#fff;">
				<button id="yx_village_query" class="btn_uc" style="margin-top: 5px;font-size: 12px">查&nbsp&nbsp询</button>
...
//    var sub_has_grid_self_line_color = [44,169,253,1];//支局的轮廓线线条颜色
    ...
    global_position_build_view.push(grid_name);
              ...
              //draw_layer.visible = false;
       		...
       		$('#nav_zoomprev').unbind();
					...
					function queryVillage(latn_id) {
						...
						$.post(url4Query,{eaction:'village_list_grid_user',latn_id:latn_id,bureau_no:bureau_no,union_org_code:union_org_code,grid_id:grid_id,village_name:$.trim(vn)},function (data) {
							data=$.parseJSON(data)
          ...
          closeWinInfoCollectionEdit = function(add6_id,city_id,area_id,substation,grid_id){
				...
				//	$("#xinjian1").css({"background-color":"#0087d4"});//#0087d4 蓝色   #989A9B  灰色
					...
					function getBuildCount_buildList(build_name){
						$.post(url4Query,{eaction:"getBuildCount_buildList_for_grid_user",latn_id:city_id,build_name:build_name,"grid_id":grid_id},function (data) {
							data = $.parseJSON(data);
					...
					function buildListScroll(region_id,build_name,latn_id,substation,grid_id,page){
						...
						$.post(url4Query,{"eaction":"build_list_for_grid_user","region_id":region_id,build_name:build_name,latn_id:latn_id,"substation":substation,"grid_id":grid_id,"page":page},function(data){
								data = $.parseJSON(data);
