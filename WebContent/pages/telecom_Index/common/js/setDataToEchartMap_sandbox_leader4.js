...
var series_name_array4 = ["执行率","执行数","成功率","成功数","目标用户"];
//地市 区域块
function setDataToEchartMap4(params,url4realTimeSubList,url4mapToWhere){
    //chart.showLoading();
    //wait();
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(d.length==0)
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    datas.push(obj);
                    datas2[org_name] = [d[i].USE_RATE,d[i].EXEC_CNT,d[i].SUCC_LV,d[i].SUCC_CNT,d[i].ORDER_CNT];
                    //[d[i].USE_RATE,d[i].EXEC_CNT,d[i].SUCC_LV,d[i].SUCC_CNT,d[i].ORDER_CNT];
                }
        ...
        complete:function(){
            echartMapReset4(min,max,params,color,datas,datas2);
            chart_map.hideLoading();
        }
    });
}
//地市 区域块
function echartMapReset4(min_num,max_num,params,color,data,data2){
    ...
    var option = {
            ...
            formatter: function(params) {
                ...
                for (var i = 0; i < option.series[0].data.length; i++) {
                    if(params.name==option.series[0].data[i].name){
                        res+="<tr><td>"+series_name_array4[0] +":</td><td>"+data2[params.name][0]+"</td></tr>";
                        res+="<tr><td>"+series_name_array4[1] +":</td><td>"+data2[params.name][1]+"</td></tr>";
                        res+="<tr><td>"+series_name_array4[2] +":</td><td>"+data2[params.name][2]+"</td></tr>";
                        res+="<tr><td>"+series_name_array4[3] +":</td><td>"+data2[params.name][3]+"</td></tr>";
                        res+="<tr><td>"+series_name_array4[4] +":</td><td>"+data2[params.name][4]+"</td></tr>";
                    }
                }
                res += "</table></div>";
                return res;
        ...
        series: [
            //series 0
            {
                layoutCenter: ['50%', '50%'],
                layoutSize: '120%',
                name: series_name_array4[0],
                type: 'map',
                //stack:series_name_array4[0],
                mapType: city_name,
                selectedMode: false,
...
//区县 柱状图
function setDataToEchartMap_bar_bureau4(params,url4realTimeSubList,url4mapToWhere){
    //chart.showLoading();
    //wait();
    var fullCityName = params.city_full_name;
    if(params.flag == 3){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(d.length==0)
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    vals.push(obj.value);
                    datas.push(obj);
                    data_map[org_name] = [d[i].USE_RATE,d[i].EXEC_CNT,d[i].SUCC_LV,d[i].SUCC_CNT,d[i].ORDER_CNT];
                }
        ...
        complete:function(){
            echartMapReset_bar_bureau4(min,max,params,color,datas,data_map);
            chart_map.hideLoading();
        }
    });
}
//区县 柱状图
function echartMapReset_bar_bureau4(min_num,max_num,params,color,data,data_map){
    var city_name = params.parent_name;
    if(city_name.indexOf("省")>-1)
        city_name = city_name.replace(/省/gi,'');
    try{
    ...
    chart_map.setOption(
        {
            tooltip: {
                ...
                formatter:function(params){
                    var res = "<div class='tips_table_wrapper'><table><tr><td colspan='2'>"+params.name+"</td></tr>";
                    res+="<tr><td>"+series_name_array4[0] +":</td><td>"+data_map[params.name][0]+"</td></tr>";
                    res+="<tr><td>"+series_name_array4[1] +":</td><td>"+data_map[params.name][1]+"</td></tr>";
                    res+="<tr><td>"+series_name_array4[2] +":</td><td>"+data_map[params.name][2]+"</td></tr>";
                    res+="<tr><td>"+series_name_array4[3] +":</td><td>"+data_map[params.name][3]+"</td></tr>";
                    res+="<tr><td>"+series_name_array4[4] +":</td><td>"+data_map[params.name][4]+"</td></tr>";
                    res += "</table></div>";
                    return res;
                }
            },
...
//支局 柱状图
function setDataToEchartMap_bar_sub4(params,url4realTimeSubList,url4mapToWhere){
    //chart.showLoading();
    //wait();
    ...
    $.ajax({
        ...
        complete:function(){
            echartMapReset_bar_sub4(min,max,params,color,datas,data_map);
            chart_map.hideLoading();
        }
    });
}
//支局 柱状图
function echartMapReset_bar_sub4(min_num,max_num,params,color,data,data_map){
    var city_name = params.parent_name;
    if(city_name.indexOf("省")>-1)
        city_name = city_name.replace(/省/gi,'');
    try{
...
//网格 点图
function setDataToEchartMap_bar_grid4(params,url4realTimeSubList,url4mapToWhere){
    //chart.showLoading();
    //wait();
    ...
    $.ajax({
        ...
        complete:function(){
            echartMapReset_bar_grid4(min,max,params,color,datas,data_map);
            chart_map.hideLoading();
        }
    });
}
//网格 点图
function echartMapReset_bar_grid4(min_num,max_num,params,color,data,data_map){
    var city_name = params.parent_name;
    if(city_name.indexOf("省")>-1)
        city_name = city_name.replace(/省/gi,'');
    try{
...
//小区 点图
function setDataToEchartMap_bar_village4(params,url4realTimeSubList,url4mapToWhere){
    //chart.showLoading();
    //wait();
    ...
    $.ajax({
        ...
        complete:function(){
            echartMapReset_bar_village4(min,max,params,color,datas,data_map);
            chart_map.hideLoading();
        }
    });
}
//小区 点图
function echartMapReset_bar_village4(min_num,max_num,params,color,data,data_map){
    var city_name = params.parent_name;
    if(city_name.indexOf("省")>-1)
        city_name = city_name.replace(/省/gi,'');
    try{
