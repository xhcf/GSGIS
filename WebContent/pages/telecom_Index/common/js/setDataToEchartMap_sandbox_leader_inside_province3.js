...
function setDataToEchartMap3(params,url4realTimeSubList,url4mapToWhere){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(d.length==0)
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    datas.push(obj);
                    datas2[org_name_temp] = [d[i].USE_RATE,d[i].USE_PORT_CNT,d[i].PORT_ID_CNT,d[i].KONG_PORT_CNT,d[i].GZ_ZHU_HU_COUNT];
                }
        ...
        complete:function(){
            echartMapReset3(min,max,params,series_name,color,datas,datas2);
            chart_map.hideLoading();
        }
    });
}
//地市 区域块
function echartMapReset3(min_num,max_num,params,series_name,color,data,data2){
