...
<e:set var="sql_part_tab_name2">
	<e:description>EDW.TB_DIM_SEND_MARKET@GSEDW 替换成 ${gis_user}.tb_dic_gis_market_type</e:description>
...
<e:description>考核统计_趋势(日)统计部分</e:description>
    <e:case value="marketing_sence_num">
        <e:q4l var="marketing_sence_num">
			...
			WHERE t1.grid_union_org_code = '${param.grid_id}'
			AND T1.STAT_DATE = TO_CHAR(SYSDATE, 'yyyymmdd')
			AND T1.STAT_LVL = 4
			and t1.grid_union_org_code IS NOT NULL
			UNION ALL
