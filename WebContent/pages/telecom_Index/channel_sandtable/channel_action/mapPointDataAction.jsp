...
<e:switch value="${param.eaction}">
  ...
  <e:case value="sc_zyl_zxt">
    ...
    <e:q4l var="list">
        SELECT T2.MONTH_CODE STATIS_MON, NVL(T1.USE_RATE, 0.00) ZYL
				...
				<e:if condition="${param.flag eq '5' }">
				VILLAGE_ID = '${short_grid_id.GRID_ID}'
				</e:if>
  ...
  <e:description>渠道沙盘-区县名字下面的获取市级id</e:description>
  <e:case value="getBureauNoByBurName">
    <e:q4o var="latnId">
      SELECT distinct(a.bureau_no) bureau_no FROM ${channel_user}.tb_gis_channel_org a,${channel_user}.tb_gis_qd_bureau_ref b WHERE b.bureau_name2 = '${param.bureau_name}' and b.latn_id = '${param.latn_id}' AND ROWNUM = 1 and a.bureau_no = b.bureau_no
    </e:q4o>
    ${e:java2json(latnId)}
  </e:case>
  ...
  <e:case value="getQXNameByBureauNo">
    <e:q4o var="dataObject">
      select org_name BUREAU_NAME from ${easy_user}.freamwork2org where cityidcol = '${param.bureau_no}'
    </e:q4o>
    ${e:java2json(dataObject)}
  </e:case>
 ...
 <e:case value="getGridResourceBySubstation">
  ...
  <e:case value="build_wines_selected_build">
    <e:q4l var="dataList">
			select '0' segm_id,
		       ...
		       sum(CENG_COUNT) CENG_COUNT,
		       sum(PEOPLE_COUNT) PEOPLE_COUNT,
		       0 OCCUPANCY_RATE,
		       0 RES_ID_COUNT,
		       0 SY_RES_COUNT,
		       sum(KD_COUNT) KD_COUNT,
		       sum(ITV_COUNT) ITV_COUNT,
		       sum(GU_COUNT) GU_COUNT,
		       sum(YD_COUNT) YD_COUNT,
		       sum(e.yx_Un) yx_un
  ...
  <e:case value="getVillageBaseInfo">
  	<e:q4o var="dataObject">
       ...
       to_char(nvl(t1.village_ru_rate,0),'FM9999999990.00')||'%' village_ru_rate ,
  		...
  		begin
              update ${gis_user}.tb_gis_village_edit_info
              	set VILLAGE_NAME = '${e:replace(param.v_name,"#","号")}',
              			...
              			WIDEBAND_NUM =  '${param.kd_user_count}',
              			TV_USER_NUM = '${param.ds_user_count}',
										zhu_hu_sum = '${param.zhu_hu_sum}',
						...
						VILLAGE_GM = '${param.village_scale}',
						village_ru_rate = replace('${param.xqrzl}','%',''),
						village_xf = '${param.village_expense_ability}',
						village_value = '${param.village_property}',
						village_label = '${param.village_type}'
  ...
  <e:case value="getVillagesByCityId">
  	<e:q4l var="dataList">
  ...
  <e:description>收集信息</e:description>
  ...
  <e:case value="getOrgsByResid">
  	<e:q4o var="dataObject">
  		SELECT bureau_Name,branch_name,grid_name FROM sde.map_addr_segm_${param.city_id} WHERE resid = '${param.add4}'
  	</e:q4o>${e:java2json(dataObject)}
  </e:case>
