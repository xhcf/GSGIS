...
<e:q4l var="kpi_index1">
  select range_min,range_max,range_name_short,nvl(range_min,range_max) range_count from gis_data.TB_GIS_KPI_RANGE where kpi_code = 'KPI_D_001' order by range_index asc
</e:q4l>
<html>
<head>
  ...
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province2.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province3.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province4.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province5.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/setDataToEchartMap_sandbox_leader_inside_province6.js?version=New Date()"/>'
          charset="utf-8"></script>
  <script src='<e:url value="/pages/telecom_Index/common/js/convertData.js?version=0.5"/>'
          charset="utf-8"></script>
...
<div style="position:relative;">
  <div class="leader_tools" id="tools_scroll">
    <ul class="nav_index_group">
      ...
      <li id="nav_index_village_page"><span></span><a href="javascript:void(0)" style="">行政村清单</a></li>
...
<script type="text/javascript">
  ...
  var url4echartmap = "";
  //echart地图要加载的页面
  var url4mapToWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/leader_city_level.jsp"/>';
  ...
  var url4mapInsideWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/leader_bureau_level.jsp"/>';
    ...
    $(".nav_index_group").children().each(function(){
      $(this).on("click",function(){
        ...
        if(index_name=="nav_index_village_detail"){//城市小区清单
          parent.load_list_view(6,flag,city_id);
          ...
          parent.load_list_view(10,'',city_id);//行政村入口 大报表模式
        }else if(index_name=="nav_index_sch_ent"){//校园商客
          //2018.10.19
          parent.switchToCity_inside_page(parent.global_current_city_id,parent.global_position[1],2,"sch_ent");
  ...
  function switch_region(region_type){
    ...
    if(region_type=="city"){
      ...
      url4devTabToWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/smallTab/small_table_broad_home_market_city.jsp" />';
      load_map("bureau");
      load_index(2,index_type,city_id,region_type);
    }else if(region_type=="sub"){
      $(".region_switch_group li:eq(2)").addClass("active");
      url4devTabToWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/smallTab/small_table_broad_home_market_sub.jsp" />';
      load_map("sub");
      load_index(3,index_type,city_id,region_type);
    }else if(region_type=="grid"){
      $(".region_switch_group li:eq(3)").addClass("active");
      url4devTabToWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/smallTab/small_table_broad_home_market_grid.jsp" />';
      load_map("grid");
      load_index(4,index_type,city_id,region_type);
    }else if(region_type=="village"){
      $(".region_switch_group li:eq(4)").addClass("active");
      url4devTabToWhere = '<e:url value="/pages/telecom_Index/sandbox_leader/smallTab/small_table_broad_home_market_village.jsp" />';
      load_map("village");
  ...
  function load_map_village_cell(){
    console.log(city_id,city_full_name,0,"village_page");
    parent.switchToCity_inside_page(city_id,city_full_name,0,"village_cell_page");
  }
