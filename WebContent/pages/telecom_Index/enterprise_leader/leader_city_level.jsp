...
<head>
  ...
  <script src='<e:url value="/pages/telecom_Index/enterprise_leader/js/setDataToEchartMap_enterprise_leader_inside_province.js?version=new Date()"/>'
...
<div style="position:relative;">
  <div class="leader_tools" id="tools_scroll">
    <ul class="nav_index_group">
      ...
      <li id="nav_index_enterprise_new"><span></span><a href="javascript:void(0)">校园新建</a></li>
    </ul>
  </div>
...
<script type="text/javascript">
  ...
  var url4echartmap = url4Query+'?eaction=index_city';
  //echart地图要加载的页面
  var url4mapToWhere = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_city_level.jsp"/>';
  var url4mapInsideWhere = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_bureau_level.jsp"/>';
  ...
  $(function () {
    ...
    $(".nav_index_group").children().each(function(){
      $(this).on("click",function(){
        ...
        }else if(index_name=="nav_index_enterprise_new"){//校园新建
        	parent.global_position[1] = city_name;
    			parent.global_position[2] = "";
    			parent.isTriggerNewFunc = true;
    			parent.toGIS();
        }else{//前6个指标
  ...
  function switch_region(region_type){
    ...
    if(region_type=="bureau"){
      ...
      load_map("bureau");
      load_index(1,index_type,city_id);
    }
  ...
  function load_map(region_type){
    ...
    if(region_type=="bureau"){
      ...
      $.get(url4mapToJson, function (cityJson) {
        ...
        if(index_type== 0){
        	url4echartmap = url4Query+"?eaction=index_map&level=2&acct_day=${yesterday.VAL}&city_id="+city_id;
        	setDataToEchartMap(params, url4echartmap, url4mapToWhere);
        }
        return;
      });
