...
<script>
	...
	/*function jumpToCRM_xiaoqiantai() {
		...
		var cert_num = encodeURI(encodeURI("17793102293"));//acc_nbr
		var contactOrderId = "8C8D1A73D87E854FE0530100007F3C6C";//order_id
		var targetObjNbr = "500212549408";//prod_inst_id
		...
		$.post('<e:url value="crmUrl2019.e"/>',{
			...
			"mktCamCateId":"81000014592",//81000014592;81000015572
			"isSupportAccept":"1"//1;3
			//81000015572 3 预受理
			//81000014592 1 一键订购界面
		},function(data1){
