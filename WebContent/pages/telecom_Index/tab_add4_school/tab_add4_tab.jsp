...
<script type="text/javascript">
    ...
    var url4data_vill_market = '<e:url value="/pages/telecom_Index/common/sql/tabData_add4_school.jsp" />';
            ...
            $.post(url4data_vill_market, params, function (data) {
                ...
                for (var i = 0, l = data.length; i < l; i++) {
                    ...
                    if('${sessionScope.UserInfo.LEVEL}'<4){
                        if('${sessionScope.UserInfo.SCHOOL_PERMISSIONS}'!="")//校园角色特有定位功能
                            newRow += ""
                            +"<td class='text-left clickable' onclick='javascript:toMap_add4(\""+ d.LATN_ID +"\",\""+ d.SEGM_ID +"\")'>" + d.STAND_NAME + "</td>";//四级地址
                        else
