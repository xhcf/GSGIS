...
//2.各层GIS地图主页面中打开客户视图的方法，将exec_agent方法的参数，传递给客户视图弹窗页
 function openCustViewByProdInstId(params) {
    ...
    var village_id = params.village_id;
    var address_id = params.address_id;
    var tab_id = params.tab_id;
    var prod_inst_id = params.prod_inst_id;
    var brigade_id = params.brigade_id;
    var only_collect = params.only_collect;
    ...
    //$("#info_collect_view_div").hide();
     console.log("行政村");
     debugger;
    $("#info_collect_edit_div > iframe").attr("src", appBase+"/pages/telecom_Index/sub_grid/viewPlane_info_collect_edit_diy_village_cell.jsp?village_id=" + village_id+"&tab_id="+tab_id+"&city_id="+city_id+"&address_id="+address_id+"&prod_inst_id="+prod_inst_id+"&brigade_id="+brigade_id+"&is_yx=1"+"&only_collect="+only_collect);
