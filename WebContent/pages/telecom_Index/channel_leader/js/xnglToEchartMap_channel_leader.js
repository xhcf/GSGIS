...
//省级地图 有效代码
function setDataToEchartMap_bar_bureau(params,url4realTimeSubList,url4mapToWhere,url4channeltype,sql_url){
    //chart.showLoading();
    //wait();
    var fullCityName = params.city_full_name;
    if(params.flag == 3){
                ...
                if(data != '' && data != null ){
                    ...
                    $.post(sql_url1,{},function(data){
                        ...
                        $.each(data1.rows,function(index1,value1){
                            var val = datatype_simple[value1.AREA_DESCRIPTION];//20190409 隐藏点
                            if(!val){
                                datatype_simple.push({"name":value1.AREA_DESCRIPTION,"value":value1.QDXN_CUR_MONTH_SCORE_NUM});
                            }
                        });

                        echartMapReset_bar_bureau(min,max,params,color,datas1,datas2,datas3,data_map,datatype_tip,datatype_simple);
                        chart_map.hideLoading();
                    });
                }
            });
...
//区县 柱状图
function echartMapReset_bar_bureau(min_num,max_num,params,color,datas1,datas2,datas3,data_map,datatype_tip,datatype_simple){
    var city_name = params.parent_name;
    if(city_name.indexOf("省")>-1)
        city_name = city_name.replace(/省/gi,'');
    try{
            ...
            series: [
                {
                    ...
                    geoIndex:0,
                    data: convertData_channel('999',datas1,[60,50,40,30,20,0]),
                ...
                },
                {
                    ...
                    coordinateSystem: 'geo',
                    geoIndex:0,
                    data: convertData_channel('999',datas2,[60,50,40,30,20,0]),
                ...
                },
                {
                    ...
                    coordinateSystem: 'geo',
                    geoIndex:0,
                    data: convertData_channel('999',datas3,[60,50,40,30,20,0]),
