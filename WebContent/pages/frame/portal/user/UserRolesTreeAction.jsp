...
<e:switch value="${param.eaction}">
	...
	%>
		...
		<e:if condition="param.removeRoleIds!='[]'">
			...
			<e:set var="strDelRoleIds" value="${e:substring(strDelRoleIds,1,strDelRoleIds.length())}"/>
		...
		<e:if condition="param.addRoleIds!='[]'">
			...
			<e:set var="strAddRoleIds" value="${e:substring(strAddRoleIds,1,strAddRoleIds.length())}"/>
			<e:q4l var="addRoles" >
