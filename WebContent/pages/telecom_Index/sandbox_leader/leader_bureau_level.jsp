...
<head>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/bureau_geo_center.js?version=1.5"/>'
            charset="utf-8"></script>
...
//						}
    ...
    parent.resize_vill_win = function(flag){
    	if(flag=="open"){
    		$("#village_info_win").css({"width":"90%"});
    		$("#village_info_win").css({"left":"5%"});
    	}else{
    		$("#village_info_win").css({"width":"70%"});
    		$("#village_info_win").css({"left":"15%"});
    	}
    }
