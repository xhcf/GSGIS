...
<html>
	...
	*{ margin:0; padding:0; list-style:none;}
	...
	.findPassword {  width:500px; position:absolute; left:50%; margin-left:-249px; top:50%; margin-top:-80px; background:#f9f9f9 url("resources/themes/base/images/boncLayout/img/iconFindPwd.png") 340px 45px no-repeat; border:1px solid #ccc;}
