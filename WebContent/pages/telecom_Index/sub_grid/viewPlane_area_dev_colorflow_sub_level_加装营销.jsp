...
<head>
	...
	<link href='<e:url value="/resources/themes/common/css/reset.css?version=1.3"/>' rel="stylesheet" type="text/css" media="all" />
	...
	<script src='<e:url value="/pages/telecom_Index/common/js/js_constant.js?version=3.5"/>' charset="utf-8"></script>
	...
	<link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_area_dev_colorflow.css?version=3.2"/>' rel="stylesheet" type="text/css" media="all" />
...
<style type="text/css">
    ...
    .village_m_tab15 table.content_table  tr td:nth-child(2) {color:#3d8ccf;padding-left:5px;}
    .village_m_tab15 table.content_table  tr td:nth-child(3) {color:#3d8ccf;}
	.build_detail_in a {color:#3d8ccf;text-decoration:none;font-size:12px;}
	#updown {
		...
		.village_m_tab15 table.content_table  tr td:nth-child(4) {color:#3d8ccf;}
	.build_detail_in a {color:#3d8ccf;text-decoration:none;font-size:12px;}
    ::-webkit-scrollbar{padding-left:1px;background-color: #eee;overflow:visible;width:14px;height:14px;}
	.content_table.build_detail_i tr:first-child {background-color:#fffec9;}
	.content_table.build_detail_i tr:first-child td:nth-child(2) {text-align:center;}
	.table.build_detail_in tr:first-child td {background-color:#fffec9; color:#333;}
	table.build_detail_in, table.build_detail_in th, table.build_detail_in td {font-size:12px;}
	#village_info_list.content_table.build_detail_in tr:first-child td {background-color:#fffec9; color:#333;}
	#village_info_list.content_table.build_detail_in tr:first-child td:nth-child(2) {text-align:center;}
	yx_info_list tr td:nth-child(2) {text-align:left;}
	.content_table.build_detail_i tr:first-child td:nth-child(2) {color:#333;}
	.content_table.build_detail_i tr:first-child td:nth-child(3) {color:#333;}
	.content_table.build_detail_i tr:first-child td:nth-child(4) {color:#333;}
	.village_m_tab15 table.content_table  tr td:nth-child(2) {text-align:left;}
	.village_m_tab15 table.content_table tr td:last-child {color:#a03e24;}
	.village_m_tab14 table.content_table tr td:last-child {color:#a03e24;}
	.village_m_tab14 table.content_table tr td:nth-child(3) {color:#a03e24;}
	#nav_marketing_btn {
    height: 24px;
    width: 70px;
	...
	#query_div{width:120px;background:#0f2c92;padding:0;position:absolute;display:none;}
	#query_div div{float: left;  height: 38px;  line-height: 38px;  color: #fff;  cursor: pointer;  padding-left:5px;}
	.ico{    width: 17px;  height: 17;  margin-right: 7px;  margin-top: -20px;}
	#query_div span{height: 18px;  line-height: 18px;  width: 30px;  font-size: 12px;  display: inline-block;  margin-top: 2px;}
	
	#model_to_rank{display:none;}
</style>
...
<div id="grid_info_win" class="sub_grid_win">
...
<div class="village_info_win new_beta" id="build_info_win1" style="display: none;height:360px;">
	<div class="village_title" id="build_info_win_draggable"><span>楼宇信息</span><div class="village_close" onclick="$('#build_info_win').hide()"></div></div>
  		...
  		<div class="devep village_new_base">
  				...
  				<div class="deve_tb">
  					<table border="0" width="100%" style="margin-top:15px;">
  						<tr>
  							<td width="50%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">支局：<span id="build_view_sub"></span></span></div></td>	
  							<td><div class="quota"><span>网格：<span id="build_view_grid"></span></span></div></td>
  						</tr>
  					</table>
  				</div>
  				<div class="deve_ta">
  				...
  				<div class="deve_tb" style="padding-top:12px;">
  					<table border="0" width="100%">
  						<tr>
  							<td width="31%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">移动用户：<span id="build_view_yd_count"></span></span></div></td>	
  							<td width="23%"><div class="quota"><span>宽带用户：<span id="build_view_kd_count"></span></span></div></td>
  							<td width="24%"><div class="quota"><span>电视用户：<span id="build_view_ds_count"></span></span></div></td>
  							<td width="22%"></td>
  						</tr>
  					</table>
  				</div>
...
<div class="build_more_win"  id="detail_more" style="display:none;">
  <div class="titlea"><div id="detail_more_draggable" style='text-align:left;width:90%;display: inline-block'>楼宇视图</div><div  class="titlec" onclick="$('#detail_more').hide()"></div></div>
	<iframe width="100%" height="100%"></iframe>
</div>
<!-- 楼宇详情弹窗 shenruijie end-->
<!-- 营销详情弹窗 -->
<div class="build_more_win"  id="mark_detail" style="display:none;">
  <div class="titlea"><div id="mark_detail_draggable" style='text-align:left;width:90%;display: inline-block'></div><div  class="titlec" onclick="$('#mark_detail').hide()"></div></div>
...
<div class="village_info_win new_beta" id="village_info_win" style="display: none;">
	<div class="village_title" id="village_drag_handler"><span>小区信息</span><div class="village_close" id="village_close"></div></div>
  ...
  <div class="bulid_village_btn village_edit" style="top:72px;width:152px;"><button   id="editBuildInVillage_btn" onclick="javascript:editBuildInVillage();">编辑</button><button id="deleteBuildInVillage_btn" onclick="javascript:deleteBuildInVillage();">删除</button></div>
  <h3  class="wrap_a tab_menu" style="border-left:none;padding-left:11px;"><span style="cursor:pointer;" class="selected">小区概况</span> | <span style="cursor:pointer;">楼宇清单</span> | <span style="cursor:pointer;">营销清单</span> | <span style="cursor:pointer;">竞争收集</span></h3>
  ...
  <div class="tab_box">
  		...
  		<div class="devep village_new_base">
  				...
  				<div class="deve_tb info_base">
  					<table border="0" width="100%">
  						<tr>
  							<td width="60%">
  								<div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;line-height: 24px">支局：<span id="village_view_sub"></span></span></div>
  							  <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;line-height: 24px">网格：<span id="village_view_grid"></span></span></div>
  							</td>
  							<td>
  								<div class="quota"><span>创&nbsp;建&nbsp;人&nbsp;：<span id="village_view_creator" style="line-height: 24px"></span></span></div>
  								<div class="quota"><span>创建时间：<span id="village_view_create_time" style="line-height: 24px"></span></span></div>
  							</td>
  					  </tr>
  					</table>
  				</div>
  				...
  				<div class="deve_tb">
  						<table border="0" width="100%">
  							<tr>
  								<td width="29%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;important;">市场占有率：<span id="village_view_market_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>	
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">楼宇数：<span id="village_view_build_count"></span></span></div></td>
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">住户数：<span id="village_view_zhu_hu"></span></span></div></td>
  								<td width="23%"><div class="quota"><span style="margin-left: 10px">人口数：<span id="village_view_real_zhu_hu"></span></span></div></td>
  							</tr>
  						</table>
  				</div>
  				<div class="deve_ta">
  				...
  				<div class="deve_tb">
  						<table border="0" width="100%">
  							<tr>
  								<td width="29%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">移动用户：<span id="village_view_yd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">宽带用户：<span id="village_view_kd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">电视用户：<span id="village_view_ds_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
  								<td width="23%"></td>
  							</tr>
  						</table>
  				</div>
  				...
  				<div class="deve_tb">
  						<table border="0" width="100%">
  							<tr>
  								<td width="29%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;important;">端口占用率：<span id="village_view_port_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">总端口：<span id="village_view_port"></span></span></div></td>
  								<td width="24%"><div class="quota"><span style="margin-left: 10px">占用端口：<span id="village_view_port_used"></span></span></div></td>
  								<td width="23%"><div class="quota"><span style="margin-left: 10px">空闲端口：<span id="village_view_free_port"></span></span></div></td>
  							</tr>
  						</table>
  				</div>
  		</div>
  	...
  	<div style="display:none;" >
  		<div class="village_new_searchbar">
  		  <div class="count_num">记录数：<span id="village_view_build_record_count"></span></div><div style="color:black;">四级地址：<input type="text" id="village_view_build_search_add4" class="search_input" /><button id="village_view_build_search_btn">查&nbsp;询</button></div>
  		</div>
  		<!--表头-->
        ...
        <table  class="content_table"  style="width:100%;margin:0px auto;">
            ...
            <th colspan=3>业务</th>
					...
					<tr>
						<th width="50" rowspan=2 >总端口</th><th width="50" rowspan=2>空闲<br/>端口</th>
						<th width="45">宽带</th><th width="45">电视</th><th>固话</th>
					</tr>
			  </table>
			</div>
  	...
  	<div style="display:none;" >
  		<div class="village_new_searchbar">
  		  ...
  		  <div style="color:black;">四级地址：<input type="text" id="village_view_yx_search_add4" class="search_input" /><button id="village_view_yx_search_btn">查&nbsp;询</button></div>
  		</div>
  		<!--表头-->
  		<div class="village_m_tab" style="width:98%;padding-right:17px;">
        <table  class="content_table"  style="width:100%;margin:0px auto;">
            ...
            <th colspan=4>营销</th>
					...
					<tr>
						<th width="60">总数</th><th width="60">已执行</th><th width="60">未执行</th><th>执行率</th>
					</tr>
			  </table>
			</div>
  	...
  	<div class="devep village_new_base competition" style="margin-top:0px;display:none;">
  		<div>
 			<table border="0" width="100%" align="center"  style="margin-bottom:10px">
				<tr>
					<td width="43%"><div class="quota"><span>电信独家进线：<span id="village_view_dx_only"></span></span></div></td>
					<td width="28%"><div class="quota"><span>电信光网覆盖：<span id="village_view_dxgw_cover"></span></span></div></td>
					<td ></td>
				
				</tr>  
				<tr>
					<td><div class="quota"><span>移动光网覆盖：<span id="village_view_ydgw_cover"></span></span></div></td>
					<td><div class="quota"><span>联通光网覆盖：<span id="village_view_ltgw_cover"></span></span></div></td>
					<td><div class="quota"><span>广电光网覆盖：<span id="village_view_gdgw_cover"></span></span></div></td>
				</tr> 
			</table>
  		</div>
  		<div class="deve_ta info_base"  style="background-color:#1DBBB5;">
			...
			<div class="deve_tb info_base" >
				<table border="0" width="100%" align="center">
				 <!--<tr>
					...
					<tr>
						<td width="33%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">移动渗透率：<span id="village_view_yd_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
						<td width="33%"><div class="quota"><span>宽带渗透率：<span id="village_view_kd_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
						<td width="33%"><div class="quota"><span>电视渗透率：<span id="village_view_ds_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
					</tr>
					<tr>
						<td width="33%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">移动用户：<span id="village_view_dxyd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
						<td width="33%"><div class="quota"><span>宽带用户：<span id="village_view_dxkd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
						<td width="33%"><div class="quota"><span>电视用户：<span id="village_view_dxds_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
					</tr>
				</table>
			</div>
			...
			<div class="deve_tb text_input">
				<table border="0" width="100%">
					<tr>
						<td width="33%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">移动用户数：<span id="village_view_ydyd_count"></span></span></div></td>
						<td width="33%"><div class="quota"><span>宽带用户数：<span id="village_view_ydkd_count"></span></span></div></td>
						<td width="33%"><div class="quota"><span>电视用户数：<span id="village_view_ydds_count"></span></span></div></td>
					</tr>
				</table>
			</div>
			<div class="deve_ta" style="background-color:#1DBBB5;">
			...
			<div class="deve_tb text_input">
				<table border="0" width="100%">
					<tr>
						<td width="33%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">移动用户数：<span id="village_view_ltyd_count"></span></span></div></td>
						<td width="33%"><div class="quota"><span>宽带用户数：<span id="village_view_ltkd_count"></span></span></div></td>
						<td width="33%"><div class="quota"><span>电视用户数：<span id="village_view_ltds_count"></span></span></div></td>
					</tr>
				</table>
			</div>
			<div class="deve_ta" style="background-color:#1DBBB5;">
			...
			<div class="deve_tb text_input">
				<table border="0" width="100%">
					<tr>
						<td width="33%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">宽带用户数：<span id="village_view_gdkd_count"></span></span></div></td>
						<td width="33%"><div class="quota"><span>电视用户数：<span id="village_view_gdds_count"></span></span></div></td>
						<td width="33%"></td>
					</tr>
				</table>
					</div>
...
<div class="build_more_win" id="village_market_detail" style="display: none;position:absolute;z-index:99999999999888;">
 <div class="target_dev" style="width: 100%">
  <div class="village_title"><span id="village_title">营销清单</span><div class="village_close" id="vvv" onclick="village_close_fun()"></div></div>
...
<div class="build_more_win" id="build_market_detail" style="display: none;position:absolute;z-index:99999999999888;">
 <div class="target_dev" style="width: 100%">
  <div class="village_title"><span id="build_market_detail_title">营销清单</span><div class="village_close" id="vvv" onclick="build_market_detail_close_fun()"></div></div>
...
<div id="buildInVillage_review_win" class="village_info_win" style="display:none;position:absolute;z-index:999;">
  ...
  <div class="target_a" style="border-bottom:none;">
     <h3 class="wrap_a tab_menu" style="border-left:none;padding-left:0px;margin-bottom:8px;"><span style="cursor:pointer;" class="selected">基础信息</span> | <span style="cursor:pointer;">竞争信息</span></h3>
  ...
  <div class="tab_box">
	  <div>
			<div class="target_a" style="border-bottom:none;">
				...
				<h3 class="wrap_a">楼宇列表<span class="add_item" onclick="javascript:cancleBuildInVillage()" style="margin-right:0px;float:right;margin-top:6px;">&nbsp;</span></h3>
	  ...
	  <div style="display:none;" class="competition">
	  	<div class="target_a" style="border-bottom:none;">
			...
			<div class="base1" style="height:36px;">
				<table border="0" width="100%">
					<tr>
						...
						<td width="33%"><span class="comp">实际住户数:</span> <input type="text" class="number" name="real_home_num" /></td>	
						<td width="33%"><span class="comp">人口数:</span> <input type="text" class="number" name="people_num" /></td>	
					</tr>
				</table>
			</div>
			...
			<div>
				<table border="0" width="100%">
					<tr>
						<td width="33%"><div class="quota"><span>电信独家进线：</span><select id="village_new_dx_only"  class="list_select" style="width: 66px;margin-left: 6px"><option value="0">否</option><option value="1">是</option></select></div></td>
						<td width="33%"><div class="quota"><span>电信光网覆盖：</span><select id="village_new_dxgw_cover"  class="list_select" style="width: 66px;margin-left: 6px"><option value="0">否</option><option value="1">是</option></select></div></td>
					</tr>
					<tr>
						<td width="33%"><div class="quota"><span>移动光网覆盖：</span><select id="village_new_ydgw_cover"  class="list_select" style="width: 66px;margin-left: 6px"><option value="0">否</option><option value="1">是</option></select></div></td>
						<td width="33%"><div class="quota"><span>联通光网覆盖：</span><select id="village_new_ltgw_cover"  class="list_select" style="width: 66px;margin-left: 6px"><option value="0">否</option><option value="1">是</option></select></div></td>
						<td width="33%"><div class="quota"><span>广电光网覆盖：</span><select id="village_new_gdgw_cover"  class="list_select" style="width: 66px;margin-left: 6px"><option value="0">否</option><option value="1">是</option></select></div></td>
					</tr>
				</table>
			</div>
			<div class="devep village_new_base">
  				...
  				<div class="deve_tb"  style="padding-top:12px;">
  					<table border="0" width="100%">
  						<tr>
  							...
  							<td width="35%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left:5px">移动用户：<span id="village_new_dxyd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
							<td width="33%"><div class="quota"><span>宽带用户：<span id="village_new_dxkd_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
							<td width=""><div class="quota"><span style="margin-left: 10px">电视用户：<span id="village_new_dxds_count" style="color:#FF9214;font-weight:bold!important;"></span></span></div></td>
  						</tr>
  					</table>
  				</div>
  				<div class="deve_ta">
  				...
  				<div class="deve_tb text_input" style="padding-top:12px;">
  					<table border="0" width="100%">
  						<tr>
  							<td width="35%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">移动用户：<input type="text" name="village_new_ydyd_count"/></span></div></td>
  							<td width="33%"><div class="quota"><span>宽带用户：<input type="text" name="village_new_ydkd_count"/></span></div></td>
  							<td><div class="quota"><span style="margin-left: 10px">电视用户：<input type="text" name="village_new_ydds_count" /></span></div></td>
  						</tr>
  					</table>
  				</div>
  				<div class="deve_ta">
  				...
  				<div class="deve_tb text_input" style="padding-top:10px;">
  					<table border="0" width="100%">
  						<tr>
  							<td width="35%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">移动用户：<input type="text" name="village_new_ltyd_count" style="width:40px;"/></span></div></td>
  							<td width="33%"><div class="quota"><span>宽带用户：<input type="text" name="village_new_ltkd_count" style="width:40px;"/></span></div></td>
  							<td><div class="quota"><span style="margin-left: 10px">电视用户：<input type="text" name="village_new_ltds_count" style="width:40px;"/></span></div></td>
  						</tr>
  					</table>
  				</div>
  				<div class="deve_ta">
  				...
  				<div class="deve_tb text_input"  style="padding-top:10px;">
  					<table border="0" width="100%">
  						<tr>
  							<td width="35%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">宽带用户：<input type="text" name="village_new_gdkd_count" style="width:40px;"/></span></div></td>
  							<td width="33%"><div class="quota"><span>电视用户：<input type="text" name="village_new_gdds_count" style="width:40px;"/></span></div></td>
  							<td><div class="quota"></div></td>
  						</tr>
  					</table>
  				</div>
				</div>
		...
		<div style="margin-top: 5px">
			...
			<div class="list_search" >
				<div style="margin-top:5px">
					...
					<div style="margin-left: 10px;display: inline-block;font-size:12px" disabled="disabled">区&nbsp&nbsp县:</div>
	...
	<div style="overflow: hidden">
		<div style="margin-top: 5px">
			...
			<div class="list_search">
				...
				<div style="margin-left: 5px;margin-top:5px">
										<div class="list_text">支&nbsp&nbsp局:</div><select id="g_branch"  class="list_select" style="width: 210px;margin-left: 10px;" disabled="disabled"><option value="">全部</option></select>
				</div>
			...
			<div class="build_bar sub_level">
			  <table>
			    <tr>
			      ...
			      <td width="160">
			        <input type="text" id="v_village_name" placeholder="输入小区名称" style="width: 135px;font-size:12px;background:#fff;">
			      </td>
			      <td width="45">
			        	网&nbsp&nbsp格:
			      </td>
			      <td width="230">
			        <select id="v_grid"  class="list_select" style="width: 210px;"><option value="">全部</option></select>
			      </td>
			      <td width="80"><button id="village_query" class="btn_uc">查&nbsp&nbsp询</button>
			      </td>
			      <td><button id="xinjian1" class="btn_xj" style="margin-top:0px;">新&nbsp;&nbsp;建</button></td>
			    </tr>
			  </table>
		</div>
...
<div id="build_div" style="display: none;height: 100%">
	<div style="overflow: hidden">
			...
			<div id="build_div_sub_name" class="village_name_new"></div>

		<div class="build_bar sub_level">
		
				<div class="list_text">四级地址:</div><input type="text" id="build_segm_name" placeholder="输入四级地址" style="width: 135px;margin-left: 13px;margin-top: 2px;font-size:12px;background:#fff;">
				<button id="build_query" class="btn_uc" style="margin-top:2px;font-size: 12px">查&nbsp&nbsp询</button>
...
<div id="yingxiao_village_div" style="display: none;height: 100%">
	<div style="overflow: hidden">
			...
			<div id="yingxiao_div_sub_name"  class="village_name_new"></div>

		<div class="build_bar sub_level">
		    <div class="list_text">网&nbsp&nbsp格:</div><select id="yx_v_grid"  class="list_select" style="width: 210px;margin-left: 13px"><option value="">全部</option></select>
				<div class="list_text">小&nbsp&nbsp区:</div><input type="text" id="yx_v_village_name" placeholder="输入小区名称" style="width: 135px;margin-left: 13px;margin-top:2px;font-size:12px;background:#fff;">
				<button id="yx_village_query" class="btn_uc" style="margin-top:2px;font-size: 12px">查&nbsp;&nbsp;询</button>
				<button id="nav_marketing_btn" class="btn_uc" style="margin-top:2px;font-size: 12px">新&nbsp;&nbsp;建</button>
		</div>
		<div class="count_num count_sub_level">记录数：<span id="yx_villagecount1"></span></div>
		<div style="padding-right:14px;width:96%;margin:2px auto 0px auto;" class="village_m_tab">
			<table class="build_detail_in" style="width:100%;">
				<tr>
					<th width="6%">序号</th>
		  ...
		  <div class="t_table village_m_tab15" style="margin:0px auto;">
			<table class="content_table build_detail_i" id="yx_info_list" style="width:100%;">
			</table>
	      </div>
	...
	<div style="overflow:hidden;">
		...
		<div class="list_search"style="padding-bottom: 5px;margin-bottom: 0px" >
			<div style="margin-left: 5px;margin-top: 5px;">
				...
				<div class="list_text" style="margin-left: 10px">区&nbsp;&nbsp县：</div><select id="y_area"  class="list_select" style="width: 75px;;margin-left:5px"><option value="" >全部</option></select>
			</div>
			<div style="margin-left: 5px;margin-top:5px">
				<div class="list_text">名&nbsp;&nbsp&nbsp称：</div><input type="text" id="chaxun" placeholder="输入营销名称" style="width: 115px;margin-left: 5px">
...
<div style="clear:both ">
	...
	<div class="tools_n" id="tools_scroll" style="position:absolute;top:-12px;left:0px;text-align:center;">
		...
		<ul id="tools">
			...
			<li id="model_to_rank" style="cursor: hand"><span></span><a href="javascript:void(0)" >统计</a></li>
			<li id="nav_village2" style="cursor: hand;"><span></span><a href="javascript:void(0)" id="village">小区</a></li>
			<li id="nav_standard2" style="cursor: hand"><span></span><a href="javascript:void(0)" id="standard">楼宇</a></li>
			<li id="nav_marketing2" style="cursor: hand"><span></span><a href="javascript:void(0)" id="marketing">营销</a></li>
...
<!--<div id="query_div">
	<div style="width:60px;border-right:1px solid #ccc;"  onclick="javascript:viewRank();"><img src="<e:url value='/pages/telecom_Index/sub_grid/image/paiming1.png' />" class="ico"/><span>划小<br/>排名</span></div><div style="width:60px" class="mapico" onclick="javascript:viewVillageDraw();"><img src="<e:url value='/pages/telecom_Index/sub_grid/image/shangtu1.png' />" class="ico"/><span>小区<br/>统计</span></div>
</div>-->
<!--绘制工具箱-->

<div id="marketing_div" class="tools" style="width:400px;">
	<div style="width:50px;display: inline-block;line-height: 42px;margin-top:3px;color:#ffd200;font-size: 14px;margin-left: 10px;border-right: 1px solid #ccc;float: left;">工具栏</div>
...
//    var sub_has_grid_self_line_color = [44,169,253,1];//支局的轮廓线线条颜色
    ...
    global_position_build_view.push(city_name);
    global_position_build_view.push(bureau_name);
    global_position_build_view.push(sub_name);
              ...
              //draw_layer.visible = false;
       		...
       		$('#nav_zoomprev').unbind();
					...
					function freshVillageViewBuildList(village_id,segm_name_search){
	                        ...
	                        cit.empty();
                        	$.post(url4Query, {eaction: "village_view_build_detail_query_list", yxid: village_id, standard_name:segm_name_search}, function (data) {
	                            data = $.parseJSON(data);
					...
					function freshVillageViewYXList(village_id,segm_name_search){
	                        ...
	                        cit.empty();
                        	$.post(url4Query, {eaction: "yx_detail_query_list", yxid: village_id, standard_name:segm_name_search}, function (data) {
	                            data = $.parseJSON(data);
															if(data==null && data.length==0){
					...
					function queryVillage(latn_id) {
						...
						$.post(url4Query,{eaction:eaction_str,latn_id:latn_id,bureau_no:bureau_no,union_org_code:union_org_code,grid_id:grid_id,village_name:$.trim(vn)},function (data) {
							data=$.parseJSON(data)
          ...
          clickToGridAndVillage = function (substation,sub_name,thiz,zoom,grid_name,station_id,village_id,tab_id) {
            ...
            tmpy = '1';
              ...
              $("#info_collect_edit_div").hide();
					...
					$("#model_to_rank").click(function(){
						parent.load_list_village(4,city_id,bureau_no,branch_no);
					});
                    //小区列表开始
					var village_list;
					$('#nav_village2').unbind();
			...
			setGrids(id,e2,e3);
                    ...
                    function setGrids(id,e1,e2){
                        ...
                        $.post(url4Query,{eaction:"setgrids",id:substation,latn_id:latn_id,bureau_no:bureau_no},function (data) {
                            data=$.parseJSON(data);
							e1.unbind();
...
//                                map.centerAndZoom(point,zoom);
									...
									setBuildCity();
									//
									$("#build_div_sub_name").text(sub_name);
              ...
              buildInVillage_mode = "add";
              	...
              	clickToSub(substation,sub_name,'',parseInt(9));
					...
					function queryYX() {
                        ...
                        $.post(url4Query,{eaction:'yingxiao_list',chaxun:chaxun,latn_id:latn_id,area_id:area_id,creater_id:'${sessionScope.UserInfo.LOGIN_ID}'},function (data) {
                            data=$.parseJSON(data);
							$("#yingxiao_table").html("");
                            if(data!=null){
                                $.each(data,function (i, d) {
                                    ...
                                    if(x.length>8)
                                        x=x.substr(0,7)+'..'*/
                                    var str = "<tr class=\"tr_default_background_color\" style='font-size:14px;cursor:pointer;' onclick=\"javascript:queryfromyxid('"+d.YX_ID+"',this)\"><td>"+ (i+1)+"</td><td style='width: 55%;text-align:left;' >"+d.YX_NAME+"</td><td style='text-align: left' >"+d.CREATE_DATE+"</td></tr>"
					...
					function queryYX_village(latn_id){//yingxiao_village_div
						$("#yingxiao_div_sub_name").text(sub_name);
							            //清空列表
						var vn = $("#yx_v_village_name").val();
						var grid_id=$("#yx_v_grid option:selected").val();
						var notUpload=0
                        $.post(url4Query,{eaction:'yingxiao_list_for_village_for_grid_user',latn_id:latn_id,bureau_no:bureau_no,union_org_code:substation,grid_id:grid_id,village_name:$.trim(vn)},function (data) {
                            data=$.parseJSON(data);
														$("#yx_info_list").html("");
                            if(data!=null){
                            ...
                            if(data.length==0) {
                            	$("#yx_villagecount1").text(data.length);
								$("#yx_info_list").html("")
                                $("#yx_info_list").html("<tr><td colspan=6 style='text-align:center'  onMouseOver=\"this.style.background='rgb(250,250,250)'\">没有查询到数据</td></tr>")
                            }/*else if(data.length<stan){
                                for(var i=0;i<=stan-data.length;i++) {
                                    var str = "<tr class=\"tr_default_background_color\" onclick=\"\"  onMouseOver=\"this.style.background='rgb(250,250,250)'\"><td style='text-align: center'></td><td style='text-align:center;' ></td><td style='text-align: center'></td></tr>";
                                    $("#yx_info_list").append(str);
                    ...
                    function freshYXViewList(yx_id,yx_view_yx_search_add4){
                    		$("#yx_view_yx_list").empty();
                    		$.post(url4Query,{eaction:"yx_view_query_list",yxid:yx_id,standard_name:yx_view_yx_search_add4},function(data){
                        	data = $.parseJSON(data);
                        	for(var i = 0,l = data.length;i<l;i++){
                        		var d = data[i];
                        		var newRow = "";
					...
					function getBuildCount_buildList(build_name){
						$.post(url4Query,{eaction:"getBuildCount_buildList",latn_id:city_id,build_name:build_name,"substation":substation},function (data) {
							data = $.parseJSON(data);
					...
					function buildListScroll(region_id,build_name,latn_id,substation,grid_id,page){
						...
						$.post(url4Query,{"eaction":"build_list_for_grid_user","region_id":region_id,build_name:build_name,latn_id:latn_id,"substation":substation,"grid_id":"","page":page},function(data){
								data = $.parseJSON(data);
					...
					function queryBuild(build_for_search){
						...
						build_list_page = 0;
						buildListScroll(bureau_no,build_for_search,city_id,substation,'',build_list_page);
					}
					var build_list_page = 0;
					...
					function queryBuild_nouse(build_name){
						$("#build_div_sub_name").text(sub_name);
						var build_name = $("#build_segm_name").val();
						$("#build_info_list").empty();
						var queryTask = new QueryTask(standard_address);
						var query = new Query();
						query.geometry = geo_sub_for_build_list;
						query.outFields = ["*"];
						...
						queryTask.execute(query, function (results) {
							...
							$.post(url4Query,{"eaction":"build_list_for_grid_user","segm_ids":segmid_for_yx_save,"build_name":build_name},function(data){
								data = $.parseJSON(data);
								for(var i = 0,l = data.length;i<l;i++){
									var d = data[i];
...
//							skin: 'demo-class',
          ...
          var village_new_items = "";
					...
					function subDraw_subList(){
						$.post(url4Query,{eaction:"getSubColorByLatnId",city_id:city_id,id:bureau_no,sub_id:substation,yesterday:'${yesterday.VAL}',last_month:'${lastMonth.VAL}'},function(data){
							data = $.parseJSON(data);
							for(var i = 0,l = data.length;i<l;i++){
								var d = data[i];
							...
							//设置左侧列表内容
							$.post('<e:url value="querysubgrid.e"/>',{eaction:"getSubListByLatnId",city_id:city_id,id:bureau_no,substation:substation},function(data){
								data = $.parseJSON(data);
								var data1 = data[1];
								data = data[0];
								var sub_style_num = new Array();
					...
					var drawAddToMap = function (evt) {
						...
						if(done) {
							var queryTask = new QueryTask(standard_address);
							var query = new Query();
							query.where = "UNION_ORG_CODE = '"+substation+"'";
							if(draw_type=="leida"){
					...
					function freshYX_new_buildyx_list(segmid_for_yx_save,segm_name_for_search){
						$("#yx_new_four_address_list").empty();
						$.post(url4Query,{"eaction":"yingxiao_new_add4_list","segmid":segmid_for_yx_save,"segm_name":segm_name_for_search},function(data){
            	data = $.parseJSON(data);
					...
					map.on("extent-change", function(evt){
						...
						if(mapZoom<9){
							...
							if(false){//如果处于小区框选功能中 //!vboo
								var grid_gra = sub_graphics_init[substation];//grid_graphics_init[vgrid_id];
								if (grid_gra) {
...
//									var linesymbol = new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color(qx_all_line_color), 1.5);
					...
					var subToGrid = function(graphics,sub_selected_geometry,sub_attr){
						...
						if($("#v_grid").children().length==1){
							layer.msg("该支局无网格");
							//加载支局下的小区
            	village_load_by_sub(sub_attr.SUBSTATION_NO,'');
							return;	
						}
            ...
            $.post(url4Query, {
              ...
              where_temp += ")";
					...
					backToSub = function(){
						...
						var sub_gras = featureLayer.graphics;
						for(var i = 0,l = sub_gras.length;i<l;i++){
							var gra = sub_gras[i];
							if(gra.attributes["SUBSTATION_NO"]==substation)
								back_to_ext = gra.geometry;
						}
						//back_to_ext = featureLayer.graphics.geometry;
					...
					featureLayer.on("update-end",function(){
						$.post(url4Query,{"eaction":"getSubListByLatnId","city_id":city_id,"id":bureau_no,sub_id:substation},function(data){
							data = $.parseJSON(data);
							//data = data[0];
							if(data.length==0)
								return;
						...
						//小区加载
						$.post(url4Query,{"eaction":"getGridIdBySubIdInVillage","sub_id":substation},function(data){
							data = $.parseJSON(data);
							//map.addLayer(standard_layer);
					...
					function queryAndSetGrid(evt){
						...
						parent.global_position.splice(3, 1, sub_data[substation]);
						parent.global_position.splice(4, 1, undefined);
						
						global_position_build_view.splice(2,1,sub_data[substation]);
						global_position_build_view.splice(3,1,undefined);
						
						var attr = evt.graphic.attributes;
						sub_gra_clicked = sub_graphics_init[substation];
                	...
                	village_load_by_sub(attr.UNION_ORG_CODE,global_village_id);
								...
								$.post(url4Query,{"eaction":"getMapGridIdByGridUnionOrgCode","latn_id":city_id,"grid_union_org_code":attr.GRID_UNION_ORG_CODE},function(data){
										data = $.parseJSON(data);
										if(data!=null){
...
//						}
					...
					function queryBuildFunc(v_id_temp,ids_str_temp,v_position){
						...
						queryTask_standard.execute(query_standard, function (results) {
							...
							//2017-11-24修改了这里的逻辑，在标准地址展示的时候，绘制出所有使用过的楼宇
					...
					function saveVillagePosition(center,v_id){
						$.post(url4Query,{"eaction":"saveVillagePosition","v_center":center,"village_id":v_id},function(data){
...
//利用js让头部与内容对应列宽度一致。  
function fix(){  
  for(var i=0;i<=$('#buildInVillage_review_win .build_village_tab tr:last').find('td:last').index();i++){  
  $('th').eq(i).css('width',$('#buildInVillage_review_win .build_village_tab tr:last').find('td').eq(i).width());  
  }  
}  
window.load=fix();  
