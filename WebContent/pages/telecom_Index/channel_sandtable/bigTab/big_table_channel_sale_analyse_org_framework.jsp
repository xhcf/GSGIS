...
<div id="detail_div" style="display:none;overflow-y:auto;width:99%;">
...
<script>
  ...
  function initListDiv(level,city_id,bureau_id,branch_id,grid_id){
    ...
    $("#detail_div").css({"width":$("body").width()});
    console.log(level,city_id,bureau_id,branch_id,grid_id);
    if(level==1)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/bigTab/big_table_channel_sale_analyse.jsp"/>');
    else if(level==2)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/bigTab/big_table_channel_sale_analyse.jsp"/>?city_id='+city_id);
    else if(level==3)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/bigTab/big_table_channel_sale_analyse.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id);
    else if(level==4)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/bigTab/big_table_channel_sale_analyse.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id);
    else if(level==5)
      $("#list_div").load('<e:url value="/pages/telecom_Index/channel_sandtable/bigTab/big_table_channel_sale_analyse.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&grid_id="+grid_id);
  }
