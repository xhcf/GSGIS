...
<div class="lable"> <a href="javascript:void(0)" onclick="getSelected();return false;">GetSelected</a> <a href="javascript:void(0)" onclick="getSelections();return false;">GetSelections</a> <a href="javascript:void(0)" onclick="clearSelections();return false;">ClearSelections</a>[当表格要实现多选时，需要将属性singleSelect设置为false，如singleSelect="false"，默认为单选。]</div>
...
<div id="tb"> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:alert('Add');return false;">Add</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cut" plain="true" onclick="javascript:alert('Cut');return false;">Cut</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:alert('Save');return false;">Save</a> </div>
