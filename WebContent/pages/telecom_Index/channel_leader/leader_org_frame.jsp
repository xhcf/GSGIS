...
<head>
  ...
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/leader_org_frame.css?version=1.5"/>' rel="stylesheet" type="text/css" media="all" />
  <link href='<e:url value="pages/telecom_Index/common/css/layer_win.css?version=1.6" />' />
  <link href='<e:url value="/pages/telecom_Index/channel_leader/css/sp_channel.css"/>' rel="stylesheet" type="text/css" media="all" />
    <style>
    .entrance_btn_group{
      position: absolute;
      left:10px;
...
<script type="text/javascript">
  ...
  global_position_url[0] = '<e:url value="/pages/telecom_Index/channel_leader/leader_province_level.jsp" />';

  var url4Query = '<e:url value="/pages/telecom_Index/common/sql/tabData.jsp"/>';

  var change_echarts_range = "";

  var map_url_province = '<e:url value="/pages/telecom_Index/channel_leader/leader_province_level.jsp" />';
  var map_url_city = '<e:url value="/pages/telecom_Index/channel_leader/leader_city_level.jsp" />';
  var map_url_bureau = '<e:url value="/pages/telecom_Index/channel_leader/leader_bureau_level.jsp" />';
  var map_url_bureau_user = '<e:url value="/pages/telecom_Index/channel_leader/leader_bureau_user_level.jsp" />';

  var map_url_sch_ent = '<e:url value="/pages/telecom_Index/channel_leader/enterprise_bureau_level.jsp" />';
  ...
  if(user_level>=3){
    ...
    /*$.post(url4Query,{eaction:"getQXNameByBureauNo",bureau_no:'${sessionScope.UserInfo.CITY_NO}'},function(data){
      ...
      if(user_level==3){
        ...
        mapContainer_url = '<e:url value="/pages/telecom_Index/channel_leader/leader_bureau_level.jsp" />';
      }
      if(user_level==4){
  ...
  var st_broad_home = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_broad_home_market.jsp" />';
  var st_fb_cover = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_fb_cover.jsp" />';
  var st_collect = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_collect.jsp" />';
  var st_dispatch_yx = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_dispatch_yx.jsp" />';
  var st_fb_real_percent = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_fb_real_percent.jsp" />';
  var st_protection = '<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_protection.jsp" />';
  ...
  function load_list_view(index_type,flag,region_id,from_menu){
    ...
    var tab_url = '<e:url value="/pages/telecom_Index/channel_leader/bigTab/"/>';
