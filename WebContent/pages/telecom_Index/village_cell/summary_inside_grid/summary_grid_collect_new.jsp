...
<script>
  ...
  var select_count = 0;
  var url_vc = "<e:url value='/pages/telecom_Index/common/sql/tabData_village_cell_grid.jsp' />";
  ...
  $(function() {
	  $("#collect_new_sub_name").text(grid_name);
      load_select1();
      load_select2();
      load_data_list(0,1);
      load_summary();
  ...
  function load_buss_type_cnt(){
      $.post(url_vc,{"eaction":"getCollectBusSummary","village_id":village_id,"res_id":res_id,"grid_id_short":grid_id_short},function(data){
          var objs = $.parseJSON(data);
          if(objs.length){
              var d = objs[0];
  ...
  function load_select1(){
      $.post(url_vc,{"eaction":"getVillageSelectOption","grid_id_short":grid_id_short},function(data){
          var data = $.parseJSON(data);
  ...
  function load_data_list(page,flag){
      ...
      $.post(url_vc,{"eaction":"getCollectList","grid_id_short":grid_id_short,"village_id":village_id,"res_id":res_id,"collect_bselect1":collect_bselect1,"page":page},function(data){
          var objs = $.parseJSON(data);
          ...
          for(var i = 0,l = objs.length;i<l;i++){
              ...
              var row = "<tr>";
              row += "<td>"+ (++seq_num) +"</td>";
              row += "<td><a href=\"javascript:exec_agent('"+ d.VILLAGE_ID+"','"+ d.BRIGADE_ID+"','"+ d.ADDRESS_ID +"',1)\">"+ name(d.CUST_NAME) +"</a></td>";
