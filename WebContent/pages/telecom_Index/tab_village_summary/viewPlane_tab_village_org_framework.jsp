...
<body>
  ...
  <div id="list_div" style="height:99%;margin:0.3% auto;position: absolute;left: 00px;border: 2px solid #2070dc;overflow-y:auto;">
  </div>
</body>
</html>
<script>
  ...
  function initListDiv(level,city_id,bureau_id,branch_id,grid_id){
    ...
    if(level==1)
      $("#list_div").load('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_province.jsp"/>');
    else if(level==2)
      $("#list_div").load('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_city.jsp"/>?city_id='+city_id);
    else if(level==3)
      $("#list_div").load('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_grid.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id);
    else if(level==4)
      $("#list_div").load('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_grid.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id);
      //window.open('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_villageDetail.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id,"","");
    else if(level==5)
      $("#list_div").load('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_grid.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&grid_id="+grid_id);
      //window.open('<e:url value="/pages/telecom_Index/tab_village_summary/viewPlane_tab_village_villageDetail.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&grid_id="+grid_id,"","");
  }
