...
<head>
  ...
  <link href='<e:url value="/resources/css/main.css"/>' rel="stylesheet" type="text/css" />
	...
	<link href='<e:url value="/pages/telecom_Index/sandbox/css/sandbox.css?version=1.3" />'
...
<body>
	<div class="sub_box" style="height:auto;width:100%;margin:0 auto;position: absolute;display:none;">
				...
				<div class="sub_">
					...
					<div class="sub_b" style="border:0px;width:97.5%;margin:15px auto;">
						<!--<div class="t_body" id="scroll_target"> download 城市支局小区信息统计_市级概况-->
							<c:datagrid
									url="pages/telecom_Index/common/sql/viewPlane_tab_village_action.jsp?eaction=grid&city_id=${param.city_id}&bureau_id=${param.bureau_id}&branch_id=${param.branch_id}&grid_id=${param.grid_id}"
