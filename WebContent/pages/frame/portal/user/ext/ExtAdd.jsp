...
<form action="" method="post" id="extAddForm" >
	...
	<colgroup>
		...
		<tr>
			<th>属性编码：</th>
			<td><input type="text" id="ext_code" name="ext_code" class="easyui-validatebox" required validType="test['属性编码']" style="width:190px;"></td>
		</tr>
		<tr>
			<th>属性名称：</th>
			<td><input type="text" id="ext_name" name="ext_name" class="easyui-validatebox" required style="width:190px;"></td>
		</tr>
		<tr>
			<th>属性描述：</th>
			<td>
				<input type="text" id="ext_desc" name="ext_desc" class="easyui-validatebox" style="width:190px;">
			</td>
		</tr>
		<tr>
			<th>属性值类型：</th>
