...
<script type="text/javascript">
  ...
  var indexContainer_url = '<e:url value="/pages/telecom_Index/common/jsp/indexTabs_dev_enterprise.jsp" />';
  ...
  global_position_url[0] = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_province_level.jsp" />';

  var url4Query = '<e:url value="/pages/telecom_Index/common/sql/tabData.jsp"/>';

  var change_echarts_range = "";

  var map_url_province = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_province_level.jsp" />';
  var map_url_city = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_city_level.jsp" />';
  var map_url_bureau = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_bureau_level.jsp" />';
  var map_url_bureau_user = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_bureau_user_level.jsp" />';

  var map_url_sch_ent = '<e:url value="/pages/telecom_Index/enterprise_leader/enterprise_bureau_level.jsp" />';
  ...
  if(user_level>=3){
    ...
    /*$.post(url4Query,{eaction:"getQXNameByBureauNo",bureau_no:'${sessionScope.UserInfo.CITY_NO}'},function(data){
      ...
      if(user_level==3){
        ...
        mapContainer_url = '<e:url value="/pages/telecom_Index/enterprise_leader/leader_bureau_level.jsp" />';
      }
      if(user_level==4){
  ...
  var st_broad_home = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_broad_home_market.jsp" />';
  var st_fb_cover = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_fb_cover.jsp" />';
  var st_collect = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_collect.jsp" />';
  var st_dispatch_yx = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_dispatch_yx.jsp" />';
  var st_fb_real_percent = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_fb_real_percent.jsp" />';
  var st_protection = '<e:url value="/pages/telecom_Index/enterprise_leader/smallTab/small_table_protection.jsp" />';
  ...
  //下钻到学校 定位到学校
  function insideToSchool(region_id,latn_id,latn_name,bureau_no,bureau_name){
    ...
    global_region_type = "school";
    global_entrance_type="school";
    global_school_id = region_id;
    $("#list_mode_view").empty();
    load_map_view();
    global_position[1] = latn_name;
    global_position[2] = bureau_name;
    //updatePosition(3);
    toGIS();
    loadSmallTab("",0,bureau_no);
  }
  ...
  function loadSmallTab(region_type,index_type,region_id){
    var url = "";
    if (index_type == 0){//校园概况
      //url = st_broad_home;
      url = indexContainer_url;
    }
  ...
  function load_list_view(index_type,flag,region_id,from_menu){
    ...
    var tab_url = '<e:url value="/pages/telecom_Index/enterprise_leader/bigTab/"/>';
  ...
  var isTriggerNewFunc = false;

  var url4Query_leader = '<e:url value="/pages/telecom_Index/common/sql/tabData_enterprise_leader.jsp" />';
