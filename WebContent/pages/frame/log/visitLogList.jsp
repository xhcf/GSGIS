...
<e:style value="/resources/themes/base/boncBase@links.css"/>
	...
	<e:if condition="${param.loginDate1!=null&&param.loginDate1!=''&&param.loginDate1!='null'}">
		...
		<c:datagrid url="/pages/frame/log/logAction.jsp?eaction=visitLog&loginId=${param.loginId }&userName=${param.userName }&area_no=${param.area_no }&menuName=${param.menuName }&loginDate=${loginDate_val}&loginDate1=${loginDate_val1}" id="visitLogListTable" pageSize="${Number_val }" download="访问日志" fit="true" border="false" toolbar="#tb">
			<thead>
				<tr>
