...
<script>
    ...
    var res = generic_kpi_index(parent.index_range_map["KPI_D_001"]);
    value_range = res[1];
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'分公司',align:'center',halign:'center',width: sub_width*0.27,
                    ...
                    {
                        field: 'USE_RATE1', title: '累计到达<br/>渗透率', align: 'center', halign: 'center', width: sub_width * 0.32,sortable:true,
                        formatter: function (value, rowData) {
                            if (value != '--') {
                    ...
                    {
                        field:'UP_MONTH',title:'本月提升',align:'center',halign:'center',width:sub_width*0.27,
                        formatter:function(value,rowData){
        ...
        $("#index_table").datagrid({
            ...
            columns:[
                [
                    ...
                    {
                        field:'AREA_DESC',title:'区县',align:'left',halign:'center',width: sub_width*0.25,
                        formatter:function(value,rowData){
                            if(value!="" && value!=null){
            ...
            onLoadSuccess:function (data) {
                ...
                var dataRows = data.rows;
                //六个级别的指标
                var level_num = count_under_range(dataRows,value_range);
                try{
                    parent.refresh_range_cnt(level_num);
                }catch(e){
                }
