...
<head>
  ...
  <script>
    ...
    $(function(){
      //支局名赋值
      $("#market_sub_name").text(grid_name);
      //标签页切换事件
        ...
        $(this).on("click", function () {
          ...
          if(index==0){
            load_summary();
        	  ...
        	  load_village_list("build_village");
        	  load_build();
          }else if(index==3){
        	  load_village_list("resident_village");
        	  load_resident();
          }
        });
      });
    ...
    function load_village_list(appendId) {
        var $doc = $("#" + appendId);
        $doc.empty();
        var params = {
    ...
    function buildListScroll(params, flag) {
      ...
      $.post(url,params, function (data) {
        ...
        for (var i = 0, l = data.length; i < l; i++) {
            ...
            "</td><td style='width:50px'>" + d.ZHU_HU_SUM + "</td><td style='width:70px'>" + d.GZ_KD_CNT +"</td><td style='width:70px' class='head_table_color'>" + d.PORT_PERCENT +
...
<div class="tab_head" id="market_tab_head">
  <span>统计</span>  <span>小区</span> <span>楼宇</span> <span>住户</span>
</div>
      ...
      <div id="summary_left">
        ...
        <div class="summary_left_cont">
          ...
          <ul>
            ...
            <li class="p_date">资源未达楼宇数：<span id="unreach_buliding_num"></span></li>
          </ul>
        </div>
      </div>
  ...
  <div class="div_hide div_3">
    ...
    <div class="resident_wrapper" >
      <div id="resident">
        ...
        <span style="font-weight: bold;">楼宇: </span><input type="text" id="resident_build" style="width: 230px;">
