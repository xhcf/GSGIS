...
<e:q4o var="monthObj">
 select t.* from easy_data.sys_const_table t where const_type='var.dss29' and  const_name='calendar.curdate'
</e:q4o>
...
<head>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/bureau_geo_center.js?version=1.0"/>'
            charset="utf-8"></script>
...
<div class="village_info_win new_beta leader" id="village_info_win" style="display: none;width:90%;height:84%;"><!-- width:880px -->

		<input type="hidden" id="village_view_v_id"/>
    <input type="hidden" id="village_view_sub_id"/>
    <input type="hidden" id="village_view_grid_id"/>

    <div class="village_title village_desk" id="village_drag_handler"><span>渠道画像</span>
...
/* $(function(){
	$("#village_info_win_body").attr("src",'<e:url value="/pages/telecom_Index/channel_leader/store_draw_detail.jsp" />?village_id=555');
...
$(function () {
		...
		parent.reposMapPosition();
			...
			var region_type_num = 1;//20181206 默认右侧加载小区
...
//						skin: 'demo-class',
                ...
                var channel_ico_selected = '<e:url value="/pages/telecom_Index/channel_leader/images/channel_ioc_selected.png" />';
               ...
               /*  $(".remove_item_yx_new").unbind();
                ...
                var url4query1 = '<e:url value="/pages/telecom_Index/channel_leader/channel_action/mapPointDataAction.jsp"/>';
                $.post(url4query1,{eaction:"getBureauNoByBurName",bureau_name: bureau_name}, function (data) {
                	...
                	var bureau_to_bearue_url ='<e:url value="/pages/telecom_Index/channel_leader/smallTab/small_table_broad_home_market.jsp" />';
                	parent.bureau_no = bureau_no;
                	parent.rank_region_type = '3';
                ...
                md_service_load = function(){
                		...
                		if (featureLayer_qx_md == ""){
                			...
                			qx_md_layer_mouseover = dojo.connect(featureLayer_qx_md, "onMouseOver", function (evt) {
    	                		var evtHtml = "";
                					$.post("<e:url value='pages/telecom_Index/channel_leader/channel_action/channel_portraitAction.jsp?eaction=getBaseInfo'/>",
                    ...
                    if (featureLayer_qx_md2 == ""){
                    	...
                    	qx_md_layer_mouseover2 = dojo.connect(featureLayer_qx_md2, "onMouseOver", function (evt) {
	                		var evtHtml = "";
                    		v$.post("<e:url value='pages/telecom_Index/channel_leader/channel_action/channel_portraitAction.jsp?eaction=getBaseInfo'/>",
                					{month:acct_month,channel_nbr:evt.graphic.attributes.CHANNEL_NBR},
                    				function(result){
    	                				var json= $.parseJSON(result);
    	                				if(json !=''&&json != null){
...
//					}
                ...
                function storeDraw(channel_nb){
                	//alert(channel_nb);
                	$("#village_info_win_body").attr("src",'<e:url value="/pages/telecom_Index/channel_leader/store_draw_detail.jsp" />?channel_nbr='+channel_nb);
            		var cent_pos = getCenter("#village_info_win");
            	    $("#village_info_win").css({"left":cent_pos[0],"top":cent_pos[1]});
            	    $("#village_info_win").show();
                }
