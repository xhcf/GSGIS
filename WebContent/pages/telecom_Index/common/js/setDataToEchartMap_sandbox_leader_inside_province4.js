...
function setDataToEchartMap4(params,url4realTimeSubList,url4mapToWhere){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(d.length==0)
                ...
                for (var i = 0; i < d.length; i++) {
                    ...
                    datas.push(obj);
                    datas2[org_name_temp] = [d[i].USE_RATE,d[i].EXEC_CNT,d[i].SUCC_LV,d[i].SUCC_CNT,d[i].ORDER_CNT];
        ...
        complete:function(){
            echartMapReset4(min,max,params,series_name,color,datas,datas2);
            chart_map.hideLoading();
        }
    });
}
//地市 区域块
function echartMapReset4(min_num,max_num,params,series_name,color,data,data2){
