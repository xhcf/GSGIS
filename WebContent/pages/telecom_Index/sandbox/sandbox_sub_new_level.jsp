...
<div id="sub_summary_div">
    ...
    <div>
        <ul class="sub_summary_total_nums">
            ...
            <!--<li><span onclick="javascript:test_interface()">接口测试</span></li>
            <li><span onclick="javascript:test_webservice()">webservice测试</span></li>-->
        </ul>
    </div>
...
<script type="text/javascript">
    ...
    var url4Query_sandSummary = '<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary.jsp" />';
   ...
   /*  小区新建修改部分  start*/
    ...
    if(window.innerHeight<800){
      ...
      function openMarketWin(tab_index,condition){
        closeOtherLayerWin();
            $("#sub_market_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_market.jsp' />?tab_index="+tab_index+"&condition="+condition+"&city_id="+city_id+"&substation="+substation);
      ...
      function openResourceWin(tab_index,condition){
      	if(tab_index==undefined)
      		tab_index = 0;
        	closeOtherLayerWin();
          $("#sub_resource_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_resource.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition);
      ...
      function openYXWin(tab_index,tab_index2){
        closeOtherLayerWin();
            $("#sub_yx_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_yx.jsp' />?tab_index="+tab_index+"&tab_index2="+tab_index2 + "&substation=" + substation);
      ...
      function openCollectWin(tab_index,condition){
        closeOtherLayerWin();
        $("#sub_collect_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_collect.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition);
      ...
      function openNewCollectWin(){
            closeOtherLayerWin();
            $("#sub_collect_new_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_collect_new.jsp' />?substation=" + substation);
            sub_collect_div_handle = layer.open({
                title: '竞争收集',
                type: 1,
                shade: 0,
    ...
    function openStockWin(tab_index,condition){
        closeOtherLayerWin();
        $("#sub_stock_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside/summary_stock.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition);
    ...
    function showSummaryWindow(){
        ...
        $.post(url4Query_sandSummary,{"eaction":"get_four_vill_type","substation":substation},function(data){
        ...
        //月营销 20190214
        $.post(url4Query_sandSummary,{eaction:"get_yx_month",substation:substation},function(data){
        		var data = $.parseJSON(data);
        		if(data!=null){
        ...
        //四级地址
        $.post(url4Query_sandSummary,{eaction:"get_add4_data",substation:substation},function(data){
            var data = $.parseJSON(data);
            if(data != null){
    ...
    function usedBuildList(){
    	$.post('<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary.jsp" />',{"eaction":"getusedBuildList","latn_id":city_id,"union_org_code":substation,"page":usedBuildPage},function(data){
    		var list = $.parseJSON(data);
    		if(list.length){
	    		for(var i = 0,l = list.length;i<l;i++){
	    			var d = list[i];
...
//                                      offset: ['1px', '38px'],
                    ...
                    function villageListScroll_none_grid(latlatn_id, bureau_no, union_org_code, village_name, branch_type, page) {
                        var village_list_p = $("#village_table");
