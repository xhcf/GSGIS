...
function echartMapReset(min_num,max_num,params,color,data,data2){
    ...
    var option = {
        ...
        /*dataRange: {//颜色的变化设置
            ...
            icon:'circle',
            splitList: [
                {start: 60,label:'强壮1（80-100):3'},
                {start: 40, end: 60, label:'强壮（80-100):3'},
                {start: 30, end: 40,label:'健康（30-80):5'},
                {start: 10, end: 30, label:'亚健康（10-30):5'},
                {end: 10,label:'不健康（0-10):8'}
            ],
            //            calculable : true,//颜色呈条状
            //            text:['高','低'],// 文本，默认为数值文本
            color: ['#42c877', '#8ae9b0', '#ff9c2b','#fcb666','#f04144']
        }*/
        /*legend: {
            orient: 'vertical',
            left: 'left',
