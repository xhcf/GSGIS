...
<html>
    <head>
        ...
        <style>
            ...
            .tab_header tr th:nth-child(4) {width:18%!important;}
            ...
            #collect_new_bulid_info_list_sj tr td:nth-child(3) {width:10%!important;}
            #collect_new_bulid_info_list_sj tr td:nth-child(4) {width:18%!important;}
            #collect_new_bulid_info_list_sj tr td:nth-child(5) {width:15%!important;}
            #collect_new_bulid_info_list_sj tr td:nth-child(6) {width:10%!important;}
            #collect_new_bulid_info_list_sj tr td:nth-child(7) {width:15%!important;}
                ...
                <tr>
                    <td>
                        <div class="count_num desk_orange_bar inside_data inside_data_orange">
                            ...
                            电信：<span id="sjqd_dx" style="color:#FF0000">0</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      if (build_id != "-1") {
          ...
          $.post(url_build, params, function(data) {
              ...
              for (var i = 0, l = data.length; i < l; i++) {
                  ...
                  if(d.SERIAL_NO==2)//政企
                    newRow += "<span class='zhengqi_flag'>政</span><a href='javascript:void(0);' onclick='parent.openNewWinInfoCollectEdit(\"" + d.SEGM_ID_2 + "\")'>" + d.SEGM_NAME_2 + "</a></td>";
                  else if(d.SERIAL_NO==1 || d.SERIAL_NO==4)//普通住户
                    newRow += "<a href='javascript:void(0);' onclick='parent.openNewWinInfoCollectEdit(\"" + d.SEGM_ID_2 + "\")'>" + d.SEGM_NAME_2 + "</a></td>";
