...
<script>
  ...
  function initListDiv(level,city_id,bureau_id,branch_id,grid_id){
    ...
    console.log(level,city_id,bureau_id,branch_id,grid_id);
    if(level==1)
      $("#list_div").load('<e:url value="/pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp"/>?village_type='+village_type+"&beginDate="+beginDate+"&from_menu="+from_menu);
    else if(level==2)
      $("#list_div").load('<e:url value="/pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp"/>?city_id='+city_id+"&village_type="+village_type+"&beginDate="+beginDate+"&from_menu="+from_menu);
    else if(level==3)
      $("#list_div").load('<e:url value="/pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&village_type="+village_type+"&beginDate="+beginDate+"&from_menu="+from_menu);
    else if(level==4)
      $("#list_div").load('<e:url value="/pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&village_type="+village_type+"&beginDate="+beginDate+"&from_menu="+from_menu);
    else if(level==5)
      $("#list_div").load('<e:url value="/pages/telecom_Index/data_four_type_region_detail/four_type_region_detail.jsp"/>?city_id='+city_id+"&bureau_id="+bureau_id+"&branch_id="+branch_id+"&grid_id="+grid_id+"&village_type="+village_type+"&beginDate="+beginDate+"&from_menu="+from_menu);
  }
