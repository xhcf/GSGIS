	...
	<head>
		...
		<script type="text/javascript">
			...
			function formatterCZ2(value,rowData){
				var content="--";
				if(rowData.INFLUENCE_TYPE!='1')
					content='<a class="easyui-linkbutton" title="添加" href="javascript:void(0);" onclick="addSubSystem(\''+rowData.SUBSYSTEM_ID+'\');"><i class="fa fa-plus-square-o" aria-hidden="true"></i></a>';
				return content;
			}
	...
	<body>
		...
		<div id="tb1">
			<form id="loginLogForm" method="post" name="loginLogForm" action="">
				...
				<div class="search-area">
					ID：<input id="subSystemIdForHasSelect"  type="text" name="subSystemIdForHasSelect" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 50px">
		...
		<div id="tb2">
			<form id="loginLogForm" method="post" name="loginLogForm" action="">
				<h2>未选择的子系统</h2>
				<div class="search-area">
					ID：<input id="subSystemIdForNeedSelect"  type="text" name="subSystemIdForNeedSelect" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 50px">
