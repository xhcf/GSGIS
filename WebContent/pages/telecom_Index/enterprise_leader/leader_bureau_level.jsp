        ...
        <div>
            <div class="target_a" style="border-bottom:none;">
                ...
                <div class="base1" style="height:65px;">
                	<div class="message_cont"><!-- 学校名称下拉框 -->
	                		<div>学校名称：
                            ...
                            for (var i = 0, l = data.length; i < l; i++) {
                                ...
                                if (i == 0) {
                                    ...
                                    if(d.BUREAU_NAME!=null){
                                    	parent.global_position[2] = d.BUREAU_NAME;
                                    	parent.updatePosition(3);
                                    }else{
                          ...
                          function () {
                          		...
                          		$.post(url4Query_enterprise,{"eaction":"getNewSchoolList","city_id":city_id},function(data){
                          				...
                          				for(var i = 0,l = d.length;i<l;i++){
                          					var item = d[i];
                          					$("#village_name").append("<option value='"+ item.BUSINESS_ID +"' data='"+ item.BUREAU_NO +"' data1='"+ item.ATTR_EXT2 +"' data2='" +item.BUSINESS_TYPE+ "' data3='"+ item.BUREAU_NAME +"'>"+ item.BUSINESS_NAME +"</option>");
...
//							skin: 'demo-class',
                            ...
                            if(nav_type_index=="village"){
                            	...
                            	for (var i = 0, l = data.length; i < l; i++) {
	                                ...
	                                if(nav_type_index=="school"){
	                                	...
	                                	vill_edit_bureau_val= d.BUREAU_NO;
	                                	$("#village_in_bureau").attr("disabled","disabled");
                    ...
                    map.on("extent-change", function (evt) {
                        ...
                        if(parent.isTriggerNewFunc){
	                      	$("#nav_func_xinjian1").click();
	                      	parent.isTriggerNewFunc = false;
                    		}
                    });
