...
<div class="cus_view_wrapper">
    <div class="cus_view_header">
        <div class="cus_view_header_tag"></div><div class="text">学生视图</div>
...
<script type="text/javascript">
        ...
        $div_li.each(function(index){
            $(this).on("click",function(){
                if(index==0){
                    ...
                    $("#home_view_tab_content").load("<e:url value='/pages/telecom_Index/enterprise_leader/jsp/viewPlane_custom_view.jsp'/>?segment_id="+"${param.segment_id}"+"&prod_inst_id="+"${param.prod_inst_id}"+"&is_lost="+is_lost+"&is_yx="+is_yx+"&lost_type="+'${param.lost_type}');
                }else if(index==1){
                    $("#home_view_tab_content").empty();
    ...
    function load_info() {
        if('${param.prod_inst_id}'!='undefined')
            $.post(url4sql,{"eaction":"getBaseInfo","addr4":'${param.segment_id}','prod_inst_id':'${param.prod_inst_id}','is_lost':is_lost,'is_yx':is_yx},function(data){
        ...
        if('${resident_info}'=='' && is_zhuanpai!="1"){
