...
<div id="buildInVillage_review_win" class="village_info_win" style="position:absolute;z-index:999;display:none;">
    ...
    <div class="tab_box">
        <div>
            <div class="target_a" style="border-bottom:none;">
                <div class="base1" style="height:50px;">
                    校园名称：<input id="village_name" type="text"/>
                    <div class="message_cont">
                        <div>地市：<span id="village_in_city"></span>分局：<select id="village_in_bureau"></select></div>
                        <div></div>
                    </div>
                    <div class="message_cont">
                    		<div></div>
                ...
                <div class="base1" style="height:55px;">
                    <div class="message_cont">
                        <div>
                            <span style="margin-right:0px;">类型：</span>
                            <select id="village_scale">
                            </select>
                            
                            <span style="margin-right:0px;margin-left:10px;">区域：</span>
                    				<select id="village_area_type">
                            </select>
                        </div>
                    </div>
                    <div class="message_cont">
...
<script type="text/javascript">
    ...
    var village_area_type_options = "<option value=\"1\" selected>教学区</option><option value=\"2\">宿舍区</option><option value=\"3\">生活区</option>";
															...
															if(data.length){
																for(var i = 1,l = data.length;i<l;i++){
																	...
																	try{
																		...
																		var part_graphic = new esri.Graphic(new Point(parseFloat(point_array[0]), parseFloat(point_array[1]), new SpatialReference({wkid: 4326})), school_img);//{"school_id": s_id,"school_name":d1.BUSINESS_NAME}
										...
										$("#nav_func_back").click(
											function(){
												...
												if(parent.global_fromProvince==1)
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/sandbox_leader/leader_province_level.jsp" />');
												else
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/sandbox_leader/leader_city_level.jsp" />');
											}
										);
										//左侧指标按钮切换
...
//							skin: 'demo-class',
                    ...
                    var buildInVillage_res_head_html2 = "<th style=\"width: 40px\">操作</th></tr>";
                    ...
                    dojo.query("#draw_polygon_village_review").onclick(function (evt) {
                    		...
                    		if(nav_type_index=="school"){
                    			$("#buildInvillage_res_head").append(buildInvillage_res_head_html1+"<th style=\"width:60px\">学校区域</th>"+buildInVillage_res_head_html2);
                    		}else{
                            ...
                            $.post(url4Query, {
                                ...
                                for (var i = 0, l = data.length; i < l; i++) {
                                    ...
                                    "<td style='width: 60px;'>" + d.OBD_CNT + "</td>";
                                    	...
                                    	item_str += "<td style='width:60px;'>"+school_area_type_select+"</td>";
                                    }else{
                    ...
                    saveBuildInVillage = function (event) {
                        ...
                        for (var i = 0, l = ids.length; i < l; i++) {
                            ...
                            if(nav_type_index=="school")
                            	build_area_type_str += (id+"_"+$(".village_area_type").eq(i).val() + ",");
                        }
                    ...
                    var school_part_ico = '<e:url value="/pages/telecom_Index/common/images/enterprise/village_red.png" />';
