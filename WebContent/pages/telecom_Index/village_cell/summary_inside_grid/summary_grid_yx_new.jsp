		...
		<div id="content1">
			<div class="div_show div_0_0" >
				...
				<div class="summary_day_data" id ="khtj_wgy" style ="display:none">
					<div class="summary_day_head summary_day_head_other">
						...
						<input id="selectMonth_yx" type="text" value="${ACCT_MONTH}" style="width:150px;float:right;" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy年MM月',onpicked:function(){showGridSummary()}})" class="Wdate" />
					</div>
			...
			<div class="div_hide div_0_1">
                ...
                <span style="padding-left:10px;">
                	...
                	<span>查询:&nbsp;&nbsp;</span><input style="background-color: #fff;" placeholder="请输入用户名或号码" type="text" name="intraday_yx_query_text" /><input class="btn blue_btn" type="button" value="查询" onclick="javascript:intra_change()" />
                </span>
