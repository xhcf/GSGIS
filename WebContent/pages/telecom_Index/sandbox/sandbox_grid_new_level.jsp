...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_area_dev_colorflow.css?version=1.5"/>'
          rel="stylesheet" type="text/css" media="all"/>
...
<style>
    ...
    /*客户视图 2018*/
	  ...
	  #unused_build_list_scroll {overflow-y:scroll;height:83%;background:#fff;}
	  #used_build_list_scroll {overflow-y:scroll;height:83%;background:#fff;}

	  .unused_build_div .layui-layer-content{height:88%!important;}
            ...
            <div class="target_a" style="border-bottom:none;">
                ...
                <div class="base1">
                    <div class="message_cont">
                        ...
                        <div>宽带家庭渗透率： <span id="broad_home_percent" style="width:10;">--</span></div>
                    </div>
                </div>
                ...
                <div class="base1">
                    <div class="message_cont">
                        ...
                        <div>
                            ...
                            <select id="xqrzl" style="width:120px;">
                            	<option value="1">80%以上</option>
                        ...
                        <div>
                        		开盘时间：
                        		<input id="selectMonth" type="text" style="color:#ffffff; width:100px;height:28px;line-height:28px;"/>
                        </div>
                        <!--<div></div>-->
                    </div>
                    进线运营商：
...
<!-- 竞争收集 收集编辑 新 暂不用 -->
<div class="info_collect_win" id="info_collect_edit_new_div" style="display:none;">
    <!--<div class="titlea">
        <div id="info_collect_edit_draggable" style='text-align:left;width:90%;display: inline-block'>竞争收集</div>
        <div class="titlec" id="info_collect_edit_div_close"></div>
    </div>-->
...
<div id="sub_summary_div">
    <div class="sub_summary_div_name">
        <span id="sub_summary_div_name" class="wgtb"></span>
    </div>
    <div>
    ...
    <div class="sub_summary_tabs">
        <div>
            ...
            <div class="sub_summary_index_content">
                ...
                <ul>
                    <li>家庭住户：<span class="summary_index_clickable" onclick="javascript:summaryToTab('market',3)" id="summary_zhu_hu"></span></li>
        ...
        <div>
            ...
            <div class="sub_summary_index_content">
                ...
                <ul>
                    <li>OBD数：<span id="summary_obd_num" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',2,'')"></span></li>
                    <li>0-1OBD：<span id="summary_obd_zero" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',2,'1')"></span></li>
                    <li>高占用OBD：<span id="summary_obd_full" class="summary_index_clickable" onclick="javascript:summaryToTab('resource',2,'3')"></span></li>
                </ul>
                <!--<ul>
                	<li>资源未达楼宇数：<span id="summary_build_num_unreach" class="summary_index_clickable" onclick=""></span></li>
                </ul>-->
        ...
        <div>
            ...
            <div class="sub_summary_index_content">
            	...
            	<ul>
            			<li>已归小区：<span id="summary_build_num_in_map" class="summary_index_clickable"></span></li>
            			<li>未归小区：<span id="summary_build_num_no_in_map" class="summary_index_clickable"></span></li>
            	</ul>
            	<!--
...
<script type="text/javascript">
    ...
    var village_where = "LATN_ID = " + city_id + " and GRID_UNION_ORG_CODE = '"+grid_id+"'";
    ...
    if(window.innerHeight<800){
      ...
      function openMarketWin(tab_index,condition){
        closeOtherLayerWin();
            $("#sub_market_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_market.jsp' />?tab_index="+tab_index+"&condition="+condition+"&city_id="+city_id+"&substation="+substation+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openResourceWin(tab_index,condition){
      	if(tab_index==undefined)
      		tab_index = 0;
        closeOtherLayerWin();
            $("#sub_resource_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_resource.jsp' />?tab_index="+tab_index+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short+"&condition="+condition);
      ...
      function openYXWin(tab_index,tab_index2){
        closeOtherLayerWin();
            $("#sub_yx_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_yx.jsp' />?tab_index="+tab_index+"&tab_index2="+tab_index2+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openCollectWin(tab_index,condition){
        closeOtherLayerWin();
            $("#sub_collect_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_collect.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function openNewCollectWin(){
            closeOtherLayerWin();
            $("#sub_collect_new_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_collect_new.jsp' />?substation=" + substation+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
            sub_collect_div_handle = layer.open({
                title: '竞争收集',
                type: 1,
                shade: 0,
      ...
      function openStockWin(tab_index,condition){
          closeOtherLayerWin();
          $("#sub_stock_div").load("<e:url value='/pages/telecom_Index/sandbox/summary_inside_grid/summary_stock.jsp' />?tab_index="+tab_index + "&substation=" + substation+"&condition="+condition+"&grid_id="+grid_id+"&grid_id_short="+grid_id_short);
      ...
      function showSummaryWindow(){
          //支局名称
          $("#sub_summary_div_name").text(grid_name);
          var params = {
              "eaction": 'get_info_all',
              "grid_union_org_code":grid_id,
          ...
          //移动用户
	        $.post(url4Query_sandSummary,{"eaction":"get_info_all2","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
	        		data = $.parseJSON(data);
	        		if(data!=null){
					...
					$.post(url4Query_sandSummary,{"eaction":"get_four_vill_type","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
          ...
          //营销
          //精准总数
          /*$.post(url4Query_sandSummary,{"eaction":"get_jz_count","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
              data = $.parseJSON(data);
              if(data!=null){
	        ...
	        //月营销 20190214
	        /*$.post(url4Query_sandSummary,{eaction:"get_yx_month","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
	        		var data = $.parseJSON(data);
	        		if(data!=null){
	        			$("#summary_jz_month").text(data.CNT);//营销 月数据
	        		}
	        });*/
          //异网总数
          $.post(url4Query_sandSummary,{"eaction":"get_yw_count","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
              data = $.parseJSON(data);
              if(data!=null){
          ...
          //日执行率、月执行率
          /*$.post(url4Query_sandSummary,{"eaction":"get_jz_rate","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
              data = $.parseJSON(data);
              if(data!=null){
          ...
          //支局营销类数据
	        $.post(url4Query_sandSummary,{"eaction":"get_yx_data","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
	        	var data = $.parseJSON(data);
	        ...
	        //运营商 20190214
	        $.post(url4Query_sandSummary,{eaction:"get_buss_cnt","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
	            var data = $.parseJSON(data);
	            if(data != null){
          ...
          $.post(url4Query_sandSummary,{"eaction":"get_yw_rate","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
              data = $.parseJSON(data);
              if(data != null){
            	  //暂无数据写死
	        ...
	        //四级地址
	        $.post(url4Query_sandSummary,{eaction:"get_add4_data","grid_union_org_code":grid_id,"grid_id_short":grid_id_short},function(data){
	            var data = $.parseJSON(data);
	            if(data != null){
    ...
    function unusedBuildList(){
    	$.post('<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary.jsp" />',{"eaction":"getUnusedBuildList","latn_id":city_id,"grid_id":grid_id,"page":unusedBuildPage},function(data){
    ...
    function usedBuildList(){
    	$.post('<e:url value="/pages/telecom_Index/common/sql/tabData_sandbox_summary.jsp" />',{"eaction":"getusedBuildList","latn_id":city_id,"grid_id":grid_id,"page":usedBuildPage},function(data){
    		var list = $.parseJSON(data);
    		if(list.length){
	    		for(var i = 0,l = list.length;i<l;i++){
	    			var d = list[i];
...
//                                      offset: ['1px', '38px'],
                    ...
                    operateVillage = function (village_id, st, addr, thiz) {
                        ...
                        $.post(url4Query, {"eaction": "getBuildIds", "village_id": village_id}, function (data) {
                            data = $.parseJSON(data);
                          if (data != null) {
                              var v_id_temp = "";
                              var v_center = "";
                              ...
                              var queryTask_standard = new QueryTask(standard_address);
                                    ...
                                    queryTask_standard.execute(query_standard, function (results) {
                                        ...
                                        for (var i = 0, l = results.features.length; i < l; i++) {
                                            ...
                                            gra_array.push(new Graphic(feature.geometry));
                                        }
                                        ...
                                        //计算一次新的中心点
																				...
																				var point_str = v_center;//旧的小区中心点
																				var new_center_point = "";//新的小区中心点位置
                    ...
                    function queryVillage(latn_id, page) {
                        ...
                        var eaction_str = "village_list_grid_user";
...
//                                map.centerAndZoom(point,zoom);
                ...
                standard_load();
                    ...
                    openVillageNewPopWin = function(substation){
...
//                          skin: 'demo-class',
                    ...
                    dojo.query("#draw_polygon_village_review").onclick(function (evt) {
                        ...
                        if (ids == null || ids == undefined || ids.length == 0) {
                            ...
                            datebox_month("selectMonth",village_kaipan_time);
                            ...
                            $.post(url4Query, {
                                ...
                                for (var i = 0, l = data.length; i < l; i++) {
                                    ...
                                    if (d.SEGM_ID == 0) {
                                		...
                                		if(bhp!='undentified'||bhp!=undentified){
                                		$("#broad_home_percent").html(bhp+"%");
                                		}else{
                                		$("#broad_home_percent").html('--');
                                		}
                                    ...
                                    "<td style='width: 60px;'>" + d.OBD_CNT + "</td>" +
                                    "<td style='width: 60px;'>" + (d.YX_UN == null ? '--' : d.YX_UN) + "</td>";
                                    item_str += "<td style='width: 40px;'>";
                                    if (buildInVillage[d.SEGM_ID] == undefined)
                                        item_str += "";
                                    else
                                        item_str += "<a href=\"javascript:void(0);\" onclick=\"javascript:removeItemFromBuildInVillage(this,'" + d.SEGM_ID + "')\"></a>";
                    ...
                    saveBuildInVillage = function (event) {
                        ...
                        //小区入住率
                       var xqrzl=$("#xqrzl option:selected").val();
                        //小区消费能力
                        ...
                        var kaipan_time = $("#selectMonth").datebox("getValue");
                        ...
                        $.post(postUrl, {eaction:"Village_edit",village_id: v_id}, function (data) {
                            ...
                            for (var i = 0, l = data.length; i < l; i++) {
                                ...
                                if (i == 0) {
												            ...
												            village_kaipan_time = data[0].VILLAGE_LABEL;
												            datebox_month("selectMonth",village_kaipan_time);
                    ...
                    function addBuildToVillagePolygen(geo,where){
                        ...
                        queryTask_standard.execute(query_standard, function (results) {
                            ...
                            for (var i = 0, l = results.features.length; i < l; i++) {
                                ...
                                if (feature.attributes.GRID_ID != grid_id_short) {
                    ...
                    queryTask1.execute(query1, function (results) {
                        ...
                        for (var i = 0, k = 0; i < l; i++, k++) {
                            ...
                            grid_graphic_center_point = name_point;
                        ...
                        //map.addLayer(village_layer);
                        //map.addLayer(village_position_layer);
                        parent.global_add4_position_flag = 2;
                    });
                    ...
                    clickToGrid = function (substation, sub_name, thiz, zoom, grid_name, station_id) {
                            ///loadLbFloatWin_sub(substation);
                        subToGridFlag = false;
                        //grid_graphic_center_point
                        map.centerAndZoom(grid_graphic_center_point,zoom);
                        grid_gra_last = "";
                        var graphics = graLayer_wg.graphics[0];
                        grid_gra_clicked = graphics;
                        beforeClickColor_grid = graphics._shape.fillStyle;
                        //var zoom = map.getZoom();
                        currentOpacity = beforeClickColor_grid.a;
                        highlightSymbol_grid_click.color.a = 0;
                        graphics.setSymbol(highlightSymbol_grid_click);
...
//                      }
                    ...
                    function village_load(where, village_id_selected_temp) {
                        ...
                        $.post(url4Query, {eaction: "getVillages", grid_id: where}, function (data1) {
                            ...
                            if(parent.global_village_position_vid != "" && parent.global_entrance_type == "village"){
			                    		parent.load_map_view();
			                    		closeOtherLayerWin();
			                    		searchVillage(parent.global_village_position_vid);
			                    		operateVillage(parent.global_village_position_vid);
			                    		parent.global_village_position_vid = "";
		                    		}
                        });
                    }
