...
<head>
    ...
    <script src='<e:url value="/pages/telecom_Index/common/js/bureau_geo_center.js?version=1.4"/>'
	  ...
	  <link href='<e:url value="/pages/telecom_Index/channel_sandtable/css/leader_org_frame.css?version=1.2"/>' rel="stylesheet" type="text/css" media="all" />
</head>
										...
										$("#nav_func_back").click(
											function(){
												...
												if(parent.global_fromProvince==1)
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/channel_sandtable/leader_province_level.jsp" />');
												else
													parent.backToPosition(1,'<e:url value="pages/telecom_Index/channel_sandtable/leader_city_level.jsp" />');
											}
										);
										//左侧指标按钮切换
