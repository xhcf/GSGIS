...
<head>
    ...
    <link href='<e:url value="/pages/telecom_Index/common/css/room_zq_flag.css?version=1.5"/>' rel="stylesheet" type="text/css"
          media="all"/>
    <link href='<e:url value="/pages/telecom_Index/sub_grid/css/viewPlane_she_dui_page_view.css?version=1.6"/>' rel="stylesheet" type="text/css"
          media="all"/>
	<!-- 加载竞争收集js -->
	<style type="text/css">
        @media screen and (max-height:500px) {
            .village_new_base .deve_ta {margin-left: 0px;height:62px;margin-bottom:3px;margin-top:2px;padding-top:24px;}
            .village_new_base .deve_tb {height:62px;margin-bottom:3px;margin-top:2px;width:84%;padding-top:0;}
            .village_new_base .deve_tb:first-child {padding-top:10px!important;background: #f00;}
        }
	</style>
</head>
<body>
...
<div class="village_name_new"><span id="village_view_title" class="cate"> </span></div>
    <%--<h3 class="wrap_a tab_menu" style="border-left:none;padding-left:15px;display:none;">
	...
	<span style="cursor:pointer;display:none;">异常用户</span></h3>--%>
    <div class="product_type village_new_searchbar build_bar">
      ...
      <input type="checkbox" name="product_type" id="bussiness_qt" value="0" /><label for="bussiness_qt">未装</label>
      --%>
      ...
      <div style="width:100%;">
          <span style="margin-left:0px;">社队：</span>
          <select id="fouraddress" name="fouraddress" style="width:90%"></select>
      </div>
    </div>
    ...
    <div class="detail_block tab_box building_list_tab cell_layout" style="margin-top:8px;">
        ...
        <div style="width:100%;padding: 0px;margin:0px;overflow:hidden;">
            <div class="devep village_new_base shedui">
                <div class="deve_ta">
                        行政架构
                </div>
                <div class="deve_tb">
                    <table border="0" width="100%">
                        <tr>
                            <td width="28%"><div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;">分公司：<span id="build_view_city"></span></span></div></td>
                            <td width="26%"><div class="quota"><span style="margin-left: 5px;">县&nbsp;&nbsp;&nbsp;局：<span id="build_view_bureau"></span></span></div></td>
                            <td><div class="quota"><span style="margin-left: 5px;">乡&nbsp;&nbsp;&nbsp;镇：<span id="build_view_town"></span></span></div></td>
                        </tr>
                        <tr>
                            <td width="28%">
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px">行政村：<span id="build_view_village_cell_name"></span></span></div>
                            </td>
                            <td width="28%">
                                <div class="quota"><span style="margin-left: 5px">社队名：<span id="build_view_she_dui_name"></span></span></div>
                            </td>
                            <td>
                                <div class="quota"><span style="margin-left: 5px">社队别名：<span id="build_view_she_dui_name2"></span></span></div>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="deve_tb">
                    <table border="0" width="100%">
                        <tr>
                            <td width="28%"><!-- 30 -->
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;">渗透率：<span id="build_view_market_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div>
                            </td>
                            <td width="26%">
                                <div class="quota"><span style="margin-left: 5px">宽带数：<span id="build_view_kd_cnt"></span></span></div>
                            </td>
                            <td>
                                <div class="quota"><span style="margin-left: 10px">住户数：<span id="build_view_zhu_hu_cnt"></span></span></div>
                            </td>
                            <!--<td width="25%">
                ...
                <div class="deve_tb">
                    <table border="0" width="100%">
                        <tr>
                            <td width="28%" >
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;">端口占用率：<span id="build_view_port_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div>
                            </td>
                            <td width="26%">
                                <div class="quota"><span style="margin-left: 5px">设备数：<span id="build_view_obd"></span></span></div>
                            </td>
                            <td width="25%">
                                <div class="quota"><span style="margin-left: 10px">端口数：<span id="build_view_port_sum"></span></span></div>
                            </td>
                            <td>
                                <div class="quota"><span style="margin-left: 0px">占用端口数：<span id="build_view_port_used_sum"></span></span></div>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td width="28%" rowspan="2">
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 10px">目标数：<span id="build_view_yx_cnt"></span></span></div>
                            </td>
                            <td width="26%" >
                                <div class="quota"><span style="margin-left: 5px;">执行数：<span id="build_view_exec_cnt" style="color:#FF9214;font-weight:bold!important;"></span></span></div>
                            </td>
                            <td>
                                <div class="quota"><span style="margin-left: 10px">执行率：<span id="build_view_exec_lv"></span></span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="quota"><span style="margin-left: 5px">成功数：<span id="build_view_succ_cnt"></span></span></div>
                            </td>
                            <td>
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 5px;">成功率：<span id="build_view_succ_lv" style="color:#FF9214;font-weight:bold!important;"></span></span></div>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="deve_tb" >
                    <table border="0" width="100%">
                        <tr>
                            <td width="28%">
                                <div class="quota"><span style="color: #9ebaf1">•</span><span style="margin-left: 10px">收集率：<span
                                        id="build_view_coll_lv"></span></span></div>
                            </td>
                            <td width="26%" rowspan="2">
                                <div class="quota"><span
                                        style="margin-left: 5px;">应收集：<span id="build_view_coll_should"
                                                                              style="color:#FF9214;font-weight:bold!important;"></span></span>
                                </div>
                            </td>
                            <td>
                                <div class="quota"><span style="margin-left: 10px">已收集：<span
                                        id="build_view_coll_done"></span></span></div>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
      ...
      var select_count = 0;
      var url_sd_view = "<e:url value='/pages/telecom_Index/common/sql/tabData_she_dui_view.jsp' />";
      var url_vill_cell = "<e:url value='/pages/telecom_Index/common/sql/tabData_village_cell.jsp' />";
	...
	var selTbl = "";
	$(function(){
        var query_param = {"eaction": "getSheDuiSelectOption"};
	...
	function comboboxAddr4Init(query_param){
		$.ajax({
			...
			success: function (data) {
				...
				for (var i = 0; i < data.length; i++) {
					var obj = data[i];
					var obj_temp = "";
					if(obj.BRIGADE_ID==res_id){
						//$("#village_view_title").text(obj.BRIGADE_NAME);
						obj_temp = {text:obj.BRIGADE_NAME,value:obj.BRIGADE_ID,"selected":true};
					}else
						obj_temp = {text:obj.BRIGADE_NAME,value:obj.BRIGADE_ID};
					arr.push(obj_temp);
				}
                ...
                $("#fouraddress").combobox("resize",$("#fouraddress").parent().width()-$("#fouraddress").prev().width()-10);
			}
		});
	}

      function getIndexAll(){
          getIndex_xzjg();
          getIndex_market();
          getIndex_resourse();
          getIndex_yx();
      ...
      //行政架构
      function getIndex_xzjg(){
          $.post(url_sd_view,{"eaction":"getIndex_xzjg","res_id":res_id},function(data){
              var ds = $.parseJSON(data);
              if(ds.length){
                  var d = ds[0];
                  $("#build_view_city").text(d.CITY_NAME);
                  $("#build_view_bureau").text(d.COUNTY_NAME);
                  $("#build_view_town").text(d.TOWN_NAME);
                  $("#build_view_village_cell_name").text(d.VILLAGE_NAME);
                  $("#build_view_she_dui_name").text(d.BRIGADE_NAME);
                  $("#build_view_she_dui_name2").text(d.BRIGADE_ALIAS);
                  $("#village_view_title").text(d.VILLAGE_NAME);
              }else{
                  $("#build_view_city").text('--');
                  $("#build_view_bureau").text('--');
                  $("#build_view_town").text('--');
                  $("#build_view_village_cell_name").text('--');
                  $("#build_view_she_dui_name").text('--');
                  $("#build_view_she_dui_name2").text('--');
                  $("#village_view_title").text('--');
              }
          });
      }
      //市场
      function getIndex_market(){
          $.post(url_sd_view,{"eaction":"getIndex_market","res_id":res_id},function(data){
              var ds = $.parseJSON(data);
              if(ds.length){
                  var d = ds[0];
                  $("#build_view_market_lv").text(d.MARKT_LV);
                  $("#build_view_kd_cnt").text(d.H_USE_CNT);
                  $("#build_view_zhu_hu_cnt").text(d.HOUSEHOLD_NUM);
              }else{
                  $("#build_view_market_lv").text('0.00%');
                  $("#build_view_kd_cnt").text('0');
                  $("#build_view_zhu_hu_cnt").text('0');
              }
          });
      }
      //资源
      function getIndex_resourse(){
          $.post(url_sd_view,{"eaction":"getIndex_resourse","res_id":res_id},function(data){
              var ds = $.parseJSON(data);
              if(ds.length){
                  var d = ds[0];
                  $("#build_view_port_lv").text(d.PORT_LV);
                  $("#build_view_obd").text(d.EQP_CNT);
                  $("#build_view_port_sum").text(d.PORT_CNT);
                  $("#build_view_port_used_sum").text(d.USERD_PORT_CNT);
              }else{
                  $("#build_view_port_lv").text('0.00%');
                  $("#build_view_obd").text('0');
                  $("#build_view_port_sum").text('0');
                  $("#build_view_port_used_sum").text('0');
              }
          });
      }
      //营销
      function getIndex_yx(){
          $.post(url_sd_view,{"eaction":"getIndex_yx","res_id":res_id},function(data){
              var ds = $.parseJSON(data);
              if(ds.length){
                  var d = ds[0];
                  $("#build_view_yx_cnt").text(d.YX_COUNT);
                  $("#build_view_exec_cnt").text(d.ZX_COUNT);
                  $("#build_view_exec_lv").text(d.ZX_LV);
                  $("#build_view_succ_cnt").text(d.SUC_COUNT);
                  $("#build_view_succ_lv").text(d.SUC_LV);
              }else{
                  $("#build_view_yx_cnt").text('0');
                  $("#build_view_exec_cnt").text('0');
                  $("#build_view_exec_lv").text('0.00%');
                  $("#build_view_succ_cnt").text('0');
                  $("#build_view_succ_lv").text('0.00%');
              }
          });
      }

      //收集
      function getIndex_collect(){
          $.post(url_sd_view,{"eaction":"getIndex_collect","res_id":res_id,"village_id":village_id},function(data){
              var ds = $.parseJSON(data);
              if(ds.length){
                  var d = ds[0];
                  $("#build_view_coll_lv").text(d.COLLECT_LV);
                  $("#build_view_coll_should").text(d.Y_COLLECT);
                  $("#build_view_coll_done").text(d.COLLECTED_CNT);
              }else{
                  $("#build_view_coll_lv").text('0.00%');
                  $("#build_view_coll_should").text('0');
                  $("#build_view_coll_done").text('0');
              }
          });
      }
